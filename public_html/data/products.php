...
$products = array(
	...
	array(
		...
		',
		'prod_compose' => array(
			array('Наполнитель Elioform', 'Наполнитель: пена Elioform (вспененный наполнитель на основе натуральных материалов). Экологически чистый материал с микропористой структурой. Упругий и эластичный, не накапливает влагу.'),
			array('Летняя сторона', 'Летняя сторона: чистый хлопок. Волокно растительного происхождения с антистатическими и воздухопроницаемыми свойствами. Имеет повышенную износостойкость.'),
			array('Зимняя сторона', 'Зимняя сторона: чистая шерсть тонкорунного мериноса. Качественное волокно животного происхождения мягкое на ощупь, обладает теплорегулирующей функцией. Хотя материал хорошо сохраняет тепло, он не накапливает пыль и влагу.')
		),
		...
		'desc' => '
				<div class="common_block_common fixcommon-block">
					<div class="half-width">
						<h3>О матрасах серии «Merino»</h3>
						<p>
						«Merino» (прежние названия &quot;Magniflex Merinos&quot;, &quot;S model&quot;) – легендарный итальянский
						матрас фабрики Magniflex, созданный более 20 лет назад. - популярная серия
						матрасов итальянского бренда Magniflex. Модель завоевала большую популярность и
						поставляется до сих пор практически в неизменном виде, лишь с небольшими
						технологическими и дизайнерскими улучшениями. Ввиду своей популярности имеет
						самый большой размерный ряд и наличие на складе. Это беспружинные матрасы с
						высокими ортопедическими свойствами, которые производятся по современным
						технологиям с учётом особенностей анатомии человека. Матрас обеспечивает крепкий
						глубокий сон и полное расслабление.<br><br>
						Изделия серии «Merino» могут сохранят ортопедические свойства не менее 10 лет. Они
						не деформируются при климатических изменениях, не вызывают аллергии. Такие
						матрасы подходят людям с заболеваниями опорно-двигательного аппарата и
						хронической болью, а также тем, кто хочет повысить качество сна и не иметь проблем
						со спиной в будущем.
						</p>
					</div>
				...
				<div class="common_block_common fixcommon-block">
					<div class="half-width">
						<h3>Преимущества матраса «Merino»</h3>
						<p>
						1. <strong>Итальянское качество.</strong> Матрас произведён в Италии на заводе в г. Прато
						(Тоскана, Флоренция). На производстве применяются материалы высокого
						качества, современное оборудование и технологии. Проект изделия
						разрабатывается конструкторским бюро квалифицированных технологов.<br><br>
						2. <strong>Безопасная доставка.</strong> Из Италии матрасы доставляются в более чем 99 стран
						по всему миру. Это возможно благодаря уникальной технологии «вакуумной
						рулонной упаковки». Именно компания Magniflex стала первой, кто предложил
						перевозить матрасы таким гигиеничным и безопасным образом. (Технология
						была запатентована в 1986 году).<br><br>
						3. <strong>Сертифицированная продукция.</strong> Матрасы «Меринос» были признаны
						компетентными организациями (РосТест, Центральный Институт Травматологии
						и Ортопедии РФ).<br><br>
						4. <strong>Уникальный состав матраса.</strong> Двусторонний матрас изготовлен из натуральных
						и экологически чистых материалов (хлопок, шерсть мериноса). Высокие
						ортопедические свойства обеспечивает основной слой Elioform.
						</p>
					</div>
					<div class="half-width">
						<h3>Описание товара</h3>
						<p>
						Модель «Мерино» представляет собой двусторонний (демисезонный) матрас с
						ортопедическими свойствами. Такой матрас хорошо вентилируется, не накапливает
						влагу и пыль.<br><br>
						Сезонное исполнение «Мерино» позволяет наслаждаться комфортным сном и
						удобством в любое время года. Разные стороны матраса («зима» и «лето») сделаны из
						разных материалов. Зимняя сторона – из чистой отборной шерсти тонкорунного
						мериноса, летняя – из 100% натурального хлопка. Все материалы на этапе производства прошли противоаллергенную обработку, поэтому матрас не вызовет
						аллергии, раздражения на коже и других неприятных симптомов.
						</p>
					</div>
				</div>
			<br /><br />
...
array('200x200',82300.00),
	...
	array(
		...
		'attr_layer_product' => '',
		'prod_compose' => array(
			array('Ткань чехла', 'Чехол: вискоза. Белоснежный шелковистый материал, который приятно прилегает к телу. Хорошо пропускает воздух, не электризуется.'),
			array('Слой Memoform', 'Слой Memoform (2 см). Пена с эффектом памяти подстраивается под каждый изгиб тела. Не оказывает обратного давления, комфортно поддерживает позвоночник и помогает восстановиться после насыщенного дня или интенсивных тренировок.'),
			array('Микрофибра', 'Микрофибра между слоями. Гипоаллергенный слой, который повышает комфорт и пропускает воздух.'),
			array('Слой Elioform', 'Слой Elioform (15 см). Мелкопористая пена на основе натуральных компонентов высокой плотности. Обеспечивает жёсткость и отменные ортопедические свойства.')
		),
		...
		'desc' => '
			...
			<div class="common_block_common fixcommon-block">
				<div class="half-width">
					<h3>О матрасах серии «Pensiero»</h3>
					<p>
						Серия матрасов «Pensiero» разработана для тех, кто ценит здоровый сон и уют.
						Итальянская компания Magniflex представила эту серию как компромисс между мягким
						спальным местом и полноценной поддержкой спины. Матрасы «Пенсиеро» сохраняют
						упругость и не деформируются даже при сильных нагрузках, но при этом обеспечивают
						безупречный комфорт и упругость.<br><br>
						Серия «Pensiero» представлена матрасами с эффектом памяти, разными сторонами
						(средне-жёсткой и жёсткой), без пружин и с плотной опорой.
					</p>
				</div>				
				<div class="half-width">
					<h3>Описание товара</h3>
					<p>
						Итальянские матрасы этой серии обеспечивают оптимальное распределение нагрузки.
						Матрас «Pensiero» выдерживает до 160 кг, а материалы, из которых он изготовлен,
						прошли тщательную противоаллергенную обработку и не накапливают влагу.<br><br>
						Беспружинный ортопедический матрас от итальянской фабрики Магнифлекс поможет
						обрести крепкий сон и забыть о болях в спине.
					</p>
				</div>
			</div>
			<div class="common_block_common fixcommon-block">			
				...
				<div class="half-width">
					<h3>Преимущества матрасов «Pensiero»</h3>
					<p>
						1. <strong>Без пружин.</strong> Конструкция матраса даёт плотную опору, при этом не
						передавливает отдельные зоны тела и обеспечивает мягкость.<br><br>
						2. <strong>Эффект памяти. </strong>За эту функцию отвечает пена Memoform – вязко-пористый
						наполнитель, который подстраивается под анатомические изгибы тела. Матрас с
						эффектом памяти обеспечивает комфортную поддержку позвоночника.<br><br>
						3. <strong>Две стороны.</strong> Можно просто перевернуть матрас, чтобы спать на более жёсткой
						стороне.<br><br>
						4. <strong>Усиленная конструкция.</strong> Выдерживает большой вес, не деформируется.<br><br>
						5. <strong>Универсальность.</strong> Подходит для большинства типов кроватей. Средняя
						толщина и оптимальный размер – достаточно широкий, но компактный, легко
						транспортируется.<br><br>
						6. <strong>Безопасная доставка.</strong> Матрасы «Пенсиеро» свёрнуты в плотный рулон и
						упакованы в вакуумную плёнку. В таком виде изделие можно удобно и безопасно
						перевозить с места на место и доставлять в разные города. Заказывая матрас,
						можно не волноваться касаемо его транспортировки.<br><br>
						7. <strong>Итальянское качество.</strong> Матрас произведён в Италии на заводе в г. Прато
						(Тоскана, Флоренция). На производстве применяются материалы высокого
						качества, современное оборудование и технологии. Проект изделия
						разрабатывается конструкторским бюро квалифицированных технологов.<br><br>
						8. <strong>Гигиеничность.</strong> Из Италии матрасы доставляются в более чем 99 стран по
						всему миру. Это возможно благодаря уникальной технологии «вакуумной
						рулонной упаковки». Именно компания Magniflex стала первой, кто предложил
						перевозить матрасы таким гигиеничным и безопасным образом. (Технология
						была запатентована в 1986 году).
					</p>
				</div>
			</div>
		',
...
/*
		...
		*/
		...
		'img_preview' => array('/img/product/Naturalmente foto2.jpg','/img/product/Naturalmente foto3.jpg','/img/Naturalmente-4.jpg', '/img/Naturalmente-5.jpg', '/img/Naturalmente-6.jpg', '/img/Naturalmente-7.jpg'),
		'img_carousel' => array('/img/product/Naturalmente foto1.jpg', '/img/product/Naturalmente foto2.jpg','/img/product/Naturalmente foto3.jpg','/img/Naturalmente-4.jpg', '/img/Naturalmente-5.jpg', '/img/Naturalmente-6.jpg', '/img/Naturalmente-7.jpg'),
		'small_img_alt' => 'матрас Naturalmente (New Naturcomfort)',
		'img' => '/img/product/Naturalmente foto1.jpg',
		'img_alt' => 'Ортопедические матрасы Naturalmente (New Naturcomfort)',	
		'prod_compose' => array(
			array('Ткань чехла', 'Wooden Fiber. Целлюлозная пряжа с волокнами белой пихты обладает лучшей терморегуляцией и воздухопроницаемостью.'),
			array('Слой Memoform', 'Слой Memoform (2 см с каждой стороны). Вязкая и эластичная пена с эффектом памяти запоминает контуры тела. На данный момент, именно этот наполнитель считается «индивидуальным» – он универсален, подходит всем, поскольку подстраивается под ваше тело и не оказывает обратного давления.'),
			array('Гипоаллергенный терморегулирующий слой', 'Сохраняет тепло, распределяет его по всей площади матраса.'),
			array('Слой Elioform', 'Слой Elioform  (18 см). Пена на основе натуральных материалов полноценно заменяет пружинный блок и обеспечивает мягкую естественную поддержку спины. Имеет высокую износостойкость.')
		),	
		'attr_cover_product' => 'Wooden Fiber. Целлюлозная пряжа с волокнами белой пихты
		обладает лучшей терморегуляцией и воздухопроницаемостью.',
		...
		// 'image_composition' => '/img/layer-naturalmente.jpg',
...
'banner_product' => '/img/Layer 1.png',
		...
		'desc' => '
			<div class="common_block_common fixcommon-block">
				<div class="half-width">
					<h3>О матрасах «Naturalmente»</h3>
					<p>Старое название этого матраса дословно переводилось с итальянского как
«натуральный комфорт» («Naturcomfort»). Со временем модель получила
новое название, но в аспекте натурального комфорта не потеряла ни
пункта: матрасы «Naturalmente» изготовлены из экологически чистых
материалов и дарят глубокий комфортный сон, каким бы тяжёлым ни был
ваш день.<br><br>
Изделия вышли в продажу в 2013 году. За столь короткое время на рынке
матрасов серия «Naturalmente» завоевала искреннюю любовь покупателей и
признание ведущих специалистов в области ортопедии и медицины в
целом.
					</p>
			...
			<div class="common_block_common fixcommon-block">
				...
				<h3>Описание товара</h3>
					<p>
					В 2016 году вышла обновлённая версия матраса «Naturcomfort» под
названием «Naturalmente». Как признаёт сам производитель, это абсолютно
новый уровень комфорта. Обновлённый матрас выше предыдущего на 1 см,
имеет улучшенный вариант чехла с более современным рисунком.
Матрас состоит из 4 слоёв (включая популярную пену с эффектом памяти и
наполнитель
Eliosoft).
<br><br>
В совокупности, высота всех слоёв матраса
составляет 22 см. Матрас с такими внушительными габаритами
выдерживает до 160 кг на одно спальное место. Пока это рекордсмен среди
матрасов: как по составу и внутреннему наполнению, так и по
практическим свойствам.
				...
				<div class="half-width fixcommon-block">
				<h3>Преимущества матраса «Naturalmente»</h3>
					<p>
					
1. <strong>Высокие ортопедические свойства.</strong> Сочетание хорошей поддержки
спины и максимального расслабления мышц. Эффект памяти и
упругий слой Eliosoft помогают сохранять позвоночник в правильном
положении.
<br><br>
2.<strong> Хорошая вентиляция.</strong>
расположены вентиляционные отверстия, благодаря которым в
матрасе не скапливается влага, пыль и пот. Также хорошую
вентиляцию обеспечивают древесные волокна, которые входят в
состав материалов. Они же регулируют температуру тела спящего,
равномерно распределяют тепло по всему объему матраса.
<br><br>
3.<strong> Мягкость.</strong> Бархатистую поверхность матраса обеспечивает особый
материал, из которого пошит несъёмный чехол. Это смесь хлопка и
древесных волокон белой пихты, так называемый «Wooden Fiber».
<br><br>
4. <strong>Итальянское качество.</strong> Матрас произведён в Италии на заводе в г.
Прато (Тоскана, Флоренция). На производстве применяются
материалы высокого качества, современное оборудование и
технологии. Проект изделия разрабатывается конструкторским бюро
квалифицированных технологов.
<br><br>
5. <strong>Безопасная доставка.</strong> Из Италии матрасы доставляются в более чем
99 стран по всему миру. Это возможно благодаря уникальной
технологии «вакуумной рулонной упаковки». Именно компания
Magniflex стала первой, кто предложил перевозить матрасы таким
гигиеничным и безопасным образом. (Технология была запатентована
в 1986 году).
					</p>
				</div>
			</div>
...
// array('200x200',144600.00),
	...
	array(
		...
		'img' => '/img/product/Memorie 8 foto1.jpg',
		'img_preview' => array('/img/product/Memorie 8 foto2.jpg', '/img/product/Memorie 8 foto3.jpg', '/img/product/Memorie 8 foto4.jpg', '/img/product/Memorie 8 foto5.jpg'),
		'img_carousel' => array('/img/product/Memorie 8 foto1.jpg', '/img/product/Memorie 8 foto2.jpg', '/img/product/Memorie 8 foto3.jpg', '/img/product/Memorie 8 foto4.jpg', '/img/product/Memorie 8 foto5.jpg'),
		...
		'attr_layer_product' => '',
		'prod_compose' => array(
			array('Ткань чехла', 'Чехол: вискоза. В отличие от многих других моделей бренда Magniflex, чехол на матрасе «Memorie 8» съёмный (на молнии). Материал не вызывает раздражения на коже и хорошо пропускает воздух.'),
			array('Наполнитель Memoform', 'Наполнитель Memoform (2 см). Гипоаллергенное волокно с эффектом памяти дарит ощущение невесомости и расслабления.'),
			array('Слой Eliosoft', 'Слой Eliosoft (5 см). Слой обеспечивает поддержку 5 основных зон тела. Вспененный материал на основе натуральных компонентов обладает высокой плотностью, высокими свойствами циркуляции воздуха – все внутренние пылевые элементы выдуваются из матраса.'),
			array('Слой Elioform', 'Слой Elioform (13 см). Основной наполнитель заменяет пружинный блок и выдерживает большой вес.')
		),	
...
'banner_product' => '/img/Layer 1.png',
		...
		'desc' => '
			...
			<div class="common_block_common">
				<div class="half-width">
				<h3>О матрасах серии «Memorie»</h3>
				<p>Новая коллекция матрасов «Memorie» создана как эталон упругих матрасов от
				итальянского производителя. Технологи бренда Magniflex учли все пожелания
				покупателей и оценки специалистов в области медицины и ортопедии, в частности.
				Матрасы «Memorie» сочетают безупречные ортопедические свойства и среднюю
				жесткость, с которой ваш сон будет крепким и здоровым.</p>
				</div>
			...
			<div class="common_block_common">
				<div class="half-width">
					<h3>Преимущества матраса «Мемори 8»</h3>
					<p>
						1. <strong>Средняя жёсткость.</strong> Матрас «Мемори 8» имеет среднюю жёсткость. Именно
						такая степень комфортна большинству людей различного телосложения. Матрас
						универсален: подходит взрослым и пожилым людям, детям, подросткам. Основа
						матраса – упругая пена Elioform, гарантирующая отличную поддержку тела во
						время сна.<br><br>
						2. <strong>Эффект памяти.</strong> Пена Memoform в подкладке чехла матраса адаптируется под
						контуры вашего тела и дарит удивительно приятный сон – без боли, посторонних
						неприятных ощущений и дискомфорта.<br><br>
						3. <strong>Поддержка пяти зон тела.</strong> Основу верхней части матраса также составляет
						пена с микросотовой структурой Eliosoft. Именно этот слой обеспечивает
						равномерную ортопедическую поддержку, массажный и мультизональный
						эффект.<br><br>
						4. <strong>Итальянское качество. </strong>Матрас произведён в Италии на заводе в г. Прато
						(Тоскана, Флоренция). На производстве применяются материалы высокого
						качества, современное оборудование и технологии. Проект изделия
						разрабатывается конструкторским бюро квалифицированных технологов.
					</p>
				</div>
				<div class="half-width">
					<h3>Описание товара</h3>
					<p>Матрас «Memorie 8» является лидером по популярности в своей коллекции. Это
					изделие средней степени жёсткости, с одной стороны имеющее массажный эффект и
					мультизональную поддержку, с другой стороны - упругий слой Elioform.<br><br>
					Это идеальный вариант для отдыха после тяжёлого рабочего дня. Матрас подходит
					спортсменам с ежедневными тренировками, людям с заболеваниями опорно-
					двигательного аппарата и хронической болью, страдающим бессонницей и тем, кто
					хочет повысить качество сна.</p>
				</div>
			</div>
		',
		'rec_buy' => '',
...
*/
    ...
    //   'small_img' => '/img/product/small/Carezza 10 3-4 PEDANA.jpg',
      ...
      'img' => '/img/product/Carezza 10 foto1.jpg',
      'img_preview' => array('/img/product/Carezza 10 foto2.jpg','/img/product/Carezza 10 foto3.jpg','/img/product/Carezza 10 foto4.jpg','/img/product/Carezza 10 foto5.jpg'),
	  ...
	  'specialoffer_label' => array(
		...
		'prod_compose' => array(
			array('Ткань чехла', 'Чехол: вискоза. Мягкое и шелковистое волокно, заполненное материалами Memosoft и Super Soft Fiber (2 см). Гипоаллергенный слой, гарантирует обволакивающий эффект.'),
			array('Наполнитель Aquabreeze', 'Инновационный материал на водной основе с молекулярной структурой открытой ячейки. Дарит ощущение свежести во время сна, повышает воздухопроницаемость.'),
			array('Слой Elioform', 'Слой Elioform (16 см). Микропористая пена высокой плотности. Обеспечивает упругость матрасу, дает высокий уровень поддержки спины.'),
		),	
		'image_composition' => '/img/Memorabile-8_1.jpg',
      ...
      'rec_buy' => '
		...
		'desc' => '
			...
			<div class="hnb_elcont3">
				<div class="common_block_common">
					<div class="half-width">
						<h3>О матрасах серии Carezza</h3>
						<p> Carezza («Карезза») – премиальная серия беспружинных матрасов от итальянского
						производителя Magniflex. Материалы, отобранные для коллекции, отличаются
						мягкостью и высокой воздухопроницаемостью. Сочетание слоев обеспечивает
						отличный ортопедический эффект и расслабление мышц во время сна.<br><br>
						От здорового сна зависит наше самочувствие. Матрасы Carezza подходят как людям с
						заболеваниями спины, хронической болью и бессонницей, так и тем, кто не имеет
						проблем со сном, но мечтает полноценно отдохнуть и расслабиться.
						</p>
					</div>
				...
				<div class="common_block_common">
					<div class="half-width">
						<h3>Преимущества матраса Carezza 10</h3>
						<p> 
							1. <strong>Матрас премиум-класса. </strong>Сочетание современных экологичных
							материалов и стильный дизайн подчеркивает высокое качество изделия.
							Чехол из шелковистого волокна декорирован фигурной стежкой и
							элегантным узором по бокам.<br><br>
							2. <strong>Высокая ортопедичность и мягкость. </strong>За эти аспекты отвечают слои
							Elioform (жесткая пена для поддержки спины), Aquabreeze (инновационная
							пена на водной основе для максимального расслабления), Memosoft и
							Super Soft Fiber в чехле (дают мягкий, обволакивающий эффект).<br><br>
							3. <strong>Свежесть и воздухопроницаемость.</strong> Особенность матраса Carezza 10 –
							наличие пены Aquabreeze. Не во всех матрасах есть этот слой, и именно
							он способствует лучшей циркуляции воздуха.
						</p>
					</div>
					<div class="half-width">
						<h3>Описание товара</h3>
						<p> Матрас Carezza 10 – это умеренно мягкая модель в коллекции. Упругая
						ортопедическая поддержка сочетается с мягкостью и уютом. Итальянские технологи до
						мелочей продумали конструкцию матраса. Тут и пена Elioform на основе натуральных
						материалов с максимальной поддержкой спины, и слой Aquabreeze на водной основе
						для лучшей циркуляции воздуха. Благодаря материалу Memosoft матрас обеспечивает
						экстра комфорт и дарит максимальное расслабление.
						</p>
					</div>
				</div>
			</div> 
    ...
    array(
		...
		'attr_layer_product' => '',
		'prod_compose' => array(
			array('Чехол из вискозы', 'Изготовлен из гигроскопичного материала, способного впитывать влагу. Ткань мягкая, приятная на ощупь, не электризуется. Чехол не снимается.'),
			array('Слой Memoform', 'Memoform (2 см). Пена с эффектом памяти подстраивается под тело, дарит ощущение невесомости и расслабления. Гарантирует высокий уровень комфорта.'),
			array('Super Soft Fiber', 'Мягкое фибровое волокно. «Дышащий» материал, который придаёт дополнительную мягкость матрасу.'),
			array('Слой Elioform', 'Elioform (18 см). Пена с микросотовой структурой высокой плотности. Материал имеет особую молекулярную структуру, что обеспечивает эластичность и воздухопроницаемость. Даёт ортопедическую поддержку телу, делает матрас упругим.')
		),	
		...
		'img_preview' => array('/img/product/Rest 9 foto2.jpg', '/img/product/Rest 9 foto3.jpg', '/img/product/Rest 9 foto4.jpg', '/img/product/Rest 9 foto5.jpg'),
		'img_carousel' => array('/img/product/Rest 9 foto1.jpg','/img/product/Rest 9 foto2.jpg', '/img/product/Rest 9 foto3.jpg', '/img/product/Rest 9 foto4.jpg', '/img/product/Rest 9 foto5.jpg'),
		'small_img_alt' => '',
		'img' => '/img/product/Rest 9 foto1.jpg',
		'img_alt' => '',
...
'desc' => '
		...
		<div class="hnb_contmy">
			...
			<div class="common_block_common ama-parallax-0">
				<div class="half-width">
				<h3>О матрасах серии Rest</h3>
				<p>Итальянский производитель Magniflex представляет серию элитных матрасов Rest («Рест»).
				Ортопедические свойства и полное расслабление во время сна, элегантный дизайн, возможность
				использовать обе стороны, идеальный баланс жёсткости и упругости – матрасы Rest до сих пор не знают
				аналогов на рынке.<br><br>
				Матрасы изготовлены только из высококачественных тканей и материалов. Мягкий слой Memoform с
				эффектом памяти подстраивается под тело спящего, гипоаллергенная фибра Super Soft Fiber дарит
				мягкость, пена Elioform даёт ортопедическую поддержку, а чехол из мягкой вискозы быстро впитывает
				влагу и обеспечивает воздухопроницаемость.
				</p>
				</div>
				<div class="coin-slider">
			...
			<div class="common_block_common ama-parallax-1">
				<div class="half-width">
					<h3>Жесткий матрас Magniflex Rest 9</h3>
					<p class="text-jus">
						Модель Magniflex Rest 9 называют «классикой» за универсальность и оптимальное соотношение слоёв.
						Такой матрас подойдёт человеку с проблемами опорно-двигательного аппарата: 18-сантиметровая пена
						Elioform гарантирует ортопедическую поддержку позвоночника. Слой пены из натуральных материалов
						выдерживает до 160 кг на одно спальное место.<br><br>
						Можно использовать обе стороны матраса Magniflex Rest 9, и это ещё один плюс к универсальности. Вы
						можете ориентироваться на свои ощущения, выбирая чуть более мягкую сторону, где есть слой с
						эффектом памяти и фиброй, или более жёсткую, где этих слоёв нет. Только ваш индивидуальный
						комфорт и полное расслабление!<br><br>
						Модель «Магнифлекс Рест 9» имеет является жестким при отсутствии в основании пружинного блока.
						Высота — 23 см. Заказав матрас в интернете, можете не сомневаться в его безопасной доставке.
						Матрас поставляется в рулоне, в который скручивается по запатентованной технологии вакуумной
						упаковки на фабрике в Италии, Флоренция, Тоскана, г. Прато, что гарантирует его гигиеничность.
                    </p>
				</div>
				<div class="half-width">
					<h3>Преимущества матраса Magniflex Rest 9</h3>
					<p class="text-jus">
                    1. Можно выбрать любую сторону (чуть более мягкую или чуть более жёсткую), в зависимости от
					ваших предпочтений;<br><br>
					2. Изготовлен из качественных и гипоаллергенных материалов (вискоза, пена на основе
					натуральных материалов, фибровое волокно);<br><br>
					3. Выдерживает большой вес;<br><br>
					4. Элегантный итальянский дизайн;<br><br>
					5. Возможность безопасно транспортировать матрас благодаря вакуумной упаковке;<br><br>
					6. Настоящая Италия.
					</p>
				</div>
			</div>
	...
	array(
		...
		'small_img' => '/img/product/small/rest_collection_interior2x.jpg',
		'img_preview' => array('/img/product/Rest 10 foto2.jpg', '/img/product/Rest 10 foto3.jpg', '/img/product/Rest 10 foto4.jpg', '/img/product/Rest 10 foto5.jpg'),
		'img_carousel' => array('/img/product/Rest 10 foto1.jpg','/img/product/Rest 10 foto2.jpg', '/img/product/Rest 10 foto3.jpg', '/img/product/Rest 10 foto4.jpg', '/img/product/Rest 10 foto5.jpg'),
		'small_img_alt' => 'элитный матрас Magniflex Rest 10',
		'img' => '/img/product/Rest 10 foto1.jpg',
		...
		'attr_layer_product' => '',
		'prod_compose' => array(
			array('Ткань чехла', 'Мягкая ткань из отборной целлюлозы. Обеспечивает терморегуляцию и высокую воздухопроницаемость, быстро впитывает влагу.'),
			array('Наполнитель Memoform', 'Наполнитель Memoform (2 см). Пена с эффектом памяти (антидавления).'),
			array('Система усиления комфорта Super Soft Fiber', 'Мягкое фибровое волокно. Обеспечивает нежную поддержку тела и улучшает качество сна.'),
			array('Слой Elioform', 'Слой Elioform (3 см). Пена микросотовой структуры. Дает твердость матрасу и обеспечивает ортопедический эффект.'),
			array('Двойной слой Eliosoft', 'Двойной слой Eliosoft (18 см). Мягкая версия пены. Благодаря особой молекулярной структуре хорошо пропускает воздух и распределяет тепло, не накапливает влагу.')
		),	
...
'banner_product' => '/img/Layer 1.png',
		...
		<div class="hnb_contmy">
			...
			<div class="common_block_common ama-parallax-0">
				<div class="half-width">
				<h3>О матрасах серии Rest</h3>
				<p>Итальянский бренд Magniflex позаботился о том, чтобы ваш сон был крепким и
					здоровым. Серия элитных матрасов «Rest» представлена беспружинными моделями
					средней жесткости. Усиленная конструкция матрасов выдержит до 160 кг веса, а
					уникальный состав и комбинация слоев заставит забыть о болях в спине и
					дискомфорте.<br><br>
					Эксклюзивная система Memoform обеспечивает «эффект памяти» – матрас
					адаптируется под контуры тела и анатомические особенности, а двойной слой пены
					Elioform придает необходимую ортопедическую жесткость. Вискозная ткань чехла
					отлично пропускает воздух и не задерживает влагу.
				</p>
				</div>
				<div class="coin-slider">
				<img src="/img/rest.jpg" alt="ортопедический матрас из коллеции Rest Magniflex">
			...
			<div class="common_block_common ama-parallax-1">
				<div class="half-width">
					<h3>Описание товара</h3>
					<p class="text-jus">
						Модель Rest 10 считается более мягким матрасом в коллекции Rest, мягче Rest 9.
						Изделие отвечает всем критериям итальянского качества: изготовлен только из
						экологичных, гипоаллергенных материалов, имеет элегантный дизайн и высокую
						степень ортопедичности. Такой матрас подойдет людям любого возраста, как тем, кто
						имеет проблемы опорно-двигательного аппарата, так и тем, кто не страдает от болей в
						спине, но мечтает улучшить качество сна.<br><br>
						Матрас «Рест 10» от Magniflex двусторонний. Одна сторона более мягкая за счет слоя
						с эффектом памяти и системой усиления комфорта Super Soft fiber, а другая – упругая
						и ортопедичная. На какой стороне матраса спать – выбор за вами, но, в любом случае,
						расслабление обеспечено!
                    </p>
				</div>
				<div class="half-width">
					<h3>Преимущества матраса Rest 10 от «Магнифлекс»</h3>
					<p class="text-jus">
						1. <strong>Беспружинный механизм поддержки спины.</strong> С появлением таких
						современных материалов как Elioform и Eliosoft уже нет потребности покупать
						матрасы с пружинами. Слои обеспечивают высокий уровень ортопедичности,
						поддерживают основные зоны тела, не давят и дарят максимальное
						расслабление.<br><br>
						2. <strong>Комбинация двух слоев Elioform и Eliosoft.</strong> Зачастую беспружинные матрасы
						содержат один из этих слоев, а в данной модели их два. Это делает матрас
						более комфортным и в то же время высоким, а также позволяет использовать
						обе стороны.<br><br>
						3. <strong>Элегантный дизайн.</strong> Итальянцы знают толк не только в создании дизайнерской
						одежды, но и матрасов. Изделие Rest 10 отличается особой строгостью и
						сдержанностью, что выглядит очень стильно, нежно и не содержит никаких
						старомодных и лишних деталей.
					</p>
				</div>
			</div>
...
for ($i = 0; $i < count($products); $i++) {
	if($products[$i]['parent_address'] != 'outlet' && ($products[$i]['parent_address2'] == 'mattresses' || $products[$i]['parent_address2'] == 'pillows' || $products[$i]['parent_address'] == 'plaids')) {
		$products[$i]['discount_koef'] = array('date_start' => '10.09.2020', 'date_end' => '27.09.2020', 'price_koef' => 0.15);
	}
}
