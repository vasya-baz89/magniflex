...
$get_breadcrumbs_product = function($item, $products, $categories){
	...
	$filters_pillows = array(
		...
		array('detskie-podushki', 'Детские подушки', '/catalog/pillows/detskie-podushki/'),
	);
...
<br><br>
        ...
        'discount_koef' => array('date_start' => '31.10.2019', 'date_end' => '31.11.2019',
            'sizes' => array(
				'80x190',
				'80x200',
				'90x190',
...
<br><br>
	...
	array(
		...
		'discount_koef' => array('date_start' => '31.10.2019', 'date_end' => '31.11.2019', 'price_koef' => 0.20),
...
Это очень удобно и практично. Если один человек предпочитает мягкий матрас, а его партнер – жесткий, то им достаточно повернуть блоки в нужные им положения и наслаждаться комфортом.
	...
	array(
		...
		'discount_koef' => array('date_start' => '01.03.2019', 'date_end' => '31.11.2019', 'price_koef' => 0.30, ), //скидка
...
Слой Eliosoft 8.5 см - это более мягкий материал, чем Elioform. Сверху и снизу закрыты слоями по 5 см мемори с эффектом памяти. Матрас довольно мягкий и потрясающе комфортный.				
		...
		'discount_koef' => array('date_start' => '04.03.2019', 'date_end' => '31.11.2019', 'price_koef' => 0.3),
...
<div style="clear:both;"></div>
		...
		'discount_koef' => array('date_start' => '31.10.2019', 'date_end' => '31.11.2019', 'price_koef' => 0.20, ), //скидка
...
<div style="clear:both;"></div>
		...
		'discount_koef' => array('date_start' => '31.10.2019', 'date_end' => '31.11.2019', 'price_koef' => 0.2),
...
<div style="clear:both;"></div>
 ...
 //скидка
	...
	array(
		...
		'attr_cat_product2' => 'съемный, защитный',
...
Magniflex - забота о самых маленьких.
	...
	array(
		...
		'sizes' => false,
		'price' => 12200.00,
		'discount_koef' => array('date_start' => '01.03.2019', 'date_end' => '31.11.2019', 'price_koef' => 0.3, ), //скидка
		//'discount_koef' => array('date_start' => '1.7.2015', 'date_end' => '31.7.2015',
			//'prices' => 4950,
		//), //скидка
	),
