...
'banner_product' => '/img/Layer 1.png',
		...
		'discount_koef' => array('date_start' => '16.12.2019', 'date_end' => '30.12.2019', 'price_koef' => 0.1),
...
<div class="half-width_img"><img  src="/img/products/mattresses/style_mattress.jpg" alt="Ортопедический матрас Magniflex из коллекции Stile"></div>
		...
		'sizes' => array(
			...
			array('120x200 (не в рулоне, новый)',37600.00),
...
<br><br>
	...
	array(
		...
		'discount_koef' => array('date_start' => '31.10.2019', 'date_end' => '31.12.2019', 'price_koef' => 0.20),
...
<iframe class="ifreme-video" width="100%" height="778px" src="https://www.youtube.com/embed/euJn6HfS6dw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
		...
		'discount_koef' => array('date_start' => '31.10.2019', 'date_end' => '31.12.2019',
			'sizes' => array('90x200 (не в рулоне, новый)','180x200'),
			'prices' => array(
    ...
    //   'small_img' => '/img/product/small/Carezza 10 3-4 PEDANA.jpg',
	  ...
	  'discount_koef' => array('date_start' => '01.02.2019', 'date_end' => '31.12.2019', 'price_koef' => 0.20),
...
Это очень удобно и практично. Если один человек предпочитает мягкий матрас, а его партнер – жесткий, то им достаточно повернуть блоки в нужные им положения и наслаждаться комфортом.
	...
	array(
		...
		'discount_koef' => array('date_start' => '16.12.2019', 'date_end' => '30.12.2019', 'price_koef' => 0.3),
    ),
    array(
...
'banner_product' => '/img/Layer 1.png',
		...
		'discount_koef' => array('date_start' => '16.12.2019', 'date_end' => '30.12.2019', 'price_koef' => 0.15),
		// 'discount_koef' => array('date_start' => '14.12.2018', 'date_end' => '31.12.2019',
		// 	'sizes' => array('160x200'),
		// 	'prices' => array(
        //         '160x200' => 52300.00
...
'banner_product' => '/img/Layer 1.png',
	...
	array(
		...
		'discount_koef' => array('date_start' => '01.03.2019', 'date_end' => '31.11.2020', 'price_koef' => 0.30, ), //скидка
...
<div style="clear:both;"></div>
		...
		'discount_koef' => array('date_start' => '31.10.2019', 'date_end' => '31.12.2019', 'price_koef' => 0.20, ), //скидка
...
<div style="clear:both;"></div>
		...
		'discount_koef' => array('date_start' => '31.10.2019', 'date_end' => '31.12.2019', 'price_koef' => 0.2),
...
'banner_product' => '/img/Layer 1.png',
	...
	array(
		'address' => 'relaxsan',
		'parent_address' => 'pillows/vacuum-pillows',
		'parent_address2' => 'pillows',
		'other_categories' => array('forma-klasicheska','collectio_relaxsan','pillows-filter','orthopedic_pillows', 'vacuum-pillows'),
...
'banner_product' => '/img/Layer 1.png',
	...
	array(
		...
		'parent_address2' => 'pillows',
		'other_categories' => array('baby-pillows', 'pillows-filter','orthopedic_pillows', 'material-memoform','memory-foam-pillows'),
		'parent_name' => 'Ортопедические подушки',
		'name' => 'Детская подушка Memoform Baby 1+',
		...
		'attr_drape_product' => '',
		'attr_layer_product' => '',
		'image_composition' => '/img/Memoform_Baby_layers.jpg',
		'prod_compose' => array(
			array('Hygienic cloth', 'The cloth protects the inner layer, increasing the pillow’s level of hygiene.'),
			array('Interior', 'The interior in Memoform is designed to respond to the weight of the neck, head and shoulders, offering a pleasant feeling of lightness while you’re asleep.'),
			array('Manufacture', 'The pillow’s special design ensures perfect breathability and optimal dispersion of moisture and heat, thanks to the holes in the middle.')
		),
		'block_attr_collections' => 'Piuma',
		'block_attr_materials' => 'Хлопок',
		'block_attr_coating' => '100% хлопок',
...
'banner_product' => '/img/Layer 1.png',
		...
		'desc' => '
			...
			<div class="common_block_common">
				...
				<p>
Подушка Memoform Baby разработана специально для детей от 1 года и старше.<br />
Заботливые родители стараются организовать правильный сон для ребенка. Это очень важно, ведь маленькие дети проводят во сне гораздо больше времени, чем взрослые. Подушка является одним из основных элементов в организации качественного сна. Она должна учитывать потребности детского организма, быть приятной и комфортной, иначе ребенок будет спать без подушки.<br />
...
Magniflex - забота о самых маленьких.
	...
	<div class="common_block_common fixcommon-block">
		<div class="half-width fixcommon-block">
		    ...
		    <p class="text-jus">
		    Подушка Memoform Baby поможет ребенку занять правильное анатомическое положение, что обеспечит полноценный глубокий сон, утреннюю бодрость и хорошую осанку в будущем.
            </p>
	    </div>
	    ...
	    <div class="half-width fixcommon-block">
			...
			<p class="text-jus">
            Мелкопористая структура пены Memoform Airyform обеспечивает высокий уровень воздухообмена, означающий свежий и здоровый сон для ребенка. Вертикальная перфорация по всей поверхности подушки увеличивает пропускную способность воздуха, защищая ребенка от накопления в подушке пылевых клещей.<br>
			</p><br /><br />
			<h3>Удлиненная</h3>
			<p class="text-jus">
	...
	array(
		...
		'parent_address' => 'pillows',
		'parent_address2' => 'pillows',
		'other_categories' => array( 'baby-pillows','pillows-with-cooling-effect', 'forma-wolna', 'chehol-viscose','collectio_freshgel','pillows-filter','orthopedic_pillows','material-memogel','gel-pillows'),
		...
		'sizes' => false,
		'price' => 12200.00,
		'discount_koef' => array('date_start' => '01.03.2019', 'date_end' => '31.11.2020', 'price_koef' => 0.3, ), //скидка
		//'discount_koef' => array('date_start' => '1.7.2015', 'date_end' => '31.7.2015',
			//'prices' => 4950,
		//), //скидка
	),
	array(
		...
		'parent_address' => 'pillows',
		'parent_address2' => 'pillows',
		'other_categories' => array( 'pillows-with-cooling-effect', 'forma-klasicheska', 'chehol-viscose','collectio_freshgel','pillows-filter','orthopedic_pillows','material-memogel', 'gel-pillows'),
		'parent_name' => 'Гелевые подушки',
...
'banner_product' => '/img/Layer 1.png',
	...
	array(
		...
		'parent_address' => 'pillows',
		'parent_address2' => 'pillows',
		'other_categories' => array( 'collectio_classico', 'pillows-with-cooling-effect', 'forma-klasicheska', 'chehol-viscose','pillows-filter','orthopedic_pillows','material-memoform','memory-foam-pillows'),
		'parent_name' => 'Гелевые подушки',
...
'banner_product' => '/img/Layer 1.png',
		...
		<div class="hnb_contvideo">
		<video controls="controls" tabindex="0" style="width:100%;" muted>
		  <source src="/data/video/Sushi Pillow by Magniflex - подушка суши для дороги.mp4" />
		  <object type="application/x-shockwave-flash" data="/data/video/index/video2.swf" width="100%"  id="video_index" style="margin:0 auto;display:inline;zoom:1;float: none;background:white;">
				<param name="movie" value="/data/video/index/video2.swf" />
				<param name="quality" value="high" />
				<param name="bgcolor" value="#000000" />
...
Чехол подушки выполнен из материала Viscose. Viscose Magniflex - невероятно приятный на ощупь материал, гарантирующий максимальное расслабление. Подушка подходит для сна в любом положении, на спине, на боку, на животе. Отличное решение для любителей путешествовать.<br /> 
	...
	array(
		...
		'parent_address' => 'pillows',
		'other_categories' => array( 'memory-foam-pillows', 'pillows-with-cooling-effect', 'forma-klasicheska', 'chehol-viscose','collectio_freshgel','pillows-filter','orthopedic_pillows','material-memogel','gel-pillows'),
		'parent_address2' => 'pillows',
		'parent_name' => 'Гелевые подушки',
...
'banner_product' => '/img/Layer 1.png',
	...
	array(
		...
		'parent_address' => 'pillows',
		'parent_address2' => 'pillows',
		'other_categories' => array( 'memory-foam-pillows','forma-klasicheska', 'material-mallowfoam', 'chehol-viscose', 'chehol-satin','collectio_virtuoso','pillows-filter','orthopedic_pillows'),
		'parent_name' => 'Ортопедические подушки',
...
'banner_product' => '/img/Layer 1.png',
	...
	array(
		...
		'parent_address' => 'pillows',
		'parent_address2' => 'pillows',
		'other_categories' => array('forma-klasicheska', 'material-memoform', 'chehol-outlast','collectio_superiore','pillows-filter','orthopedic_pillows','memory-foam-pillows'),
		'parent_name' => 'Ортопедические подушки',
...
'banner_product' => '/img/Layer 1.png',
	...
	array(
		...
		'parent_address' => 'pillows',
		'parent_address2' => 'pillows',
		'other_categories' => array( 'memory-foam-pillows', 's-masagnim-effektom', 'forma-klasicheska', 'material-memoform', 'chehol-outlast','collectio_superiore','pillows-filter','orthopedic_pillows'),
		'parent_name' => 'Ортопедические подушки',
...
'banner_product' => '/img/Layer 1.png',
		...
		<div itemscope itemtype="http://schema.org/ItemList" style="opacity: 0; height: 0; position: absolute; left: 999999px;">
			<link  href="https://magniflex.ru/catalog/pillows/memoform-superiore-deluxe-orthomassage/">
			<div itemprop="itemListElement" itemscope itemtype="http://schema.org/Product">
				<img alt="Photo of product" itemprop="image" src="https://magniflex.ru/img/product/big/MEMOFORM%20ORTHOMASSAGE%20SUP%20MX-5.jpg"> <a  href="https://magniflex.ru/catalog/pillows/memoform-superiore-deluxe-orthomassage/"><span itemprop="name">ОРТОПЕДИЧЕСКАЯ ПОДУШКА MEMOFORM SUPERIORE DELUXE ORTHOMASSAGE</span></a>
	...
	array(
		...
		'parent_address' => 'pillows',
		'parent_address2' => 'pillows',
		'other_categories' => array( 'baby-pillows','memory-foam-pillows', 'forma-wolna', 'forma-klasicheska', 'material-memoform', 'chehol-outlast','collectio_superiore','pillows-filter','orthopedic_pillows'),
		'parent_name' => 'Ортопедические подушки',
...
'banner_product' => '/img/Layer 1.png',
	...
	array(
		...
		'parent_address' => 'pillows',
		'parent_address2' => 'pillows',
		'other_categories' => array('baby-pillows','forma-wolna', 'material-memoform', 'chehol-outlast','collectio_superiore','pillows-filter','orthopedic_pillows','memory-foam-pillows'),
		'parent_name' => 'Ортопедические подушки',
...
'banner_product' => '/img/Layer 1.png',
	...
	array(
		...
		'parent_address' => 'pillows',
		'parent_address2' => 'pillows',
		'other_categories' => array( 'forma-klasicheska', 'material-memoform', 'chehol-viscose','collectio_classico','pillows-filter','orthopedic_pillows','memory-foam-pillows'),
		'parent_name' => 'Ортопедические подушки',
...
'banner_product' => '/img/Layer 1.png',
	...
	array(
		...
		'parent_address' => 'pillows',
		'parent_address2' => 'pillows',
		'other_categories' => array('baby-pillows','forma-wolna', 'material-memoform', 'material-mallowfoam', 'chehol-viscose','collectio_classico','pillows-filter','orthopedic_pillows','memory-foam-pillows'),
		'parent_name' => 'Ортопедические подушки',
...
<br /><br />
		...
		//'available' => array(
			...
			//'msg_product' => '<span style="color: #900;font-size: 17px;">Нет в наличии, ориентировочные сроки поставки: 10.05.2016 </span>',
		//),
		'discount_koef' => array('date_start' => '28.11.2019', 'date_end' => '01.12.2019', 'price_koef' => 0.25),
		'sizes' => false,
		'available' => array(
			'status' => false,
			'msg_category' => 'Нет в наличии',
	...
	array(
		...
		'desc' => '
			...
			<div class="category_product">
							...
							<div class="memory-foam-pillows s-masagnim-effektom forma-klasicheska material-memoform chehol-outlast Collectio_superiore pillows-filter memoform-superiore-deluxe-orthomassage Orthopedic_pillows" name="Подушка" style="display: none;"></div>
...
Это свойство обеспечивает ощущение повышенного комфорта и легкости во время сна и благотворно влияет на позвоночник, позволяя ему расслабиться.
	...
	array(
		...
		'discount_koef' => array('date_start' => '16.12.2019', 'date_end' => '30.12.2019', 'price_koef' => 0.25),
	),
	array(
		'address' => 'sorrento-1',
		'parent_address' => 'plaids',
