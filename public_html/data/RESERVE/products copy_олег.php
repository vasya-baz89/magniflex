...
$products = array(
	...
	array(
		...
		#breadcrumbs {
			...
			<li><b>Высота</b>:  16 см</li><li><b>Степень жесткости</b>: <div class="rigidity rigidity_4" title="жесткий"></div><!--достаточно жесткий--></li>
			...
			<div class="hnb_contmy">
				<div class="hnb_contcenter">
						<div class="half-width">
							...
							<p>
							Модель Merino (прежнее название " Magniflex Merinos", "Model S") – легендарный итальянский матрас фабрики Magniflex, созданный более 20 лет назад. Модель завоевала большую популярность и поставляется до сих пор практически в неизменном виде, лишь с небольшими технологическими улучшениями. Ввиду своей популярности имеет самый большой размерный ряд и наличие на складе в г. Москва. Поставляется в рулонной упаковке по изобретенной технологии Magniflex. Имеет рекомендации ЦИТО (Центральный Институт Травматологии и Ортопедии имени Приорова), а также удостоверение Минздрава.
							</p>
							<h3>Комфорт в любое время года</h3>
							<strong><i>Двухсторонний матрас с чехлом «зима/лето»</i></strong>
							<p>
							Матрас Magniflex Merino (Merinos) оснащается двусторонним несъемным чехлом с «зимней» и «летней» сторонами. «Летняя» поверхность матраса, а также боковины выполнены из 100% натурального хлопка двойного кручения. Материал натуральный, имеет высокий уровень износостойкости за счет своей плотности. «Зимняя» сторона выполнена из натуральной шерсти тонкорунного мериноса. Материал гипоаллергенный: не вызывает зуд кожи и приятен тактильно. Шерсть создает терапевтический эффект, благодаря тепловому барьеру между кожей и окружающей средой.
							</p>
						</div>
...
VK.Widgets.Like("vk_like", {type: "button"});
	...
	array(
		...
		<style>
			...
			<div style="position:relative; clear:both;">
    <script type="text/javascript">VK.init({apiId: 4977479, onlyWidgets: true});</script><div style=" float: left;" id="vk_like"></div><script type="text/javascript">VK.Widgets.Like("vk_like", {type: "button"});</script>
...
<div class="half-width_img"><img  src="/img/products/mattresses/style_mattress.jpg" alt="Ортопедический матрас Magniflex из коллекции Stile"></div>
	...
	array(
		...
		<style>
			...
			<ul><li>
			СДЕЛАНО В ИТАЛИИ, OEKO-TEX®, EC</li>
			<li><b>Высота</b>:  20см</li><li><b>Степень жесткости</b>: <div class="rigidity rigidity_4" title="жесткий"></div> Жесткий</li>
    ...
    //   'small_img' => '/img/product/small/Carezza 10 3-4 PEDANA.jpg',
      ...
      'rec_buy' => '
		...
		'desc' => '
         ...
         <div class="common_block_common fixcommon-block">
				<div class="half-width fixcommon-block">
                <h3>Стильный дизайн коллекции премиум класса</h3>
				<p class="text-jus">
				Коллекция матрасов Carezza – это сочетание самых передовых технологий и материалов в совокупности с изысканным итальянским дизайном. Поддержка, предлагаемая этими матрасами сравнима с эффектом обволакивающего объятия, которое длится всю ночь. Выбранные материалы для этой коллекции сочетают мягкость материалов с необычайной способностью циркуляции воздуха, что придает невероятную свежесть и комфорт во время сна.<br /><br />
Также гарантируется расслабление тела благодаря внутреннему слою с инновационным материалом Aquabreeze, пеной на водной основе с молекулярной структурой открытой ячейки, которая способствует циркуляции воздуха и обеспечивает свежесть во время сна. <br /><br />

Слой материала Elioform состоит из микропористой пены, сочетающей эластичность и воздухопроницаемость. Elioform обеспечивает упругую поддержку спины, при относительно мягком чехле и средней жесткости материале Aquabreeze. Несмотря на мягкость верхней части матраса, поддержка спины довольно упругая с сохранением ортопедических и анатомических свойств матраса.<br /><br />

Carezza – матрас, который может быть мягким и приятным и при этом гарантировать высокий уровень поддержки спины, что также может быть комфортным для людей с большим весом, так как будет отсутствовать ощущение «проваливания» поясницы, что может быть на слишком мягком матрасе, например.
				</p>
            	</div>
				<div class="half-width fixcommon-block">
					<h3>Чехол - Viscose®, не съемный с рисунком флорентийской лилии</h3>
					<p class="text-jus">
					Матрас имеет чехол из материала viscose, что представляет из себя мягкое и шелковистое высокотехнологичное волокно, которое придает коже удивительное ощущение мягкости. Этот матрас, заполненный материалами в чехле Memosoft и Super Soft Fiber, гарантирует необыкновенный воздухопроницаемый, мягкий и обволакивающий комфорт. <br /><br />
					Несъемный терморегулирующий чехол с запатентованной технологией Viscose. Элегантная объемная ткань.
					</p>
...
Это очень удобно и практично. Если один человек предпочитает мягкий матрас, а его партнер – жесткий, то им достаточно повернуть блоки в нужные им положения и наслаждаться комфортом.
	...
	array(
		...
		#breadcrumbs {
			...
			<ul><li>
			СДЕЛАНО В ИТАЛИИ, OEKO-TEX®, EC</li>
			<li><b>Высота</b>:  23 см</li><li><b>Степень жесткости</b>: <div class="rigidity rigidity_3" title="средней жесткости"></div><!--Средней жесткости--></li>
	...
	array(
		...
		#breadcrumbs {
			...
			<ul><li>
			СДЕЛАНО В ИТАЛИИ, OEKO-TEX®, EC</li>
			<li><b>Высота</b>:  25 см</li><li><b>Степень жесткости</b>: Регулируемая<!--Средней жесткости--></li>
...
Слой Eliosoft 8.5 см - это более мягкий материал, чем Elioform. Сверху и снизу закрыты слоями по 5 см мемори с эффектом памяти. Матрас довольно мягкий и потрясающе комфортный.				
	...
	array(
		...
		#breadcrumbs {
			...
			<ul><li>
			СДЕЛАНО В ИТАЛИИ, OEKO-TEX®, EC</li>
			<li><b>Высота</b>:  30 см</li><li><b>Степень жесткости</b>: Регулируемая<!--Средней жесткости / Жесткий 4 комбинации комфорта--></li>
...
Идеальный матрас с потрясающими свойствами, настоящее воплощение мечты! Высокотехнологичный матрас Premium класса, обладающий 6-ю уровнями комфорта (жесткий, умеренный, идеальный, комбинированный 3 варианта), обеспечивает потребителю возможность самостоятельно смоделировать оптимальный уровень комфорта. Высокий анатомический и ортопедический эффекты, в сочетании с терморегулирующими свойствами чехла, делают этот матрас идеальной системой комфортного сна и отдыха.
			...
			<div class="common_block_common fixcommon-block">
				<div class="half-width fixcommon-block">
				<h3>Элитный ортопедический «матрас-конструктор» Magniflex Memoform Dua</h3>
				<!--	<img class="two-width" src="/img/products/mattresses/magniflex_comfort.jpg" alt="Комфорт от Magniflex">-->
					<p class="text-jus">
	...
	array(
		...
		.zoom_btn_tester img{
		  display: block;
			...
			<li><b>Высота</b>:  30 см</li><li><b>Степень жесткости</b>: <div class="rigidity rigidity_2" title="средней мягкости"></div><!--Комфортнейший--></li>
		...
		'desc' => '
			...
			<div class="common_block_common fixcommon-block">
				...
				<h3> Подойдет даже самым маленьким</h3>
					<p class="text-jus">
					Можно использовать как подушку для детей: благодаря своему небольшому размеру и высоте - это отличный вариант научить Вашего ребенка спать правильно, что послужит залогом крепкого здоровья в будущем.
					</p>
				</div>
			</div>
...
VK.Widgets.Like("vk_like", {type: "button"});
		...
		'desc' => '
			...
			<div class="common_block_common">
				...
				<strong><i>Ортопедическая подушка волнообразной формы с охлаждающим эффектом</i></strong>
					<p>??????? ТЕКСТ ВСТАВИТЬ! Подушка Memoform Superiore Deluxe Comfort — улучшенный вариант популярной модели Comfort.
	...
	array(
		...
		#breadcrumbs {
			...
			<ul><li>ГЕЛЕВАЯ ПОДУШКА, СДЕЛАНО В ИТАЛИИ, OEKO-TEX®, EC</li><li><b>Размер</b>: 72x42x12 см</li><li><b>Уровень комфорта</b>: Умеренно мягкий, упругая подушка.</li></li><li><b>Срок службы</b>: не менее 15 лет</li></ul><br>
			<div style="position:relative; clear:both;">
    <script type="text/javascript">
  VK.init({apiId: 4977479, onlyWidgets: true});
</script>
