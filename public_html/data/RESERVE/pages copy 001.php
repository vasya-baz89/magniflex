			...
			'text' => '
				<div class="sl_top">
                    <div class="main_sl">
						...
						<div class="ama_main_slide">
							<img class="mobLeft-15vh" src="/img/Slide01.png" alt="Новогодняя скидка 10%!" />
							<div class="ama_main_slide_text_center">
						...
						<div class="ama_main_slide">
							<img  class="mobLeft15vh" src="/img/Slide02.png" alt="Новогодняя скидка 10%!" />
							<div class="ama_main_slide_text_center">
						...
						<div class="ama_main_slide">
							<img  class="mobLeft-20vh" src="/img/Slide03.png" alt="Новогодняя скидка 10%!" />
							<div class="ama_main_slide_text_center">
						...
						<div class="ama_main_slide">
							<img  class="mobLeft-30vh" src="/img/Magnistretch.jpg" alt="Новогодняя скидка 10%!" />
							<div class="ama_main_slide_text_center">
                ...
                <div class="titleSubtitle titleSubtitle--home">
                    <h2 class="title title--blue">Коллекции Magniflex<br>
                        Настоящие шедевры, когда речь идет о комфорте и отдыхе
                    </h2>
                    <p class="subtitle subtitle--grey">
                        Каждый продукт отражает страсть и преданность, делает<br>
							матрасы Magniflex уникальными и неповторимыми
                    </p>
                </div>
                ...
                <div class="ama_blocks_general">
                    <div class="card link-this">
                         <a href="/catalog/elitnye-comfort-delux/" class="info-link">
                            <img src="/img/DOLCE-VITA-quadrata.jpg" alt="The Italian-style sleep  that makes life sweeter than ever" title="The Italian-style sleep  that makes life sweeter than ever" class="img-responsive ">
                        </a>
                        <div class="info">
                            <a href="/catalog/elitnye-comfort-delux/" class="info-link">
                                <h2 class="title title--card">
                                    Итальянский стиль сна<br>
									это делает жизнь слаще, чем когда-либо
                                </h2>
                                <p class="subtitle subtitle--card">Отличный комфорт для<br>опыт сна, как никто другой.</p>
                            </a>
                            <a href="/catalog/elitnye-comfort-delux/" class="button button--card">УЗНАЙТЕ КОЛЛЕКЦИЮ Comfort Delux</a>
                        </div>
                    </div>
                    <div class="card link-this">
                         <a href="/catalog/elitnye-stretching/" class="info-link">
                            <img src="/img/Magnismartech.jpg" alt="The Italian-style sleep  that makes life sweeter than ever" title="The Italian-style sleep  that makes life sweeter than ever" class="img-responsive ">
                        </a>
                        <div class="info">
                            <a href="/catalog/elitnye-stretching/" class="info-link">
                                <h2 class="title title--card">
                                ...
                                <p class="subtitle subtitle--card">Система кровати, которая<br>
								произойдет революция в том, как вы спите.</p>
                            </a>
                            <a href="/catalog/elitnye-stretching/" class="button button--card">ОТКРОЙТЕ СИСТЕМУ КРОВАТИ MAGNISMARTECH</a>
                        </div>
                    </div>
                    <div class="card link-this">
                         <a href="/catalog/elitnye-freshgel/" class="info-link">
                            <img src="/img/Magnigel_2.jpg" alt="The Italian-style sleep  that makes life sweeter than ever" title="The Italian-style sleep  that makes life sweeter than ever" class="img-responsive ">
                        </a>
                        <div class="info">
                            <a href="/catalog/elitnye-freshgel/" class="info-link">
                                <h2 class="title title--card">
								...
								<p class="subtitle subtitle--card">Легкий, воздушный, дышащий, необыкновенно проницаемый.</p>
                            </a>
                            <a href="/catalog/elitnye-freshgel/" class="button button--card">О Коллекция FRESHGEL</a>
                        </div>
                    </div>
                    <div class="card ama_last_card">
                        <div class="card link-this" style="background:url(/img/Magnigel-dual-12.jpg);">
							<a href="/catalog/elitnye-freshgel/new-freshgel-10/" class="info-link">
								<div class="info">
									<div class="button-card">
										<span class="first-line"></span>
										<span class="second-line"></span>
									</div>
									Откройте для себя новый FRESHGEL Dual 10
								</div>
							</a>
                        </div>
                        <div class="card link-this " style="background:url(/img/Topper-Magnigel.jpg);">
							<a href="/catalog/elitnye-freshgel/new-freshgel-12/" class="info-link">
								<div class="info">
									<div class="button-card">
										<span class="first-line"></span>
										<span class="second-line"></span>
									</div>
									Откройте для себя новый FRESHGEL Dual 12
								</div>
							</a>
                        </div>
                        <div class="card link-this ">
                            <img src="/img/freshgel-wave.jpg" alt="" title="" class="img-responsive ">
							<a href="/catalog/gelevye-podushki/FreshGel+Wave/" class="info-link">
								<div class="info">
									<div class="button-card">
										<span class="first-line"></span>
										<span class="second-line"></span>
									</div>
									Откройте для себя FRESHGEL WAVE
								</div>
							</a>
                        </div>
                        <div class="card link-this ">
                            <img src="/img/freshgel_standard.jpg" alt="" title="" class="img-responsive ">
							<a href="/catalog/gelevye-podushki/Memoform-Magnigel-Standard/" class="info-link">
								<div class="info">
									<div class="button-card">
										<span class="first-line"></span>
										<span class="second-line"></span>
									</div>
									Откройте для себя новый MEMOFORM MAGNIGEL DELUXE STANDARD
								</div>
							</a>
                        </div>
                    </div>
                ...
                <div class="ama_cases">
                    <div class="card" style="width: 100%">
                        <a href="/o-magniflex/company/" class="info-link">
                            ...
                            <div class="info">
                                <p class="title title--sup">НАША СУЩНОСТЬ </p>
                                <h2 class="title title--card">
									Совершенство<br>
									итальянская традиция
                                </h2>
                                <p class="subtitle subtitle--card">Тонкое мастерство и итальянская изобретательность всегда<br>
									дал жизнь продуктам, которые известны во всем мире.</p>
                            </div>
                        </a>
                    </div>
                    <div class="ama_flex_cases">
                        <div class="card">
                            <a href="/catalog/mattresses/" class="info-link">
                                ...
                                <div class="info">
                                    <p class="title title--sup">СПАТЬ ХОРОШО</p>
                                    <h2 class="title title--card">

										Чтобы жить хорошо <br>
										должен хорошо спать
                                    </h2>
                                    <p class="subtitle subtitle--card">Хороший сон необходим для здорового образа жизни и основная<br>
								необходимость, и это больше, чем просто удовольствие.</p>
                                </div>
                            </a>
                        </div>
                        <div class="card">
                            <a href="/production/fabric-and-treatments/" class="info-link">
                                ...
                                <div class="info">
                                    <p class="title title--sup">МАТЕРИАЛЫ</p>
                                    <h2 class="title title--card">
                                        Ведущий производитель <br>
										матрасов в Италии
                                    </h2>
                                    <p class="subtitle subtitle--card">Magniflex полагается на лучшие решения для удовлетворения всех <br>
										потребностей своих клиентов, когда речь идет о комфорте.</p>
                                </div>
                            </a>
                        </div>
                    </div>
