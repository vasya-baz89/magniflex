...
$get_breadcrumbs_product = function($item){
	$breadcrumbs_ret = array(array('Главная','/'),array('Каталог','/catalog/' . $item['parent_address2']));
	...
	array(
		...
		'small_desc' => '
			<div class="ama_product_desc">
				<p align="left" class="spec-left">HEIGHT</p>
				<p align="right" class="spec-right">13 Cm</p>
				<p align="left" class="spec-left">COATING</p>
				<p align="right" class="spec-right">Viscose</p>
				<p align="left" class="spec-left">COMFORT</p>
				<p align="right" class="spec-right">Firm</p>
			</div>
		',
		...
		'attr_cat_product1' => '13 см',
		'attr_cat_product2' => 'Съемный outlast/viscose.',
		'attr_cat_product3' => 'средней жесткости/средней мягкости',
		'attr_cover_product' => '',
		'attr_padding_product' => 'Ортопедический матрас Merino Magniflex состоит исключительно из природных, экологически чистых материалов, летняя сторона - 100% натуральный хлопок
		 зимняя сторона - 100% натуральная шерсть тонкорунного мериноса ',
...
экологически чистых материалов.<br><br><br>
		...
		'sizes' => array(
			...
			array('100x200 (не в рулоне, новый)',25000.00),
		...
		//  'discount_koef' => array('date_start' => '14.12.2018', 'date_end' => '31.05.2019',
		// 	'sizes' => array(
        //         '100x200 (не в рулоне, новый)'
        //     ),
		// 	'prices' => array(
		// 		'100x200 (не в рулоне, новый)' => 20000.00
		// 	),
		// ), //скидка
...
Современная вспененная латексная пена Elioform Magniflex обладает мелкопористой структурой и высокой плотностью, за счет чего материал обладает повышенными свойствами циркуляции воздуха и большим сроком службы. При эксплуатации матраса при воздействии на него с какой-либо стороны воздух выдувает все внутренние пылевые и другие элементы, гарантируя защиту от появления пылевых клещей.</p>
	...
	<div class="half-width_img">
		...
		'small_desc' => '
        <span class="hnb_popular">
        Жесткая поддержка спины.
        </span>
			<p class="hnb_harek">
			Упругий матрас с трикотажным чехлом.<br>
Высота: 18 см.<br>
...
<div class="half-width_img" ><img  src="/img/product/big/stile-6.jpg"></div>
		...
		'sizes' => array(
			...
			array('90x190 (не в рулоне, новый)',26900.00),
		...
		'discount_koef' => array('date_start' => '14.12.2018', 'date_end' => '31.12.2018',
			'sizes' => array('90x190 (не в рулоне, новый)'),
			'prices' => array(
                '90x190 (не в рулоне, новый)' => 21520.00
			),
		), //скидка
...
<
	...
	array(
		...
		'small_desc' => '
        <span class="hnb_popular">
        Жесткая поддержка спины + эффект памяти.
        </span>
			<p class="hnb_harek">
			Более комфортный вариант матраса Stile, добавлен слой с эффектом памяти.<br>
Высота: 15 см.<br>
...
VK.Widgets.Like("vk_like", {type: "button"});
    ...
    <div class="fb-like" style="  float: left;" data-href="https://www.magniflex.ru/catalog/orthopedic_mattresses/MERINO-BAMBOO/" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true"></div>
		...
		'sizes' => array(
			...
			array('200x210 (не в рулоне, новый)',82700.00),
		),
		'discount_koef' => array('date_start' => '14.12.2018', 'date_end' => '31.12.2018',
			'sizes' => array('80x200 (не в рулоне, новый)', '200x210 (не в рулоне, новый)'),
			'prices' => array(
                '80x200 (не в рулоне, новый)' => 26560.00,
				'200x210 (не в рулоне, новый)' => 66160.00
			),
		), //скидка
	),
	array(
...
VK.Widgets.Like("vk_like", {type: "button"});
	...
	array(
		...
		'small_desc' => '
        <span class="hnb_popular">
        Упругая поддержка спины
        </span>
			<p class="hnb_harek">
			Двусторонний матрас зима/лето.<br>
Высота: 18 см.<br>
Жесткость: средней жесткости.<br>
Наполнитель: Waterlattex.<br>
Чехол: несъемный, 100% шерсть мериноса/хлопок с пропиткой Teflon.<br>
Сделано в Италии.<br>
                 </p>
		',
		'attr_cat_product1' => '18 см',
...
<br><br>
		...
		'sizes' => array(
			...
			array('190x205 (не в рулоне, новые)',64800.00),
			array('200x200',71900.00),
		),
        'discount_koef' => array('date_start' => '1.7.2015', 'date_end' => '30.04.2019',
            'sizes' => array(
				'80x190',
				'80x200',
				'90x190',
            ...
            'prices' => array(
				...
				'180x195' => 56700.00,
				'180x200' => 58320.00,
				'190x205 (не в рулоне, новые)' => 51840.00,
				'200x200' => 64710.00,
            ),
		), //скидка
        ...
        Бархатный, волокна древесины
			...
			<p class="hnb_harek">
			Эффект памяти, повышенный уровень комфорта, чехол с волокнами белой пихты.<br>
Высота: 22 см.<br>
Жесткость: средней жесткости.<br>
Наполнитель: Eliosoft, Memoform.<br>
Чехол: несъемный, Wooden fiber.<br>
Сделано в Италии.
                 </p>
		',
...
<br><br>
      ...
      <i>Материал Memoform Magniform (дорогая технология создающая "эффект памяти") находится с двух сторон. Общая высота - 4 см!</i>
		...
		'sizes' => array(
			...
			array('90x200 (не в рулоне, новый)',43200.00),
		...
		'discount_koef' => array('date_start' => '1.7.2015', 'date_end' => '31.01.2019',
            'sizes' => array('80x190','80x200','90x190','90x200','90x200 (не в рулоне, новый)','120x190','120x200','140x190','140x200','160x190','160x195','160x200','170x200','180x200','200x200'),
            'prices' => array(
                '90x200 (не в рулоне, новый)' => 34560.00
            ),
        ), //скидка
		'discount_koef' => array('date_start' => '04.03.2019', 'date_end' => '11.03.2019', 'price_koef' => 0.1),
		'yml_desc' => '
	...
	array(
		...
		'small_desc' => '
        <span class="hnb_popular">
        Комфортный, расслабляющий.
        </span>
			<p class="hnb_harek">
			Терморегуляция чехла coolmax, 6 см слоя с эффектом памяти.<br>
Высота: 20 см.<br>
Жесткость: средней жесткости/мягкий.<br>
Наполнитель: Elioform, Memoform.v
Чехол: несъемный, Coolmax.<br>
Сделано в Италии.
                 </p>
		',
		'attr_cat_product1' => '20 см',
...
VK.Widgets.Like("vk_like", {type: "button"});
	...
	array(
		...
		'small_desc' => '<span class="hnb_popular">
        Массажный эффект.
        </span>
        <p class="hnb_harek">
        Мульти-зональный матрас, оказывающий массажный эффект.<br>
Высота: 20 см.<br>
Жесткость: средней жесткости.<br>
Наполнитель: Elioform, Eliosoft, Memoform.<br>
...
<div style="clear:both;"></div>
    ...
    array(
      ...
      'small_desc' => '
        ...
        <p class="hnb_harek">
              Высота: 25 см.<br>
              Жесткость: мягкий с упругой поддержкой.<br>
              Наполнитель: Elioform, Aquabreeze, Memosoft.<br>
              Чехол: несъемный, Viscose.<br>
              Сделано в Италии.
                   </p>
	  ',
	  ...
	  'discount_koef' => array('date_start' => '01.02.2019', 'date_end' => '31.04.2019', 'price_koef' => 0.30),
    ...
    array(
		...
		'small_desc' => '
			...
			<p class="hnb_harek">Строгий классический дизайн, повышенный уровень комфорта, эффект памяти.<br>
            Высота: 23 см.<br>
            Жесткость: Жесткий<br>
            Наполнитель: Elioform, Memoform.<br>
            Чехол: несъемный, viscose.<br>
...
была удостоена одной из главных наград выставки.
	...
	array(
        ...
        <p class="hnb_harek">Строгий классический дизайн, более мягкий, чем Rest 9. Эффект памяти.<br>
        Высота: 25 см.<br>
        Жесткость: средней жесткости.<br>
        Наполнитель: Elioform, Eliosoft, Memoform.<br>
        Чехол: несъемный, viscose.<br>
...
была удостоена одной из главных наград выставки.
	...
	array(
		...
		'small_desc' => '
			...
			<p class="hnb_harek">Строгий классический дизайн, более мягкий, чем Rest 10.<br>
            Высота: 30 см.<br>
            Жесткость: средней мягкости.<br>
            Наполнитель: Elioform, Eliosoft, Memoform.<br>
            Чехол: несъемный, viscose.<br>
            Сделано в Италии.
                 </p>
...
беспружинный. Две стороны для эксплуатации.</h3>
		...
		/*'discount_koef' => array('date_start' => '14.12.2018', 'date_end' => '31.12.2018',
			...
			'prices' => array(
                '90x200 (не в рулоне, новый)' => 46480.00
			),
		), *///скидка
	...
	array(
		...
		'small_desc' => '
			...
			<p class="hnb_harek">Регулируемая жесткость, терморегулирующий чехол с космическими технологиями outlast.<br>
            Высота: 25 см.<br>
            Жесткость: средней жесткости/средней мягкости, dual.<br>
            Наполнитель: Eliosoft, Memoform.<br>
            Чехол: съемный на молнии, outlast/viscose.<br>
            Сделано в Италии
                 </p>
		',
		'attr' => '
		...
		'discount_koef' => array('date_start' => '14.12.2018', 'date_end' => '31.12.2018',
			'sizes' => array('90x200 (не в рулоне, новый)'),
			'prices' => array(
                '90x200 (не в рулоне, новый)' => 50880.00,
			),
		), //скидка
	...
	array(
		...
		'small_desc' => '
			...
			<p class="hnb_harek">Регулируемая жесткость, терморегулирующий чехол с космическими технологиями outlast. Более мягкий, чем Comfort plus 10.<br>
            Высота: 30 см.<br>
            Жесткость: средней мягкости/мягкий, dual.<br>
            Наполнитель: Eliosoft, Eliosoft, Memoform.<br>
            Чехол: съемный на молнии, outlast/viscose.<br>
            Сделано в Италии.
                 </p>
		',
	...
	array(
		...
		'small_desc' => '
			...
			<p class="hnb_harek">Матрас с охлаждающим эффектом, не жарко и комфортно.<br>
            Высота: 23 см.<br>
            Жесткость: средней мягкости.<br>
            Наполнитель: Magnigel, Eliosoft, Memoform.<br>
            Чехол: съемный на молнии, viscose.<br>
            Сделано в Италии.
                 </p>
		',
	...
	array(
		...
		'small_desc' => '
			<span class="hnb_popular">
			Сон на облаке. Технология dual
			</span>
			<p class="hnb_harek">Регулируемая жесткость, с охлаждающим эффектом, не жарко и комфортно. Более мягкий, чем Freshgel 9.<br>
            Высота: 25 см.<br>
            Жесткость: средней жесткости/средней мягкости, dual.<br>
            Наполнитель: Magnigel, Eliosoft, Memoform.<br>
            Чехол: съемный на молнии, viscose.<br>
		...
		'discount_koef' => array('date_start' => '01.03.2019', 'date_end' => '30.04.2019', 'price_koef' => 0.30, ), //скидка
    ),
    array(
		...
		'discount_koef' => array('date_start' => '14.12.2018', 'date_end' => '31.12.2018',
			'sizes' => array('90x200 (не в рулоне, новый)'),
			'prices' => array(
                '90x200 (не в рулоне, новый)' => 59680.00
			),
		), //скидка
		'discount_koef' => array('date_start' => '04.03.2019', 'date_end' => '11.03.2019', 'price_koef' => 0.1),
    ...
    array(
		...
		'small_desc' => '
			...
			<p class="hnb_harek">Регулируемая жесткость, с охлаждающим эффектом, не жарко и комфортно. Более мягкий, чем Freshgel 12.<br>
            Высота: 30 см.<br>
            Жесткость: средней мягкости/мягкий, dual.<br>
            Наполнитель: Magnigel, Eliosoft, Memoform.<br>
            Чехол: съемный на молнии, viscose.<br>
	...
	array(
		...
		'small_desc' => '
			<span class="hnb_popular">
			Запатентованная технология Magnistretch
			</span>
			<p class="hnb_harek">Слегка растягивает позвоночник, идеально для спортсменов. Чехол с космической технологией терморегуляции Outlast.<br>
            Высота: 23 см.<br>
            Жесткость: средней жесткости.<br>
            Наполнитель: Elioform, Eliosoft, Memoform.<br>
            Чехол: съемный на молнии, outlast/viscose.<br>
...
<!-----
		...
		'discount_koef' => array('date_start' => '14.12.2018', 'date_end' => '31.12.2018',
			'sizes' => array('90x200 (не в рулоне, новый)'),
			'prices' => array(
				'90x200 (не в рулоне, новый)' => 71360.00
			),
		), //скидка
		'yml_desc' => 'Комфортный терморегулирующий матрас  с гелевым слоем Magnigel Foam. Не нагревается от соприкосновения с телом: спать на нем прохладно даже жарким летом. Зимой не “отбирает” тепло! Эффект памяти. Необыкновенно проницаемый, дышащий. Уровень комфорта: достаточно Жесткий Высота: 23 см. Срок службы: не менее 15 лет.',
		'yml_yandex' => array('160x200'),
	...
	array(
		...
		'small_desc' => '
			<span class="hnb_popular">
			Технология dual, мягкий
			</span>
			<p class="hnb_harek">
			Невероятно мягкий и комфортный матрас с максимальным расслаблением. Чехол с космической технологией терморегуляции Outlast.<br>
Высота: 30 см.<br>
Жесткость: средней мягкости/очень мягкий, регулируемый dual core.<br>
Наполнитель: Elioform, Eliosoft, Memoform.<br>
Чехол: съемный на молнии, outlast/viscose, dual.<br>
Сделано в Италии.
                 </p>
		',
		'attr_cat_product1' => '30 см',
...
Коллекция идеально удовлетворяет желания тех, кто ищет возможность максимального расслабления на матрасе. Все матрасы проработаны до мельчайших деталей и используют эксклюзивные ткани и материалы с их превосходными свойствами.
	...
	array(
		...
		'small_desc' => '
			<span class="hnb_popular">
			Технология dual, 6 вариантов жесткости
			</span>
			<p class="hnb_harek">Возможность регулировать жесткость в процессе эксплуатации - 6 комбинаций. Чехол с космической технологией терморегуляции Outlast.<br>
            Высота: 30 см.<br>
            Жесткость: средней жесткости/жесткий, dual.<br>
            Наполнитель: Elioform, Eliosoft, Memoform.<br>
            Чехол: съемный на молнии, outlast/viscose, dual.<br>
            Сделано в Италии.
                 </p>
...
Начинка сделана из супер мягкого фибрового волокна. Материал невероятно мягкий и дышащий, обеспечивает нежную и комфортную поддержку всего вашего тела. Его особый состав обеспечивает ощущение комфорта и улучшает качество сна.
	...
	array(
		...
		'small_desc' => '
			<span class="hnb_popular">
			Премиальная элитная серия
			</span>
			<p class="hnb_harek">
			Зима/лето: Кашемир, меринос, верблюжья шерсть, конский волос / шелк, лён, конский волос, хлопок.<br>
Высота: 30 см.<br>
Жесткость: средней мягкости.<br>
Наполнитель: Elioform Breeze, Memoform HD.<br>
Чехол: несъемный, satin, viscose.<br>
Сделано в Италии.
                 </p>
		',
		'attr_cat_product1' => '30 см',
...
array(
		...
		#breadcrumbs {
			...
			<ul><li>
			<li>Материал: ЛДСП или МДФ</li><li>Категория ткани: на выбор</li>
			<li>Стоимость доставки: бесплатно, срок доставки: завтра для Москвы</li>
		',
		'advantages' => '',
		'desc' => '
...
<img itemprop="image" src="/img/and_imgtopimpack.jpg">
		...
		'discount_koef' => array('date_start' => '01.02.2019', 'date_end' => '31.04.2019', 'price_koef' => 0.20, ), //скидка
...
<img itemprop="image" src="/img/and_imgtopimpack.jpg">
		...
		'discount_koef' => array('date_start' => '04.03.2019', 'date_end' => '30.04.2019', 'price_koef' => 0.2),
...
Сертифицировано ведущими организациями мира. Продается в 98 странах, на 5 континентах.
		...
		'discount_koef' => array('date_start' => '14.12.2018', 'date_end' => '31.12.2018', 'price_koef' => 0.1), //скидка
		//'discount_koef' => array('date_start' => '24.11.2016', 'date_end' => '10.01.2017', 'price_koef' => 0.2, ), //скидка
		//'discount_koef' => array('date_start' => '1.7.2015', 'date_end' => '31.7.2015',
			//'sizes' => array('90x200', '160x200', '180x200'),
			//'prices' => array(
...
VK.Widgets.Like("vk_like", {type: "button"});
    ...
    <div class="fb-like" style="  float: left;" data-href="https://www.magniflex.ru/catalog/vacuum_pillows/RELAXSAN/" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true"></div>
		...
		'desc' => '
			...
			<div class="common_block_common">
				<div class="half-width">
				<h3>Ортопедическая подушка  Memoform Standard Classico</h3>
				<strong><i>Классический итальянский ортопедический матрас премиум класса</i></strong><br><br>
				Ортопедическая подушка «привычной» классической формы, к которой Вам не придется привыкать, в отличие, например, от подушек «волнообразных» форм. В качестве наполнителя используется вспененный материал Memoform Airyform, разработанный специалистами компании Magniflex.  Это последнее на сегодняшний день поколение материала Memoform, обладающее не только перфорацией, но и большим уровнем воздухообмена. Все это позволяет подушке быть "дышащей", а соответственно минимизировать количество пылевых и прочих накоплений, гарантируя чистый свежий и здоровый сон. <br/>
Вязко-эластичный на ощупь материал Memoform Airyform обладает памятью формы, что позволяет обеспечивать поддержку головы и шеи индивидуально для каждого, благодаря выраженному анатомическому эффекту. Отличие материала memoform airyform Magniflex от других аналогов больше всего проявляется в мягкости материала - в продаже редко можно встретить такой приятный на ощупь, нежный и в то же время плотный упругий материал, который обеспечит правильную ортопедическую поддержку и положение.<br/>
...
Подушка сертифицирована в Европе как Medical Device, что гарантирует здоровый, правильный и качественный сон.
	...
	array(
		...
		'img_alt' => '',
		'attr' => '
			<ul><li>Ортопедическая подушка. ПРОИЗВОДСТВО ИТАЛИЯ</li><li>Размеры: 52 x 32 x 5/10 см. Вес: 850 г.</li><li>Уровень комфорта: Высочайший. Мягкая, комфортная, анатомической формы</li><li>Стоимость доставки: бесплатно, срок доставки: завтра для Москвы</li><li>Условия: <a href="/pokupatelyam/oplata-i-dostavka/" target="_blank">доставка</a>, <a href="/pokupatelyam/oplata/" target="_blank">оплата</a></li><li>Срок службы: не менее 15 лет</li></ul><br>
			<div style="position:relative; clear:both;">
    <script type="text/javascript">
  VK.init({apiId: 4977479, onlyWidgets: true});
</script>
...
Подушка сертифицирована в Европе как Medical Device, что гарантирует здоровый, правильный и качественный сон.
		...
		<div class="ama_pillow_desk_block">
			<a href="/production/Cotton/"><img src="/img/cotton_new.jpg" alt="100% натуральный хлопок"></a>
			<a href="/production/Cotton/"><p>Хлопок</p></a>
		</div>
		<div class="ama_pillow_desk_block">
		...
		',
		'sizes' => false,
    'discount_koef' => array('date_start' => '7.12.2015', 'date_end' => '31.11.2018', 'price_koef' => 0.3 ), //скидка
    'available' => array(
			'status' => false,
			'msg_category' => 'Нет в наличии',
			'msg_product' => '<span style="color: #900;font-size: 17px;">Нет в наличии</span>',
...
Подушка сертифицирована в Европе как Medical Device, что гарантирует здоровый, правильный и качественный сон.
	...
	array(
		...
		'title' => 'Гелевая подушка с эффектом памяти Magniflex SUSHI PICCOLO в официальном интернет-магазине Magniflex ',
		'description' => 'Описание, фотографии, состав гелевой подушки с эффектом памяти Magniflex SUSHI PICCOLO',
		'keywords' => 'гелевая подушка, подушка с эффектом памяти, итальянская подушка',
		'small_desc' => '
			<span class="hnb_popular">
			гелевая
		...
		'attr' => '
			...
			<ul><li>Ортопедическая подушка. ПРОИЗВОДСТВО ИТАЛИЯ</li><li>Размер: 42х23х11, с чехлом: 55х29х11 см</li><li>Уровень комфорта: Умеренно мягкий, упругая подушка.</li><li>Стоимость доставки: бесплатно, срок доставки: завтра для Москвы</li><li>Условия: <a href="/pokupatelyam/oplata-i-dostavka/" target="_blank">доставка</a>, <a href="/pokupatelyam/oplata/" target="_blank">оплата</a></li><li>Срок службы: не менее 15 лет</li></ul><br>
			<div style="position:relative; clear:both;">
    <script type="text/javascript">
  VK.init({apiId: 4977479, onlyWidgets: true});
</script>
...
Подушка сертифицирована в Европе как Medical Device, что гарантирует здоровый, правильный и качественный сон.
				...
				<div class="coin-slider">
					<img src="/img/product/pillow_for_travel_SUSHI.jpg" alt="">
				</div>
			</div>
	...
	array(
		...
		'parent_address2' => 'pillows',
		'parent_name' => 'Гелевые подушки',
		'name' => 'Memoform Magnigel Deluxe Standard',
...
Подушка сертифицирована в Европе как Medical Device, что гарантирует здоровый, правильный и качественный сон.
	...
	array(
		...
		'parent_name' => 'Ортопедические подушки',
		'name' => 'Memoform Superiore Deluxe Standard',
...
Подушка сертифицирована в Европе как Medical Device, что гарантирует здоровый, правильный и качественный сон.
	...
	array(
		...
		'parent_name' => 'Ортопедические подушки',
		'name' => 'Memoform Superiore Deluxe Orthomassage',
...
Подушка сертифицирована в Европе как Medical Device, что гарантирует здоровый, правильный и качественный сон.
	...
	array(
		...
		'parent_name' => 'Ортопедические подушки',
		'name' => 'Memoform Superiore Deluxe Wave',
...
Подушка сертифицирована в Европе как Medical Device, что гарантирует здоровый, правильный и качественный сон.
	...
	array(
		...
		'parent_name' => 'Ортопедические подушки',
		'name' => 'Memoform Superiore Comfort',
		...
		'block_attr_extra' => 'Медицинское устройство сертифицировано, на спине, на боку, на животе',
		'attr' => '
			<ul><li>Ортопедическая подушка. ПРОИЗВОДСТВО ИТАЛИЯ</li><li>Размер:  52x32x5/10 cm</li><li>Уровень комфорта: Умеренно мягкая, эффект памяти, фиксация шеи+терморегуляция Outlast.</li><li>Стоимость доставки: бесплатно, срок доставки: завтра для Москвы</li><li>Условия: <a href="/pokupatelyam/oplata-i-dostavka/" target="_blank">доставка</a>, <a href="/pokupatelyam/oplata/" target="_blank">оплата</a></li><li>Срок службы: не менее 15 лет</li></ul><br>
			<div style="position:relative; clear:both;">
    <script type="text/javascript">
  VK.init({apiId: 4977479, onlyWidgets: true});
</script>
...
Подушка сертифицирована в Европе как Medical Device, что гарантирует здоровый, правильный и качественный сон.
	...
	array(
		...
		'parent_name' => 'Ортопедические подушки',
		'name' => 'Memoform Standard Classico',
...
VK.Widgets.Like("vk_like", {type: "button"});
	...
	array(
		...
		'small_desc' => '
			...
			Состав: 100% шерсть<br>
		    Размер: 150х200<br>
			Цвет: Бежевый, светло-коричневый.<br>
Рисунок:  Геометрия, клетка с бахромой.<br>
Производитель: Italian Woollen Treasures S.r.l., Италия.
		...
		'attr' => '
			<ul>
				<li>Состав: 100% шерсть</li>
				<li>Размер: 150х200</li>
				<li>Цвет: Бежевый, светло-коричневый.</li>
				<li>Рисунок:  Геометрия, клетка с бахромой.</li>
				<li>Производитель: Italian Woollen Treasures S.r.l., Италия.</li>
			</ul><br>
			<div style="position:relative; clear:both;">
...
VK.Widgets.Like("vk_like", {type: "button"});
	...
	array(
		...
		'small_desc' => '
			<p class="hnb_harek">
			Состав: 80% шерсть, 20% полиамид<br>
		    Размер: 150х200<br>
...
Производитель: Italian Woollen Treasures S.r.l., Италия.
		...
		'attr' => '
			<ul>
				<li>Состав: 80% шерсть, 20% полиамид</li>
				<li>Размер: 150х200</li>
				<li>Цвет: Слоновая кость.</li>
    ...
    <div class="fb-like" style="  float: left;" data-href="https://www.magniflex.ru/catalog/bases/Topper-Best-Top/" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true"></div>
		...
		<div class="block_line2">
				...
				Высококачественный итальянский плед, производство Италия, Тоскана, Флоренция, г. Прато
					...
					<br><br>
					Пледы коллекции LARA – дизайнерский однотонный плед, который на 80% состоит из натуральной шерсти. Светлый молочный оттенок.
<br><br>
Также в пледе использовано 20% полиамида. Полиамид — это волокно, пропускающее воздух, быстросохнущее, маломнущееся, материал с которым мы постоянно сталкиваемся в быту. Вещи из полиамида прекрасно и довольно долго сохраняют свой первоначальный товарный вид, поскольку данный вид материала особенно устойчив к изнашиванию и состоит из волокон высокой прочности.
<br><br>
...
Плед может служить не только покрывалом для Вашей кровати, но также может использоваться как одеяло или платок. Плед – это практичное и долговечное изделие, не требует частых стирок, в поездках занимает минимум места, в нем не заводятся клещи, избавляет от стресса благодаря терапевтическим свойствам.
<br><br>
Поставляется в разных размерах, на сегодня доступен цвет №1 и размер 150х200. В случае необходимости заказа другого размера или пожеланий по размеру, просьба обращаться по телефонам нашей горячей линии: +7-495-507-22-65 или по электронной почте: info@magniflex.ru
				</div>
				<div class="half-width_img">
					<img src="/img/Lara_1_interior_1.jpg">
				</div>
			</div>
...
VK.Widgets.Like("vk_like", {type: "button"});
    ...
    <div class="fb-like" style="  float: left;" data-href="https://www.magniflex.ru/catalog/bases/Topper-Best-Top/" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true"></div>
		...
		<div class="block_line2">
		<div class="half-width">
		<h3>Итальянский шерстяной плед LARA BORDEAUX</h3>
		Высококачественный итальянский плед, производство Италия, Тоскана, Флоренция, г. Прато
		...
		<div class="half-width_img">
			<img src="/img/product/very_small/LARA-Bordeaux-Internet.jpg">
		</div>
	</div>
		',
		'composition' => '
	...
	array(
		...
		'small_desc' => '
		    ...
		    Размер: 150х200<br>
			Цвет: Красный.<br>
Рисунок: Геометрический узор с бахромой.<br>
Производитель: Italian Woollen Treasures S.r.l., Италия.
                 </p>
		',
		'attr_cat_product1' => '80% шерсть, 20% полиамид',
		...
		'attr' => '
			<ul>
				...
				<li>Размер: 150х200</li>
				<li>Цвет: Красный.</li>
				<li>Рисунок: Геометрический узор с бахромой.</li>
				<li>Производитель: Italian Woollen Treasures S.r.l., Италия.</li>
			</ul><br>
			<div style="position:relative; clear:both;">
    <script type="text/javascript">
...
VK.Widgets.Like("vk_like", {type: "button"});
    ...
    <div class="fb-like" style="  float: left;" data-href="https://www.magniflex.ru/catalog/bases/Topper-Best-Top/" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true"></div>
		...
		<div class="half-width_img">
			<img src="/img/product/very_small/LARA-Rosso-Internet.jpg">
		</div>
	</div>
		',
		'composition' => '
...
VK.Widgets.Like("vk_like", {type: "button"});
	...
	array(
		...
		'attr' => '
			<ul><li>
			<a href="/production/nastoyashchie-ortopedicheskie-matrasy/" target="_blank">Ортопедический матрас.</a> <a href="/production/vacuum-packing/" target="_blank">Вакуумная упаковка.</a> <a href="/production/made-in-Italy/" target="_blank">ПРОИЗВОДСТВО ИТАЛИЯ</a></li>
			<li>Высота: 20, и 22 см</li><li>Степень жесткости: Средняя</li>
			<li>Стоимость доставки: бесплатно, срок доставки: завтра для Москвы</li>
			<li>Условия: <a href="/pokupatelyam/oplata-i-dostavka/" target="_blank">доставка</a>, <a href="/pokupatelyam/oplata/" target="_blank">оплата</a>
			<li>Срок службы: не менее 10 лет</li></ul><br>
			<div style="position:relative; clear:both;">
...
Высота ножки 250-260 мм.<br /><br />
	...
	array(
		...
		'parent_address' => 'tracks',
		'parent_name' => 'Пледы',
		'name' => 'BABILONA AMANDA GREY',
		'other_categories' => array(''),
		'title' => 'Итальянский плед  BABILONA AMANDA GREY',
		'description' => 'Пледы. Пледы, фотографии, описание, характеристики ортопедического BABILONA AMANDA GREY',
		'keywords' => 'Пледы, итальянские пледы',
		'small_desc' => '
			<p class="hnb_harek">
			Состав: 70% хлопок, 30% акрил<br>
		    Размер: 130х170<br>
			Цвет: Серый.<br>
Рисунок: Геометрия, клетка с бахромой.<br>
Производитель: Italian Woollen Treasures S.r.l., Италия.
		...
		'attr' => '
			<ul>
				<li>Состав: 70% хлопок, 30% акрил</li>
				<li>Размер: 130х170</li>
				<li>Цвет: Серый.</li>
				<li>Рисунок: Геометрия, клетка с бахромой.</li>
				<li>Производитель: Italian Woollen Treasures S.r.l., Италия.</li>
			</ul><br>
...
VK.Widgets.Like("vk_like", {type: "button"});
	...
	array(
		...
		'parent_address' => 'tracks',
		'parent_name' => 'Пледы',
		'name' => 'BABILONA Grey/Red',
		'other_categories' => array(''),
		'title' => 'Итальянский плед  BABILONA Grey/Red',
		'description' => 'Пледы. Пледы, фотографии, описание, характеристики ортопедического BABILONA Grey/Red',
		'keywords' => 'Пледы, итальянские пледы',
		'small_desc' => '
			<p class="hnb_harek">
			Состав: 70% хлопок, 30% акрил<br>
		    Размер: 130х170<br>
			Цвет: Серый, красный<br>
Рисунок: Геометрия, клетка с бахромой.<br>
Производитель: Italian Woollen Treasures S.r.l., Италия.
                 </p>
		',
...
Поставляется в разных размерах, на сегодня доступен цвет №1 и №3 и размер 150х200. В случае необходимости заказа другого размера или пожеланий по размеру, просьба обращаться по телефонам нашей горячей линии: +7-495-507-22-65 или по электронной почте: info@magniflex.ru
	...
	array(
		...
		'parent_address' => 'tracks',
		'parent_name' => 'Пледы',
		'name' => 'BABILONA CHECK 305-2',
		'other_categories' => array(''),
		'title' => 'Итальянский плед  BABILONA Grey/Red',
		'description' => 'Пледы. Пледы, фотографии, описание, характеристики ортопедического BABILONA CHECK 305-2',
		'keywords' => 'Пледы, итальянские пледы',
		'small_desc' => '
			<p class="hnb_harek">
			Состав: 70% хлопок, 30% акрил<br>
		    Размер: 130х170<br>
			Цвет: Серый, красный, черный, белый<br>
Рисунок: Геометрия, клетка с бахромой.<br>
Производитель: Italian Woollen Treasures S.r.l., Италия.
                 </p>
		',
		...
		'attr' => '
			<ul>
				<li>Состав: 70% хлопок, 30% акрил</li>
				<li>Размер: 130х170</li>
				<li>Цвет: Серый, красный, черный, белый</li>
				<li>Рисунок: Геометрия, клетка с бахромой.</li>
				<li>Производитель: Italian Woollen Treasures S.r.l., Италия.</li>
			</ul><br>
			<div style="position:relative; clear:both;">
...
VK.Widgets.Like("vk_like", {type: "button"});
    ...
    <div class="fb-like" style="  float: left;" data-href="https://www.magniflex.ru/catalog/bases/Topper-Best-Top/" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true"></div>
		...
		<div class="block_line2">
		<div class="half-width">
		<h3>Итальянский плед BABILONA CHECK 305-2</h3>
		Высококачественный итальянский плед, производство Италия, Тоскана, Флоренция, г. Прато
