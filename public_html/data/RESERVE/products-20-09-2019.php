...
<h3>Cертифицирована как Medical Device</h3>
Подушка сертифицирована в Европе как Medical Device, что гарантирует здоровый, правильный и качественный сон.
				</div>
				<div class="coin-slider">
		...
		'desc' => '
			...
			<div class="common_block_common">
				...
				<strong><i>Ортопедическая подушка волнообразной формы с фиксацией шеи</i></strong>
					...
					<img class="width-fix-prod" src="/img/Layer 5.png" alt="">
				</div>
				<div class="coin-slider">
					<img src="/img/Memoform_Standard_Classico.jpg" alt="">
...
VK.Widgets.Like("vk_like", {type: "button"});
    ...
    Плед может служить не только покрывалом для Вашей кровати, но и использоваться в качестве одеяла или платка. Плед – практичное и долговечное изделие, не требующее частых стирок, в поездках занимает минимум места, в нём не заводятся клещи. Он избавит от стресса благодаря терапевтическим свойствам. <br/>
