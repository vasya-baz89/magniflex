<?php
	...
	$pages = array(
				...
				<div class="sl_top">
                    <div class="main_sl">
						...
						<div class="ama_main_slide">
							...
							<img class="img_lazy_load" src="/img/banners/buffon_choose_magniflex.jpg" data-src="/img/banners/buffon_choose_magniflex.jpg" alt="Джанлуиджи Буффон, капитан сборной Италии, чемпион мира" />
						...
						<div class="ama_main_slide">
							<img class="mobLeft-15vh img_lazy_load" src="/img/Slide01.png" data-src="/img/Slide01.png" alt="Итальянские ортопедические матрасы Magniflex" />
							<div class="ama_main_slide_text_center">
						...
						<div class="ama_main_slide">
							<img  class="mobLeft15vh img_lazy_load" src="/img/Slide02.png" data-src="/img/Slide02.png" alt="Идеальная формула здорового сна от Magniflex" />
							<div class="ama_main_slide_text_center">
						...
						<div class="ama_main_slide">
							<img  class="mobLeft-20vh img_lazy_load" src="/img/Slide03.png" data-src="/img/Slide03.png" alt="Непревздойденный комфорт дарят матрасы и подушки Magniflex" />
							<div class="ama_main_slide_text_center">
						...
						<div class="ama_main_slide">
							<img  class="mobLeft-30vh img_lazy_load" src="/img/Magnistretch.jpg" data-src="/img/Magnistretch.jpg" alt="Натуральные ткани и материалы Magniflex" />
							<div class="ama_main_slide_text_center">
        ...
        <div class="ama_blocks_general">
            ...
            <img class="img-responsive img_lazy_load" src="/img/main/orthopedic_pillow.jpg" data-src="/img/main/orthopedic_pillow.jpg" alt="Ортопедические подушки" title="Итальянские ортопедические подушки Magniflex для всей семьи">
            </a>
                <div class="info">
                <a href="/catalog/pillows/" class="info-link">
            ...
            <img class="img-responsive img_lazy_load" src="/img/main/orthopedic_matresses.jpg" data-src="/img/main/orthopedic_matresses.jpg" alt="Ортопедические матрасы" title="Итальянские ортопедические матрасы Magniflex для детей и взрослых">
            </a>
                <div class="info">
                <a href="/catalog/mattresses/" class="info-link">
            ...
            <img class="img-responsive img_lazy_load" src="/img/main/buffon_magniflex.jpg" data-src="/img/main/buffon_magniflex.jpg" alt="Амбассадор Магнифлекс - Джанлуиджи Буффон" title="Амбассадор бренда - звезда мирового футбола, вратарь Джанлуиджи Буффон">
            </a>
                <div class="info">
                <a href="/o-magniflex/stars-magniflex/" class="info-link">
            ...
            <div class="card ama_last_card">
				...
				<a href="/production/fabric-and-treatments/" class="info-link">
					...
					<div class="button-card">
					  ...
					  Используем космические технологии НАСА
                        ...
                        <div class="card link-this ">
                            <img class="img-responsive img_lazy_load" src="/img/main/magni_04.jpg" data-src="/img/main/magni_04.jpg" alt="Матрасы на пляжах" title="">
                        ...
                        <div class="card link-this ">
                            <img class="img-responsive img_lazy_load" src="/img/main/magni_03.jpg" data-src="/img/main/magni_03.jpg" alt="Матрасы Magniflex в лучших отелях Мира" title="">
				...
				<section class="advantage_grey_block">
					<div class="content_grey_block">
						<div class="item_grey_block">
							<img class="img_lazy_load" src="/img/imgama2_icon1.svg" data-src="/img/imgama2_icon1.svg" alt="img">
						...
						<div class="item_grey_block">
							<img class="img_lazy_load" src="/img/imgama2_icon2.svg" data-src="/img/imgama2_icon2.svg" alt="img">
						...
						<div class="item_grey_block">
							<img class="img_lazy_load" src="/img/imgama2_icon3.svg" data-src="/img/imgama2_icon3.svg" alt="img">
							<p class="number_grey_block">99</p>
							<span class="line_grey_block"></span>
							<p class="text_grey_block">СТРАН<br />более 35 млн покупателей во всем Мире</p>
						</div>
						<div class="item_grey_block">
							<img class="img_lazy_load" src="/img/imgama2_icon4.svg" data-src="/img/imgama2_icon4.svg" alt="instasamka">
                ...
                <div class="ama_cases">
                    <div class="card" style="width: 100%">
                        <a href="/pokupatelyam/certificates/" class="info-link">
                            <img class="img-responsive card--case filtered img_lazy_load" src="/img/case01-new.png" data-src="/img/case01-new.png" alt="Безопасная продукция, не содержат химически вредных и токсичных веществ" title="Excellence is  an Italian tradition">
                            <div class="info">
                    ...
                    <div class="ama_flex_cases">
                        <div class="card">
                            <a href="/o-magniflex/company/" class="info-link">
                                <img class="img-responsive card--case filtered img_lazy_load" src="/img/case02-new.png" data-src="/img/case02-new.png" alt="О компании Магнифлекс">
                                <div class="info">
                        ...
                        <div class="card">
                            <a href="/production/fabric-and-treatments/" class="info-link">
                                <img class="img-responsive card--case filtered img_lazy_load" src="/img/case03-new.png" data-src="/img/case03-new.png" alt="уникальные ткани и материалы" title="уникальные ткани и материалы">
                                <div class="info">
                ...
                <!--<section class="banner banner--store">
                    <div>
                        <p class="title title--store">Мы экспортируем<br>
                            ...
                            в 99 странах</p>
                        <img class="img-responsive img_lazy_load" src="/img/states.png" data-src="/img/states.png" alt="">
                    </div>
                    <div>
				...
				<section class="ama_container data--social">
					...
					<img src="/img/instagram.svg" data-src="/img/instagram.svg" alt="" class="img-responsive social-image img_lazy_load" >
					
                    <p class="title title--social colordx"><img class="img_lazy_load" src="/img/logoX@2x.svg" data-src="/img/logoX@2x.svg" alt="logo">Мы в Instagram</p>
					<ul class="sets_container_insta">
				<!--	<div class="leftdx slick-arrow" style=""><img class="img_lazy_load" src="/img/next.svg" data-src="/img/next.svg" alt=""></div> -->
                        <li class="setheight" style="height: 283px;">
                            <a href="https://www.instagram.com/magniflexrus/" target="_blank" class="data-link">
                                <img class="img_lazy_load" src="/img/slide1.jpg" data-src="/img/slide1.jpg" alt="" title="">
							</a>
							<div class="underblockdx">
							<img class="under_insta_imgdx img_lazy_load"  src="img/magni.jpg" data-src="img/magni.jpg" alt="">
                        ...
                        <li class="setheight" style="height: 283px;">
                            <a href="https://www.instagram.com/magniflexrus/" target="_blank" class="data-link">
                                <img class="img_lazy_load" src="/img/slide2.jpg" data-src="/img/slide2.jpg" alt="" title="">
							</a>
							<div class="underblockdx">
								<img class="under_insta_imgdx img_lazy_load"  src="img/magni.jpg" data-src="img/magni.jpg" alt="">
								<div class="likenamedx">
									<p>@magniflexrus</p>
									<div class="likedx">
										<img class="img_lazy_load" src="img/heart-shape-silhouette.svg" data-src="img/heart-shape-silhouette.svg" alt="">
										<p>11</p>
									</div>
								</div>
							</div>
                        ...
                        <li class="setheight" style="height: 283px;">
                            <a href="https://www.instagram.com/magniflexrus/" target="_blank" class="data-link">
                                <img class="img_lazy_load" src="/img/slidd.jpg" data-src="/img/slidd.jpg" alt="" title="">
							</a>
							<div class="underblockdx">
							<img class="under_insta_imgdx img_lazy_load" src="img/magni.jpg" data-src="img/magni.jpg" alt="">
							<div class="likenamedx">
                        ...
                        <li class="setheight" style="height: 283px;">
                            <a href="https://www.instagram.com/magniflexrus/" target="_blank" class="data-link">
                                <img class="img_lazy_load" src="/img/slide5.jpg" data-src="/img/slide5.jpg" alt="" title="">
							</a>
							<div class="underblockdx">
							<img class="under_insta_imgdx img_lazy_load"  src="img/magni.jpg" data-src="img/magni.jpg" alt="">
							<div class="likenamedx">
						...
						<li class="setheight" style="height: 283px;">
						<a href="https://www.instagram.com/magniflexrus/" target="_blank" class="data-link">
							<img class="img_lazy_load" src="/img/slide6.jpg" data-src="/img/slide6.jpg" alt="" title="">
						</a>
						<div class="underblockdx">
							<img class="under_insta_imgdx img_lazy_load"  src="img/magni.jpg" data-src="img/magni.jpg" alt="">
							<div class="likenamedx">
						...
						<!--	<div class="nextdx slick-arrow" style=""><img class="img_lazy_load" src="/img/next.svg" data-src="/img/next.svg" alt=""></div>-->
                    </ul>
				...
				<div id="slides">
								...
								<div>
									...
									<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/mattresses/MERINOS/"><img class="img_lazy_load" src="/img/slaydcont/merino.jpg" data-src="/img/slaydcont/merino.jpg" alt="матрас магнифлекс меринос" /></a>
									</div>
								...
								<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/detskie-ortopedicheskie-matrasy/"><img class="img_lazy_load" src="/img/slaydcont/merino.jpg" data-src="/img/slaydcont/merino.jpg" alt="матрас магнифлекс меринос детский" /></a>
									</div>
									<div class="hnb_contslidtext">
...
Купить итальянские матрасы Magniflex Merino с ортопедическим эффектом для детей и подростков Вы можете в нашем интернет-магазине.
								...
								<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/mattresses/MERINO-GREEN-TEA/ "><img class="img_lazy_load" src="/img/slaydcont/merino-green-tea.jpg" data-src="/img/slaydcont/merino-green-tea.jpg" alt="матрас магнифлекс green tea" /></a>
									</div>
									<div class="hnb_contslidtext">
...
Модель изготовлена на основе современного материала Eliocel-60, который в большей степени, нежели природный латекс, способен помочь Вам принять максимально удобное положение, выпрямить позвоночник и успокоить нервы. Это становится хорошей профилактикой болезней дыхательной системы и опорно-двигательного аппарата.
								...
								<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/mattresses/MERINO-BAMBOO/"><img class="img_lazy_load" src="/img/slaydcont/merino-bambuk.jpg" data-src="/img/slaydcont/merino-bambuk.jpg" alt="матрас магнифлекс bambo" /></a>
									</div>
									<div class="hnb_contslidtext">
...
Матрас Magniflex Bamboo имеет умеренно жесткую рифленую поверхность, которая дарит комфорт и приятные ощущения, обладает легкими массажными свойствами.
								...
								<div>
									...
									<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/mattresses/WATERLATTEX/ "><img class="img_lazy_load" src="/img/slaydcont/waterlatex.jpg" data-src="/img/slaydcont/waterlatex.jpg" alt="матрас магнифлекс waterlattex " /></a>
									</div>
									<div class="hnb_contslidtext">
...
Матрасы Waterlattex мягкие и комфортные. Они прекрасно подходят пожилым людям и беременным женщинам, а также тем, кто любит спать на животе или на боку.
								...
								<div>
									...
									<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/mattresses/MEMO-MERINO/ "><img class="img_lazy_load" src="/img/slaydcont/memory.jpg" data-src="/img/slaydcont/memory.jpg" alt="матрас магнифлекс Orthomemo Merino" /></a>
									</div>
									<div class="hnb_contslidtext">
...
1 апреля 2015 год.
		...
		array(
			...
			'text' => '
			<!--<span class="red">В случае размещения заказа 2, 3 или 4 ноября ближайшая дата отгрузки 5 ноября.</span><br><br>-->
...
array(
			...
			<div class="news2-block">
				<!--<article class="magazine-article-preview_new is-inview">
					<div class="news_block_with">				
						<a href="/skidki-magniflex/black-friday/" class="magazine-article-preview__image">
		...
		array(
			...
			'breadcrumbs_image' => '/img/breadcrumbs_aziendaok.jpg',
			'text' => '
			<p>Акции с 1 декабря по 30 декабря 2019 года:<br>
			Ликвидация складских остатков, распродажа товаров со склада представительства фабрики в Москве.:<br><br>
			Скидка 20% от розничной цены только на матрасы и размеры из наличия:<br>
			...
			Скидка 30% от розничной цены только на матрасы и подушки, размеры из наличия:<br>
			<a href="/catalog/elitnye-freshgel/freshgel-9/?size=90x200">Ортопедические матрасы Freshgel 9 (90х200) </a><br>
			<a href="/catalog/elitnye-freshgel/freshgel-10/?size=80x200">Ортопедические матрасы Freshgel 10 (80х200) </a><br>
			<a href="/catalog/elitnye-magnificent/magnificent-12/?size=200x200">Ортопедические матрасы Magnificent 12 (200х200) </a><br>
			<a href="/catalog/collectio-memorie/memorie-9/">Ортопедические матрасы Memorie 9 (160x200, 180x200 и 1 шт. 90x200 с экспозиции шоу-рума) </a><br>
...
<div class="hnb_mypoh2sk">
	...
	Осенняя акция на итальянские пледы:<br>
	...
	<p> Более подробную информацию по матрасам с экспозиций можно получить по телефону +7 (495) 989 11 32 или по электронной почте <a href="mailto:info@magniflex.ru">info@magniflex.ru</a></p>
			...
			<table >
				...
				<tr>
					<td>4</td>
					<td><a href="/catalog/elitnye-rest/stile-6/?size=90x200 (не в рулоне, новый)">Stile 6</a></td>
					<td>90x200</td>
					<td>1</td>
					<td>25 400 руб</td>
					<td>17.800 руб.</td>
				...
				<tr>
					<td>6</td>
					<td><a href="/catalog/elitnye-rest/stile-7/?size=160x200 (не в рулоне, новый)">Stile 7</a></td>
					<td>160x200</td>
					<td>1</td>
					<td>50 200 руб</td>
					<td>35.200 руб.</td>
				...
				<tr>
					<td>11</td>
					<td><a href="/catalog/mattresses/MERINOS/?size=160x200">Merinos</a></td>
					<td>160x200</td>
					<td>1</td>
					<td>39 900 руб</td>
					<td>28.000 руб.</td>
			...
			<tr>
				<td>2</td>
				<td><a href="/catalog/elitnye-magnificent/Magnificent-12/?size=160x200 (с экспозиции шоу-рума)">Magnificent 12</a></td>
				<td>160*200</td>
				<td>1</td>
				<td>192 400 руб</td>
				<td>134.700 руб.</td>
