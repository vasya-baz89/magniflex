...
Вы когда-нибудь мечтали спать на облаке? Теперь это становится возможным благодаря матрасам Magniflex Freshgel! Буквально "дышащая" структура материала Magnigel делает сон на матрасе достаточно мягким и свежим, матрас превращается в маленький райский уголок! 
<br>
            <br>
...
Это свойство обеспечивает ощущение повышенного комфорта и легкости во время сна и благотворно влияет на позвоночник, позволяя ему расслабиться.
	...
	array(
		...
		',
		'small_img' => '/img/product/very_small/pledASMANA-400-3.jpg',
		'small_img_alt' => 'ASMANA 400 3',
		'img' => '/img/product/big/pledASMANA-400-3.jpg.png',
		'img_preview' => array('/img/product/big/ASMANA-400-3.jpg'),
		'img_alt' => 'ASMANA 400 3',
		'specialoffer_label' => array(
			'category' => 'label_new_product',
		),
		'attr' => '
			<ul>
				...
				<li style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #dddddd;">Состав: 90% шерсть, 10% кашемир</li>
				<li style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #dddddd;">Размер: 150х200</li>
...
VK.Widgets.Like("vk_like", {type: "button"});
    ...
    <div class="fb-like" style="  float: left;" data-href="https://www.magniflex.ru/catalog/bases/Topper-Best-Top/" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true"></div>
		...
		'desc' => '
			<div class="hnb_elcont3">
						...
						Высококачественные итальянские пледы, производство Италия, Тоскана, Флоренция, г. Прато.
	...
	array(
		...
		',
		'small_img' => '/img/product/very_small/pled2.jpg',
		'small_img_alt' => 'SORRENTO 1',
		'img' => '/img/product/big/pled2.png',
		'img_preview' => array('/img/product/big/SORRENTO-1.jpg'),
		'img_alt' => 'SORRENTO 1',
		'specialoffer_label' => array(
			'category' => 'label_new_product',
		),
		'attr' => '
			<ul>
				...
				<li style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #dddddd;">Состав: 100% шерсть</li>
				<li style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #dddddd;">Размер: 150х200</li>
...
VK.Widgets.Like("vk_like", {type: "button"});
	...
	array(
		...
		'img' => '/img/product/big/pled2.png',
		'img_preview' => array('/img/product/big/SORRENTO-3.jpg'),
		'img_alt' => 'SORRENTO 2',
		'specialoffer_label' => array(
			'category' => 'label_new_product',
		),
...
VK.Widgets.Like("vk_like", {type: "button"});
	...
	array(
		...
		'img' => '/img/product/big/pled2.png',
		'img_preview' => array('/img/product/big/LUCCA-1.jpg'),
		'img_alt' => 'LUCCA 1',
		'specialoffer_label' => array(
			'category' => 'label_new_product',
		),
...
VK.Widgets.Like("vk_like", {type: "button"});
	...
	array(
		...
		'img' => '/img/product/big/pled2.png',
		'img_preview' => array('/img/product/big/LUCCA-3.jpg'),
		'img_alt' => 'LUCCA 3',
		'specialoffer_label' => array(
			'category' => 'label_new_product',
		),
...
VK.Widgets.Like("vk_like", {type: "button"});
	...
	array(
		...
		'name' => 'LARA 1',
		'title' => 'Пледы',
		'description' => 'Пледы. Пледы, фотографии, описание, характеристики ортопедического LARA 1',
		'keywords' => 'Пледы, ',
		'small_desc' => '
			<p class="hnb_harek">
		...
		',
		'small_img' => '/img/product/very_small/pled-white.jpg',
		'small_img_alt' => 'LARA 1',
		'img' => '/img/product/big/pled-white.png',
		'img_preview' => array('/img/product/big/LARA-1.jpeg'),
		'img_alt' => 'LARA 1',
		'specialoffer_label' => array(
			'category' => 'label_new_product',
		),
		'attr' => '
			<ul>
				...
				<li style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #dddddd;">Состав: 80% шерсть, 20% полиамид</li>
				<li style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #dddddd;">Размер: 150х200</li>
...
VK.Widgets.Like("vk_like", {type: "button"});
    ...
    <div class="fb-like" style="  float: left;" data-href="https://www.magniflex.ru/catalog/bases/Topper-Best-Top/" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true"></div>
		...
		'skidka_text' => '
			<span id="skidka2"><b>25%</b> скидка на все подушки при покупке матраса</span>
		',
		'cycle-title' => 'Плед Magniflex LARA 1',
		'cycle-name' => 'Плед Magniflex LARA 1',
		'sizes' => array(
			array('150x200',8100.00),
		),
	),
