<?php
	...
	$pages = array(
				...
				<div class="sl_top">
                    <div class="main_sl">
						<div class="ama_main_slide">
							<img src="/img/buffon_choose_magniflex_bf_fon.jpg" alt="Черная пятница в MAGNIFLEX" />
							<a class="abs-link" href="/skidki-magniflex/black-friday/"></a>
							<div class="ama_main_slide_text_center">
								<p class="ama_slider_title" style="color:#f9df36">Черная Пятница</p>
								<p class="ama_slider_desc">Скидки на матрасы и подушки до 30%</p>
								<a href="/skidki-magniflex/black-friday/" class="button button--blue" style="color: #000;border: 3px solid #f9df36;background-color: #f9df36;">Узнать подробности</a>
							</div>
						</div>
        ...
        <div class="ama_blocks_general">
            ...
            <img src="/img/main/orthopedic_pillow.jpg" alt="Ортопедические подушки" title="Итальянские ортопедические подушки Magniflex для всей семьи" class="img-responsive ">
            </a>
                <div class="info">
                <a href="/catalog/pillows/" class="info-link">
            ...
            <img src="/img/main/orthopedic_matresses.jpg" alt="Ортопедические матрасы" title="Итальянские ортопедические матрасы Magniflex для детей и взрослых" class="img-responsive ">
            </a>
                <div class="info">
                <a href="/catalog/mattresses/" class="info-link">
            ...
            <div class="card ama_last_card">
				...
				<section class="advantage_grey_block">
					<div class="content_grey_block">
						<div class="item_grey_block">
							<img src="/img/imgama2_icon1.png" alt="img">
						...
						<div class="item_grey_block">
							<img src="/img/imgama2_icon2.png" alt="img">
                ...
                <div class="ama_cases">
                    <div class="card" style="width: 100%">
                        <a href="/pokupatelyam/certificates/" class="info-link">
                            <img src="/img/case01-new.png" alt="Безопасная продукция, не содержат химически вредных и токсичных веществ" title="Excellence is  an Italian tradition" class="img-responsive card--case filtered">
                            <div class="info">
                    ...
                    <div class="ama_flex_cases">
                        <div class="card">
                            <a href="/o-magniflex/company/" class="info-link">
                                <img src="/img/case02-new.png" alt="О компании Магнифлекс" class="img-responsive card--case filtered">
                                <div class="info">
                        ...
                        <div class="card">
                            <a href="/production/fabric-and-treatments/" class="info-link">
                                <img src="/img/case03-new.png" alt="уникальные ткани и материалы" title="уникальные ткани и материалы" class="img-responsive card--case filtered">
                                <div class="info">
				...
				<section class="ama_container data--social">
                    ...
                    <p class="title title--social colordx"><img src="/img/logoX@2x.svg" alt="logo">Мы в Instagram</p>
...
array(
		...
		array(
			...
			'breadcrumbs_image' => '/img/breadcrumbs_aziendaok.jpg',
			'text' => '
			<p>Акции с 1 ноября по 30 ноября 2019 года:<br>
		...
		array(
			...
			'text' => '
				...
				<img alt="" src="/img/black_friday.jpg" />
				<p>
					
					<b>с 29 ноября 00:00 - 1 декабря 23:59:</b><br><br>
					
					
					<b>Скидка 10% на все матрасы</b> из наличия на складе (кроме Waterlattex, Orthomemo Merino, Rest 12, Magnificent 12, B-bamboo, Freshgel 9,10, Memorie 9 и Carezza).<br>
					<b>Скидка 25% на подушки</b> из наличия на складе (кроме Freshgel Wave - на нее скидка составляет 30%).<br>
					<b>Скидка 25% на все пледы</b> I.W.T. из наличия на складе.<br><br>
					* скидки не суммируются.<br>
					* скидки только от розничной цены для розничных покупателей.				
				</p>
			'
		),
		array(
