<?php
	...
	$pages = array(
		array(
			...
			'name' => '',
			'left_sidebar' => '',
			'title' => 'MAGNIFLEX — официальный сайт | Итальянские матрасы и подушки',
			'description' => 'Мы - единственные официальные представители Магнифлекс в РФ. Гарантирует самые низкие цены и непревзойденное качество товаров: итальянских ортопедических матрасов и подушек.',
			'keywords' => 'магнифлекс, матрас, сайт, италия, магазин, москва, производство, официальный, итальянский, фирменный, купить, magniflex, матрасы магнифлекс, матрасы magniflex',
			'text' => '
				<div class="sl_top">
                    <div class="main_sl">
						...
						<div class="ama_main_slide">
							<picture>
								...
								<img src="/img/slider/letosale_1.jpg" alt="Скидки 15% на все матрасы и подушки" />
							</picture>
							<div class="ama_main_slide_text_center">
								<p class="ama_slider_title">ОСЕНЬ SALE. СКИДКИ 15%</p>
								<p class="ama_slider_desc">на все матрасы и подушки</p>
								<a href="/discounts/discounts-15pr/" class="button button-red">Подробности акции</a>
							</div>
						</div>
						...
						<div class="ama_main_slide">
							<picture>
								<!--[if IE 9]><video style="display: none;"><![endif]-->
								<source srcset="/img/slider/buffon_choose_magniflex_320.webp" media="(max-width: 320px)" type="image/webp">
								<source srcset="/img/slider/buffon_choose_magniflex_320.jpg" media="(max-width: 320px)">
								<source srcset="/img/slider/buffon_choose_magniflex_340.webp" media="(max-width: 340px)" type="image/webp">
								<source srcset="/img/slider/buffon_choose_magniflex_340.jpg" media="(max-width: 340px)">
								<source srcset="/img/slider/buffon_choose_magniflex_576.webp" media="(max-width: 576px)" type="image/webp">
								<source srcset="/img/slider/buffon_choose_magniflex_576.jpg" media="(max-width: 576px)">
								<source srcset="/img/slider/buffon_choose_magniflex_768.webp" media="(max-width: 768px)" type="image/webp">
								<source srcset="/img/slider/buffon_choose_magniflex_768.jpg" media="(max-width: 768px)">
								<source srcset="/img/slider/buffon_choose_magniflex.webp" media="(min-width: 769px)" type="image/webp">
								<!--[if IE 9]></video><![endif]-->
								<img src="/img/slider/buffon_choose_magniflex.jpg" alt="Джанлуиджи Буффон, капитан сборной Италии, чемпион мира" /> <!-- /img/banners/buffon_choose_magniflex.jpg -->
							</picture>
							<div class="ama_main_slide_text_center">
						...
						<div class="ama_main_slide">
							<picture>
								<!--[if IE 9]><video style="display: none;"><![endif]-->
								<source srcset="/img/slider/Slide01_320.webp" media="(max-width: 320px)" type="image/webp">
								<source srcset="/img/slider/Slide01_320.jpg" media="(max-width: 320px)">
								<source srcset="/img/slider/Slide01_340.webp" media="(max-width: 340px)" type="image/webp">
								<source srcset="/img/slider/Slide01_340.jpg" media="(max-width: 340px)">
								<source srcset="/img/slider/Slide01_576.webp" media="(max-width: 576px)" type="image/webp">
								<source srcset="/img/slider/Slide01_576.jpg" media="(max-width: 576px)">
								<source srcset="/img/slider/Slide01_768.webp" media="(max-width: 768px)" type="image/webp">
								<source srcset="/img/slider/Slide01_768.jpg" media="(max-width: 768px)">
								<source srcset="/img/slider/Slide01.webp" media="(min-width: 769px)" type="image/webp">
								<!--[if IE 9]></video><![endif]-->
								<img src="/img/slider/Slide01.jpg" alt="Итальянские ортопедические матрасы Magniflex" /> <!-- /img/Slide01.png -->
							</picture>
							<div class="ama_main_slide_text_center">
								<p class="ama_slider_title">Итальянские ортопедические матрасы</p>
								<p class="ama_slider_desc">Матрасы №1 в Италии. С 1962 года</p>
								<a href="/o-magniflex/about-magniflex/" class="button button--blue">Узнать больше</a>
							</div>
						</div>
						<div class="ama_main_slide">
							<picture>
								<!--[if IE 9]><video style="display: none;"><![endif]-->
								<source srcset="/img/slider/Slide02_320.webp" media="(max-width: 320px)" type="image/webp">
								<source srcset="/img/slider/Slide02_320.jpg" media="(max-width: 320px)">
								<source srcset="/img/slider/Slide02_340.webp" media="(max-width: 340px)" type="image/webp">
								<source srcset="/img/slider/Slide02_340.jpg" media="(max-width: 340px)">
								<source srcset="/img/slider/Slide02_576.webp" media="(max-width: 576px)" type="image/webp">
								<source srcset="/img/slider/Slide02_576.jpg" media="(max-width: 576px)">
								<source srcset="/img/slider/Slide02_768.webp" media="(max-width: 768px)" type="image/webp">
								<source srcset="/img/slider/Slide02_768.jpg" media="(max-width: 768px)">
								<source srcset="/img/slider/Slide02.webp" media="(min-width: 769px)" type="image/webp">
								<!--[if IE 9]></video><![endif]-->
								<img src="/img/slider/Slide02.jpg" alt="Идеальная формула здорового сна от Magniflex" /> <!-- /img/Slide02.png -->
							</picture>
							<div class="ama_main_slide_text_center">
						...
						<div class="ama_main_slide">
							<picture>
								<!--[if IE 9]><video style="display: none;"><![endif]-->
								<source srcset="/img/slider/Slide03_320.webp" media="(max-width: 320px)" type="image/webp">
								<source srcset="/img/slider/Slide03_320.jpg" media="(max-width: 320px)">
								<source srcset="/img/slider/Slide03_340.webp" media="(max-width: 340px)" type="image/webp">
								<source srcset="/img/slider/Slide03_340.jpg" media="(max-width: 340px)">
								<source srcset="/img/slider/Slide03_576.webp" media="(max-width: 576px)" type="image/webp">
								<source srcset="/img/slider/Slide03_576.jpg" media="(max-width: 576px)">
								<source srcset="/img/slider/Slide03_768.webp" media="(max-width: 768px)" type="image/webp">
								<source srcset="/img/slider/Slide03_768.jpg" media="(max-width: 768px)">
								<source srcset="/img/slider/Slide03.webp" media="(min-width: 769px)" type="image/webp">
								<!--[if IE 9]></video><![endif]-->
								<img src="/img/slider/Slide03.jpg" alt="Непревздойденный комфорт дарят матрасы и подушки Magniflex" /> <!-- /img/Slide03.png -->
							</picture>
							<div class="ama_main_slide_text_center">
						...
						<div class="ama_main_slide">
							<img src="/img/Magnistretch.jpg" alt="Натуральные ткани и материалы Magniflex" />
							<div class="ama_main_slide_text_center">
        ...
        <h1 class="title title--blue">Итальянские ортопедические матрасы и подушки</h1>
        ...
        <div class="ama_blocks_general">
			...
			<picture>
				<!--[if IE 9]><video style="display: none;"><![endif]-->
				<source srcset="/img/index/orthopedic_pillow_320.webp" media="(max-width: 320px)" type="image/webp">
				<source srcset="/img/index/orthopedic_pillow_320.jpg" media="(max-width: 320px)">
				<source srcset="/img/index/orthopedic_pillow_360.webp" media="(max-width: 360px)" type="image/webp">
				<source srcset="/img/index/orthopedic_pillow_360.jpg" media="(max-width: 360px)">
				<source srcset="/img/index/orthopedic_pillow_576.webp" media="(max-width: 576px)" type="image/webp">
				<source srcset="/img/index/orthopedic_pillow_576.jpg" media="(max-width: 576px)">
				<source srcset="/img/index/orthopedic_pillow.webp" media="(min-width: 577px)" type="image/webp">
				<!--[if IE 9]></video><![endif]-->
				<img class="img-responsive" src="/img/main/orthopedic_pillow.jpg" alt="Ортопедические подушки" title="Итальянские ортопедические подушки Magniflex для всей семьи">
			</picture>
            </a>
                <div class="info">
                <a href="/catalog/pillows/" class="info-link">
                ...
                <a href="/catalog/pillows/" class="button button--card">Ортопедические подушки</a>
                </div>
            </div>
            <div class="card link-this">
			...
			<picture>
				<!--[if IE 9]><video style="display: none;"><![endif]-->
				<source srcset="/img/index/orthopedic_matresses_320.webp" media="(max-width: 320px)" type="image/webp">
				<source srcset="/img/index/orthopedic_matresses_320.jpg" media="(max-width: 320px)">
				<source srcset="/img/index/orthopedic_matresses_360.webp" media="(max-width: 360px)" type="image/webp">
				<source srcset="/img/index/orthopedic_matresses_360.jpg" media="(max-width: 360px)">
				<source srcset="/img/index/orthopedic_matresses_576.webp" media="(max-width: 576px)" type="image/webp">
				<source srcset="/img/index/orthopedic_matresses_576.jpg" media="(max-width: 576px)">
				<source srcset="/img/index/orthopedic_matresses.webp" media="(min-width: 577px)" type="image/webp">
				<!--[if IE 9]></video><![endif]-->
				<img class="img-responsive" src="/img/main/orthopedic_matresses.jpg" alt="Ортопедические матрасы" title="Итальянские ортопедические матрасы Magniflex для детей и взрослых">
			</picture>
            </a>
                <div class="info">
                <a href="/catalog/mattresses/" class="info-link">
                ...
                <a href="/catalog/mattresses/" class="button button--card">Ортопедические матрасы</a>
                </div>
            </div>
			...
			<picture>
				<!--[if IE 9]><video style="display: none;"><![endif]-->
				<source srcset="/img/index/buffon_magniflex_320.webp" media="(max-width: 320px)" type="image/webp">
				<source srcset="/img/index/buffon_magniflex_320.jpg" media="(max-width: 320px)">
				<source srcset="/img/index/buffon_magniflex_360.webp" media="(max-width: 360px)" type="image/webp">
				<source srcset="/img/index/buffon_magniflex_360.jpg" media="(max-width: 360px)">
				<source srcset="/img/index/buffon_magniflex_576.webp" media="(max-width: 576px)" type="image/webp">
				<source srcset="/img/index/buffon_magniflex_576.jpg" media="(max-width: 576px)">
				<source srcset="/img/index/buffon_magniflex.webp" media="(min-width: 577px)" type="image/webp">
				<!--[if IE 9]></video><![endif]-->
				<img class="img-responsive" src="/img/main/buffon_magniflex.jpg" alt="Амбассадор Магнифлекс - Джанлуиджи Буффон" title="Амбассадор бренда - звезда мирового футбола, вратарь Джанлуиджи Буффон">
			</picture>
            </a>
                <div class="info">
                <a href="/o-magniflex/stars-magniflex/" class="info-link">
                <h2 class="title title--card">Звезды выбирают Magniflex</h2>
            ...
            <div class="card ama_last_card">
                <div class="card link-this" style="background:url(/img/main/martin_magni.jpg);">
				<a href="/production/fabric-and-treatments/" class="info-link">
					...
					<div class="button-card">
					  ...
					  Используем космические технологии НАСА
                        ...
                        <div class="card link-this "  style="background:url(/img/main/magni_02.jpg);">
                        ...
                        <div class="card link-this ">
                            <img class="img-responsive img_lazy_load" src="/img/no-image.png" data-src="/img/main/magni_04.jpg" alt="Матрасы на пляжах" title="">
                        ...
                        <div class="card link-this ">
                            <img class="img-responsive img_lazy_load" src="/img/no-image.png" data-src="/img/main/magni_03.jpg" alt="Матрасы Magniflex в лучших отелях Мира" title="">
				...
				<section class="advantage_grey_block">
					<div class="content_grey_block">
						<div class="item_grey_block">
							<img class="img_lazy_load" src="/img/no-image.png" data-src="/img/imgama2_icon1.svg" alt="img">
						...
						<div class="item_grey_block">
							<img class="img_lazy_load" src="/img/no-image.png" data-src="/img/imgama2_icon2.svg" alt="img">
						...
						<div class="item_grey_block">
							<img class="img_lazy_load" src="/img/no-image.png" data-src="/img/imgama2_icon3.svg" alt="img">
							<p class="number_grey_block">99</p>
							<span class="line_grey_block"></span>
							<p class="text_grey_block">СТРАН<br />более 35 млн покупателей во всем Мире</p>
						</div>
						<div class="item_grey_block">
							<img class="img_lazy_load" src="/img/no-image.png" data-src="/img/imgama2_icon4.svg" alt="instasamka">
...
<div class="hnb_contvideo"></div>
				<script>
				$(document).ready(function(){
					if(!is_mobile()){
					$(\'.hnb_contvideo\').append(\'\
                ...
                <div class="ama_cases">
                    <div class="card" style="width: 100%">
                        <a href="/pokupatelyam/certificates/" class="info-link">
							<picture>
								<!--[if IE 9]><video style="display: none;"><![endif]-->
								<source srcset="/img/index/case01-new.webp" type="image/webp">
								<source srcset="/img/index/case01-new.jxr" type="image/vnd.ms-photo>
								<!--[if IE 9]></video><![endif]-->
								<img class="img-responsive card--case filtered" src="/img/case01-new.png" alt="Безопасная продукция, не содержат химически вредных и токсичных веществ" title="Excellence is  an Italian tradition">
							</picture>
                            <div class="info">
                                <p class="title title--sup">БЕЗОПАСНО</p>
                                <h2 class="title title--card">
									Продукция сертифицирована OEKO-TEX
                                </h2>
                                <p class="subtitle subtitle--card">OEKO-TEX гарантирует, что изделия не содержат химически вредных и токсичных веществ. Безопасно для Вас и для окружающей среды</p>
                            </div>
                        </a>
                    </div>
                    <div class="ama_flex_cases">
                        <div class="card">
                            <a href="/o-magniflex/about-magniflex/" class="info-link">
								<picture>
									<!--[if IE 9]><video style="display: none;"><![endif]-->
									<source srcset="/img/index/case02-new.webp" type="image/webp">
									<source srcset="/img/index/case02-new.jxr" type="image/vnd.ms-photo>
									<!--[if IE 9]></video><![endif]-->
									<img class="img-responsive card--case filtered" src="/img/case02-new.png" alt="О компании Магнифлекс">
								</picture>
                                <div class="info">
                        ...
                        <div class="card">
                            <a href="/production/fabric-and-treatments/" class="info-link">
								<picture>
									<!--[if IE 9]><video style="display: none;"><![endif]-->
									<source srcset="/img/index/case03-new.webp" type="image/webp">
									<source srcset="/img/index/case03-new.jxr" type="image/vnd.ms-photo>
									<!--[if IE 9]></video><![endif]-->
									<img class="img-responsive card--case filtered" src="/img/case03-new.png" alt="уникальные ткани и материалы" title="уникальные ткани и материалы">
								</picture>
                                <div class="info">
                ...
                <!--<section class="banner banner--store">
                    <div>
                        <p class="title title--store">Мы экспортируем<br>
                            ...
                            в 99 странах</p>
                        <img class="img-responsive img_lazy_load" src="/img/no-image.png" data-src="/img/states.png" alt="">
                    </div>
                    <div>
				...
				<section class="ama_container data--social">
					...
					<img src="/img/no-image.png" data-src="/img/instagram.svg" alt="" class="img-responsive social-image img_lazy_load" >
					
                    <p class="title title--social colordx"><img class="img_lazy_load" src="/img/no-image.png" data-src="/img/logoX@2x.svg" alt="logo">Мы в Instagram</p>
					<ul class="sets_container_insta">
				<!--	<div class="leftdx slick-arrow" style=""><img class="img_lazy_load" src="/img/no-image.png" data-src="/img/next.svg" alt=""></div> -->
                        <li class="setheight" style="height: 283px;">
                            <a href="https://www.instagram.com/magniflexrus/" target="_blank" class="data-link">
                                <img class="img_lazy_load" src="/img/no-image.png" data-src="/img/slide1.jpg" alt="" title="">
							</a>
							<div class="underblockdx">
							<img class="under_insta_imgdx img_lazy_load"  src="/img/no-image.png" data-src="img/magni.jpg" alt="">
							<div class="likenamedx">
								<p>@magniflexrus</p>
								<div class="likedx">
									<img class="img_lazy_load" src="img/heart-shape-silhouette.svg" alt="">
									<p>22</p>
								</div>
							</div>
						</div>
                        ...
                        <li class="setheight" style="height: 283px;">
                            <a href="https://www.instagram.com/magniflexrus/" target="_blank" class="data-link">
                                <img class="img_lazy_load" src="/img/no-image.png" data-src="/img/slide2.jpg" alt="" title="">
							</a>
							<div class="underblockdx">
								<img class="under_insta_imgdx img_lazy_load"  src="/img/no-image.png" data-src="img/magni.jpg" alt="">
								<div class="likenamedx">
									<p>@magniflexrus</p>
									<div class="likedx">
										<img class="img_lazy_load" src="/img/no-image.png" data-src="img/heart-shape-silhouette.svg" alt="">
										<p>11</p>
									</div>
								</div>
							</div>
                        ...
                        <li class="setheight" style="height: 283px;">
                            <a href="https://www.instagram.com/magniflexrus/" target="_blank" class="data-link">
                                <img class="img_lazy_load" src="/img/no-image.png" data-src="/img/slidd.jpg" alt="" title="">
							</a>
							<div class="underblockdx">
							<img class="under_insta_imgdx img_lazy_load" src="/img/no-image.png" data-src="img/magni.jpg" alt="">
							<div class="likenamedx">
                        ...
                        <li class="setheight" style="height: 283px;">
                            <a href="https://www.instagram.com/magniflexrus/" target="_blank" class="data-link">
                                <img class="img_lazy_load" src="/img/no-image.png" data-src="/img/slide5.jpg" alt="" title="">
							</a>
							<div class="underblockdx">
							<img class="under_insta_imgdx img_lazy_load"  src="/img/no-image.png" data-src="img/magni.jpg" alt="">
							<div class="likenamedx">
						...
						<li class="setheight" style="height: 283px;">
						<a href="https://www.instagram.com/magniflexrus/" target="_blank" class="data-link">
							<img class="img_lazy_load" src="/img/no-image.png" data-src="/img/slide6.jpg" alt="" title="">
						</a>
						<div class="underblockdx">
							<img class="under_insta_imgdx img_lazy_load"  src="/img/no-image.png" data-src="img/magni.jpg" alt="">
							<div class="likenamedx">
						...
						<!--	<div class="nextdx slick-arrow" style=""><img class="img_lazy_load" src="/img/no-image.png" data-src="/img/next.svg" alt=""></div>-->
                    </ul>
					<a target="_blank" href="https://www.instagram.com/magniflexrus/" class="button button--blue">Смотреть все</a>
					
				</section>
				<section class="data--videogalleryindex">
					<div class="ama_container oficialRf">
						<p class="title title--social colordx"><img class="img_lazy_load" src="/img/logoX@2x.svg" data-src="/img/logoX@2x.svg" alt="logo" style="opacity: 1;">Мы на Youtube</p>
						<br>
						<div class="sfvideo-gallery">
							<div>
								<a href="javascript:void(0);" class="sfvideo-gallery-a"><img src="/img/poster/1.jpg" alt="" /></a>
								<div class="video-wrapper" data-iframe="https://www.youtube.com/embed/qZJFOiv7g6c"></div>
							</div>
							<div>
								<a href="javascript:void(0);" class="sfvideo-gallery-a"><img src="/img/poster/2.jpg" alt="" /></a>
								<div class="video-wrapper" data-iframe="https://www.youtube.com/embed/oDtTaDvv-SY"></div>
							</div> 
							<div>
								<a href="javascript:void(0);" class="sfvideo-gallery-a"><img src="/img/poster/3.jpg" alt="" /></a>
								<div class="video-wrapper" data-iframe="https://www.youtube.com/embed/SIOX1dEnX2o"></div>
							</div> 
							<div>
								<a href="javascript:void(0);" class="sfvideo-gallery-a"><img src="/img/poster/4.jpg" alt="" /></a>
								<div class="video-wrapper" data-iframe="https://www.youtube.com/embed/PY_GhUbUyXY"></div>
							</div> 
							
							<div>
								<a href="javascript:void(0);" class="sfvideo-gallery-a"><img src="/img/poster/5.jpg" alt="" /></a>
								<div class="video-wrapper" data-iframe="https://www.youtube.com/embed/qZJFOiv7g6c"></div>
							</div>
							<div>
								<a href="javascript:void(0);" class="sfvideo-gallery-a"><img src="/img/poster/6.jpg alt="" /></a>
								<div class="video-wrapper" data-iframe="https://www.youtube.com/embed/oDtTaDvv-SY"></div>
							</div> 
							<div>
								<a href="javascript:void(0);" class="sfvideo-gallery-a"><img src="/img/poster/7.jpg" alt="" /></a>
								<div class="video-wrapper" data-iframe="https://www.youtube.com/embed/SIOX1dEnX2o"></div>
							</div> 
							<div>
								<a href="javascript:void(0);" class="sfvideo-gallery-a"><img src="/img/poster/8.jpg" alt="" /></a>
								<div class="video-wrapper" data-iframe="https://www.youtube.com/embed/3LwIB75ElCc"></div>
							</div> 
						</div> 
						<a target="_blank" href="https://www.youtube.com/c/MagniflexSuRussia/videos" rel="nofollow" title="Перейти на youtube канал Magniflex" class="button button--blue">Смотреть все</a>
					</div>
				</section>'."
				<style>
				.data--videogalleryindex{
					background: #eee;
					padding: 10px;
				}
				.data--videogalleryindex .slick-prev, .data--videogalleryindex .slick-next{
					-webkit-transform: translate(0%, -20px) scale(1.5);
					-ms-transform: translate(0%, -20px) scale(1.5);
					transform: translate(0%, -20px) scale(1.5);
				}
				.data--videogalleryindex .slick-next:before{
					right:0;
				}
				.data--videogalleryindex .slick-prev:hover:before, .data--videogalleryindex .slick-next:hover:before{
					border-left-color: #c10d24;
					border-bottom-color: #c10d24;
				}
				.sfvideo-gallery-a {
					position: relative;
					display: block;
				...
				.slick-slide .sfvideo-gallery-a img {
					transition: all .25s;
					position: relative;
					width: 246px;
					height: 138px;
				}
				.sfvideo-gallery-a:after {
					position: absolute;
					top: 50%;
					left: 50%;
					margin-left: -50px;
					...
					content: ' ';
					display: block;
					background: url(/img/slider/play2.png);
					background-size: contain;
					transition: all .25s;
				}
				.sfvideo-gallery-a:hover img{
					filter: contrast(125%);
				}
				.sfvideo-gallery-a:hover:after{
					transform: scale(1.5);
				}
				.video-wrapper-fixed-overlay{
					display:none;
					position:fixed;
					top:0;
					left:0;
				...
				.video-wrapper-fixed-overlay.active, .video-wrapper-fixed.active{
					display:block;
				}
				.video-wrapper-fixed-close{
					top: -16px;
					right: -16px;
					width: 32px;
					height: 32px;
					...
					border: none;
					border-radius: 50%;
					background-color: rgba(248, 173, 20, 0.9);
				...
				.video-wrapper-fixed-close:hover{
				...
				<script>
				function closeVidWrapFixed(){
					$('.video-wrapper-fixed, .video-wrapper-fixed-overlay').removeClass('active');
					$('.video-wrapper-fixed').html('');
				}
				$(document).ready(function(){
					$('.sfvideo-gallery').slick({
					  slidesToShow: 4,
					  slidesToScroll: 2,
					  autoplay: false,
					  autoplaySpeed: 3000,
    ...
    },
    {
      ...
      settings: {
        ...
        slidesToScroll: 1
				  ...
				  $('.sfvideo-gallery-a').click(function(){
					  $('.video-wrapper-fixed').html('<iframe src=\"'+$(this).parent().find('.video-wrapper').attr('data-iframe')+'\" frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe><div class=\"video-wrapper-fixed-close\" onclick=\"closeVidWrapFixed();\" title=\"Закрыть видео\">x</div>');
					  $('.video-wrapper-fixed, .video-wrapper-fixed-overlay').addClass('active');
				  });
				});
				</script>
				".'
				...
				<div id="slides">
								...
								<div>
									...
									<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/mattresses/MERINOS/"><img class="img_lazy_load" src="/img/no-image.png" data-src="/img/slaydcont/merino.jpg" alt="матрас магнифлекс меринос" /></a>
									</div>
								...
								<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/detskie-ortopedicheskie-matrasy/"><img class="img_lazy_load" src="/img/no-image.png" data-src="/img/slaydcont/merino.jpg" alt="матрас магнифлекс меринос детский" /></a>
									</div>
									<div class="hnb_contslidtext">
...
Купить итальянские матрасы Magniflex Merino с ортопедическим эффектом для детей и подростков Вы можете в нашем интернет-магазине.
								...
								<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/mattresses/MERINO-GREEN-TEA/ "><img class="img_lazy_load" src="/img/no-image.png" data-src="/img/slaydcont/merino-green-tea.jpg" alt="матрас магнифлекс green tea" /></a>
									</div>
									<div class="hnb_contslidtext">
...
Модель изготовлена на основе современного материала Eliocel-60, который в большей степени, нежели природный латекс, способен помочь Вам принять максимально удобное положение, выпрямить позвоночник и успокоить нервы. Это становится хорошей профилактикой болезней дыхательной системы и опорно-двигательного аппарата.
								...
								<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/mattresses/MERINO-BAMBOO/"><img class="img_lazy_load" src="/img/no-image.png" data-src="/img/slaydcont/merino-bambuk.jpg" alt="матрас магнифлекс bambo" /></a>
									</div>
									<div class="hnb_contslidtext">
...
Матрас Magniflex Bamboo имеет умеренно жесткую рифленую поверхность, которая дарит комфорт и приятные ощущения, обладает легкими массажными свойствами.
								...
								<div>
									...
									<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/mattresses/WATERLATTEX/ "><img class="img_lazy_load" src="/img/no-image.png" data-src="/img/slaydcont/waterlatex.jpg" alt="матрас магнифлекс waterlattex " /></a>
									</div>
									<div class="hnb_contslidtext">
...
Матрасы Waterlattex мягкие и комфортные. Они прекрасно подходят пожилым людям и беременным женщинам, а также тем, кто любит спать на животе или на боку.
								...
								<div>
									...
									<div class="hnb_slidimg">
										<a href="https://www.magniflex.ru/catalog/mattresses/MEMO-MERINO/ "><img class="img_lazy_load" src="/img/no-image.png" data-src="/img/slaydcont/memory.jpg" alt="матрас магнифлекс Orthomemo Merino" /></a>
									</div>
									<div class="hnb_contslidtext">
...
<div class="video-wrapper-fixed-overlay" onclick="closeVidWrapFixed();"></div>
<div class="video-wrapper-fixed"></div>
			'
		),
		...
		array(
			...
			<script>
				$(document).ready(function(){
					...
					$(".goodtable").detach().appendTo(".hnb_conttextright")
				})
			</script>
			'
		),
...
'
		...
		array(
			...
			'description' => 'Какие материалы используются для изготовления чехлов для матрасов Magniflex',
			'breadcrumbs_image'=>'/img/breadcrumbs_riposook.jpg',
			'keywords' => '',
			'text' => '
						<a name="mytitlepag"></a>
						<h2 name="hnb_mytitlepag" class="hnb_mytitlepag">Какие материалы используются для изготовления чехлов для матрасов Magniflex</h2>
		...
		array(
			...
			'parent_address' => 'articles',
			'parent_name' => 'Статьи',
			'name' => 'Наполнитель Memoform Magniflex',
			'left_sidebar' => 'catalog',
			'title' => 'Наполнитель Memoform Magniflex: особенности и преимущества',
			'description' => 'Особенности и преимущества пены Memoform Magniflex',
			'breadcrumbs_image'=>'/img/breadcrumbs_riposook.jpg',
			'keywords' => 'memoform magniflex, мемеформ магнифлекс',
			'text' => '
						<a name="mytitlepag"></a>
						<h2 name="hnb_mytitlepag" class="hnb_mytitlepag">Наполнитель Memoform Magniflex: особенности и преимущества</h2>
		...
		array(
			...
			'description' => 'Сравнение пружинных и беспружинных матрасов. ',
			'keywords' => 'какой матрас лучше, пружинный или беспружинный',
			'breadcrumbs_image'=>'/img/breadcrumbs_riposook.jpg',
			'text' => '
						<a name="mytitlepag"></a>
		...
		array(
			...
			'description' => 'Статья о том, какие бывают ортопедические основания, зачем они нужны и как выбрать правильное ортопедическое основание',
			'keywords' => 'ортопедические основания',
			'breadcrumbs_image'=>'/img/breadcrumbs_riposook.jpg',
			'text' => '
						<a name="mytitlepag"></a>
		...
		array(
			...
			'description' => 'Преимущества шерсти мериноса для покрытия ортопедических матрасов',
			'keywords' => 'шерсть мериноса для матрасов',
			'breadcrumbs_image'=>'/img/breadcrumbs_riposook.jpg',
			'text' => '
						<a name="mytitlepag"></a>
...
<a href="/contacts/show-room-matrasov/">Шоу-рум - центральный магазин в Москве</a><br />
...
/* GOOGLE MAPS  */
		...
		array(
			...
			'left_sidebar' => 'production',
			'title' => 'Итальянские вакуумные матрасы Magniflex. Вакуумная упаковка',
			'description' => 'История изобретения вакуумной упаковки матрасов',
			'keywords' => 'вакуумная упаковка патент, кто изобрел вакуумную упаковку матрасов',
			'text' => '
...
<table class="hnb_tabmy">
	...
	<tr>
			...
			'text' => '
				<style>
					...
					<div class="hnb_cart_basket">
						...
						<br />
						<div class="sf_coupon_block">
							<input type="text" minlength="1" maxlength="32" name="coupon" id="input_coupon" placeholder="Введите купон" />
							<a href="javascript:void(0);" id="coupon_btn" title="Нажмите, что бы активировать введеный купон" onclick="set_coupon(\'input_coupon\');">Применить</a>
							<span class="coupon_error">Неверный купон</span>
							<div class="coupon_success">Купон успешно применен. Размер скидки: <span id="coupon_skidka"></span>%. Скидки не суммируются.</div>
						</div>
		...
		array(
			...
			'keywords' => 'матрасы подушки магнифлекс',
			'text' => '
				<!-- Event snippet for Magniflex Начало оформления покупки conversion page -->
				<script>
				  gtag(\'event\', \'conversion\', {\'send_to\': \'AW-669190695/0Y_vCKrnj9cBEKeUjL8C\'});
				</script>
						...
						<div id="text_agree" class="text_agree" style="display: none;">
							...
							<ol>
								<li><p>Общие положения</p>
									<ol>
										<li>Настоящая Политика в отношении обработки персональных данных (далее — Политика) составлена в соответствии с п. 2 ст. 18.1 Федерального закона № 152-ФЗ от 27 июля 2006 года «О персональных данных» и является основополагающим внутренним регулятивным документом ИП Михайлова И. В. (ИП Михайлова И. В.  далее — Организация или Оператор), определяющим ключевые направления его деятельности в области обработки и защиты персональных данных (далее — ПДн), оператором которых является Организация.</li>
										...
										<li><p>Обработка ПДн</p>
											<ol>
												...
												<li>Категории субъектов персональных данных<br />
													...
													<ul>
														<li>физические лица, состоящие с ИП Михайлова И. В. в трудовых отношениях;</li>
														<li>физические лица, являющие близкими родственниками сотрудников учреждения;</li>
														<li>физические лица, уволившиеся из ИП Михайлова И. В.;</li>
														<li>физические лица, являющиеся кандидатами на работу в ИП Михайлова И. В.;</li>
														<li>физические лица, состоящие с ИП Михайлова И. В. в гражданско-правовых отношениях;</li>
														<li>физические лица, заинтересованные в услугах ИП Михайлова И. В. и оставившие свою контактную информацию в форме на сайте организации, расположенного по адресу https://www.magniflex.ru/;</li>
													</ul>
												</li>
												<li>ПДн, обрабатываемые Организацией:
													...
													Полный список ПДн представлен в Перечне ПДн, утвержденном Генеральным директором организации в лице управляющей компании ИП Михайлова И. В..
												</li>
...
<div style="clear: both;"> </div>
		...
		array(
			...
			'parent_address' => '',
			'parent_name' => '',
			'name' => 'Карта сайта www.magniflex.ru',
			'left_sidebar' => 'o-magniflex',
			'title' => 'Карта сайта магазина Magniflex.ru',
			'description' => 'Карта сайта официального магазина Magniflex.ru',
			'keywords' => 'карта сайта magniflex',
			'text' => '
				...
				<div class="hnb_contarea">
					...
					<div class="hnb_conttextright">
					<ul class="sitemap">
						<li><a title="О компании Magniflex" href="/o-magniflex/about-magniflex/">О Magniflex</a>
						<ul>
							<li><a title="О компании Magniflex" href="/o-magniflex/about-magniflex/">О компании</a></li>
					...
					<li>
						<a title="Шоу-рум Magniflex" href="/contacts/show-room-matrasov/">Шоу-рум</a></li>
					<li>
						<a title="Акции и Скидки" href="/discounts/">Скидки</a>
						<ul >
							<li></li>

							<li><a title="Скидки на открытые матрасы Magniflex" href="/discounts/skidki-na-otkrytye-matrasy-magniflex/">Открытые матрасы</a></li>
							<li><a title="25% скидка на подушки Magniflex" href="/discounts/">25% скидка на подушки</a></li>
					...
					<li>
						...
						<ul >
							<li></li>
							<li><a title="Интернет-магазин Magniflex" href="/contacts/online-store/">Интернет-Магазин</a></li>
							<li><a title="Шоу-рум матрасов Magniflex" href="/contacts/show-room-matrasov/">Шоу-рум</a></li>
							<li><a title="Адреса магазинов Magniflex в Москве" href="/shops/moscow/">Москва</a></li>
...
"
	...
	array(
		...
		array(
			...
			'parent_address' => '',
			'parent_name' => '',
			'name' => 'МАГНИФЛЕКС НЕ РАБОТАЕТ С 28 МАРТА ПО 30 АПРЕЛЯ',
			'left_sidebar' => '',
			'title' => 'МАГНИФЛЕКС НЕ РАБОТАЕТ С 28 МАРТА ПО 30 АПРЕЛЯ',
			'description' => '',
			'keywords' => 'magniflex',
			'breadcrumbs_image' => '/img/breadcrumbs_sonnook.jpg',
			'text' => '
					<p>
						Российское представительство фабрики Magniflex в связи распоряжением Правительства РФ не работает с 28 марта по 30 апреля 2020 года.<br />
						Телефонная служба поддержки может работать ограничено.<br />
						Ближайшая доставка возможна в первый рабочий день после объявленных выходных дней.
					</p> 
		...
		array(
			...
			'text' => '
					...
					<ul class="why_list_magni">
						...
						<li>20 лет безупречной работы в России.</li>
					</ul>
					<br />
...
<div class="hnb_gal">
<!---------------------------!!!!!!!!!!!!!!!!!!!------------------------>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/72482069_142456310372720_7167334301765055212_n.jpg" class="boxer relgallery" title="Hotel Villa Carlotta"  itemprop="contentUrl"> <img src="/img/dream/72482069_142456310372720_7167334301765055212_n.jpg" alt="Hotel Villa Carlotta" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/73420469_2662278103832250_1662365357536642087_n.jpg" class="boxer relgallery" title="Villa Viscardo"  itemprop="contentUrl"> <img src="/img/dream/73420469_2662278103832250_1662365357536642087_n.jpg" alt="Villa Viscardo" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/28514962_1077405099064528_8285102155855618209_o.jpg" class="boxer relgallery" title="Villa Casagrande"  itemprop="contentUrl"> <img src="/img/dream/28514962_1077405099064528_8285102155855618209_o.jpg" alt="Villa Casagrande" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/28828030_1082872518517786_6046858889608042055_o.jpg" class="boxer relgallery" title="Allegroitalia"  itemprop="contentUrl"> <img src="/img/dream/28828030_1082872518517786_6046858889608042055_o.jpg" alt="Allegroitalia" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/32778117_1118023505002687_7348826078682546176_o.jpg" class="boxer relgallery" title="Hotel Hermitage"  itemprop="contentUrl"> <img src="/img/dream/32778117_1118023505002687_7348826078682546176_o.jpg" alt="Hotel Hermitage" itemprop="thumbnailUrl" /></a></span>
...
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/41695185_1227859017352468_9172397548214681600_o.jpg" class="boxer relgallery" title="Hotel De La Ville"  itemprop="contentUrl"> <img src="/img/dream/41695185_1227859017352468_9172397548214681600_o.jpg" alt="Hotel De La Ville" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/40500759_1219231208215249_6497943433292808192_o.jpg" class="boxer relgallery" title="Relais De La Costa"  itemprop="contentUrl"> <img src="/img/dream/40500759_1219231208215249_6497943433292808192_o.jpg" alt="Relais De La Costa" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/44335529_1248749845263385_2962661921020444672_o.jpg" class="boxer relgallery" title="Hotel La Palma Capri"  itemprop="contentUrl"> <img src="/img/dream/44335529_1248749845263385_2962661921020444672_o.jpg" alt="Hotel La Palma Capri" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/37975842_1182567491881621_8371958761140518912_o.jpg" class="boxer relgallery" title="Hotel Wi-Ki-Woo"  itemprop="contentUrl"> <img src="/img/dream/37975842_1182567491881621_8371958761140518912_o.jpg" alt="Hotel Wi-Ki-Woo" itemprop="thumbnailUrl" /></a></span>

<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/54457933_426425284576838_6642090126663662869_n.jpg" class="boxer relgallery" title="Hotel Edgbaston"  itemprop="contentUrl"> <img src="/img/dream/54457933_426425284576838_6642090126663662869_n.jpg" alt="Hotel Edgbaston" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/64887804_515839195955324_388242239317802965_n.jpg" class="boxer relgallery" title="Hotel Marignolle"  itemprop="contentUrl"> <img src="/img/dream/64887804_515839195955324_388242239317802965_n.jpg" alt="Hotel Marignolle" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/60294940_417810269043470_3258848266788060890_n.jpg" class="boxer relgallery" title="Human company"  itemprop="contentUrl"> <img src="/img/dream/60294940_417810269043470_3258848266788060890_n.jpg" alt="Human company" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/47691394_341586439766414_4567529218358950147_n.jpg" class="boxer relgallery" title="Toscana Hotel & Restaurant"  itemprop="contentUrl"> <img src="/img/dream/47691394_341586439766414_4567529218358950147_n.jpg" alt="Toscana Hotel & Restaurant" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/69840773_2188511594779596_54463872143348043_n.jpg" class="boxer relgallery" title="Hotel Algila"  itemprop="contentUrl"> <img src="/img/dream/69840773_2188511594779596_54463872143348043_n.jpg" alt="Hotel Algila" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/40510675_689877834724442_7841307069380496228_n.jpg" class="boxer relgallery" title="Hotel De La Ville"  itemprop="contentUrl"> <img src="/img/dream/40510675_689877834724442_7841307069380496228_n.jpg" alt="Hotel De La Ville" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/61740484_442504239866401_5727289171222258340_n.jpg" class="boxer relgallery" title="Hotel Viscardo"  itemprop="contentUrl"> <img src="/img/dream/61740484_442504239866401_5727289171222258340_n.jpg" alt="Hotel Viscardo" itemprop="thumbnailUrl" /></a></span>
<span class="newWidth50" itemscope itemtype="https://schema.org/ImageObject"><a href="/img/dream/65474581_2458292764458027_4211580927416394603_n.jpg" class="boxer relgallery" title="Hotel President"  itemprop="contentUrl"> <img src="/img/dream/65474581_2458292764458027_4211580927416394603_n.jpg" alt="Hotel President" itemprop="thumbnailUrl" /></a></span>
...
array(
            ...
            Запрос для получения коммерческого предложения просьба направлять на нашу почту: info@magniflex.ru либо по телефону: +7 (495) 792-16-93.
</p>
...
<p>
Для отправки заявки используйте почту: info@magniflex.ru или позвоните в отдел по работе с оптовыми покупателями по телефону: +7 (495) 792-16-93.
</p>
...
или написать сообщение на электронную почту: info@magniflex.ru
</p>
		...
		array(
			...
			info@magniflex.ru либо по телефону: +7 (495) 792-16-93.
			</p>
...
<a href="#" target="_blank"> <img alt="Пейзажи Тосканы. Родины матрасов Magniflex" src="/img/slider_index/toskana-magniflex-07.jpg"><span>Пейзажи Тосканы. Родины матрасов Magniflex</span></a>
		...
		array(
			...
			<style>
				#breadcrumbs {
					background: url(/img/breadcrumbs_riposook.jpg)!important;
...
<div class="new-sertificate">
	<div class="sertificate-line">
	<a class="sertificate-link" href="/pokupatelyam/certificates/ministerstvo-rf/">
		<div class="sertificate-top">
			<img src="/img/sert-rostest.jpg"  alt="Сертификат ГОСТР на подушки и матрасы">
		</div>
		<div class="sertificate-bottom">
			<h2>ОБЯЗАТЕЛЬНАЯ СЕРТИФИКАЦИЯ ГОСТ Р</h2>
			<p>свидетельствует о безопасности продукции, услуг и работ и подтверждается знаком качества. 
			</p>
		</div>
	</a>
	</div>
	<div class="sertificate-line">
	<a class="sertificate-link" href="/pokupatelyam/certificates/sanitar-epilogichskiy/">
		<div class="sertificate-top">
			<img src="/img/unnamed.jpg" alt="Сертификат Oeko-Tex стандарт 100">
		</div>
		<div class="sertificate-bottom">
			<h2>СЕРТИФИКАТЫ САНИТАРНО-ЭПИДЕМИОЛОГИЧЕСКОЕ</h2>
			<p>Санитарно-эпидемиологическое заключение  - документ, который подтверждает разрешение органами Министерства Здравоохранения и социального развития РФ  производства или ввоза продукции 
			</p>
		</div>
	</a>
	</div>
...
Одобрена и рекомендована к применению ведущими европейскими медицинскими центрами, практикующий профилактику и лечение опорно-двигательного аппарата человека.</p>
			...
			<div class="new-sertificate">
				<div class="sertificate-line">
					<a class="sertificate-link" href="/pokupatelyam/certificates/Oeko-Tex/">
						<div class="sertificate-top">
							<img src="/img/magniflex-sertifikat-1.jpg" alt="Сертификат Oeko-Tex стандарт 100">
						</div>
						<div class="sertificate-bottom">
							<h2>Oeko-Tex стандарт 100</h2>
							<p>Международная Ассоциация независимых лабораторий (в состав Ассоциации входят 17 исследовательских институтов в 40 странах мира) 
							</p>
						</div>
					</a>
				</div>
				<div class="sertificate-line">
						<a class="sertificate-link" href="/pokupatelyam/certificates/LGA/">
							<div class="sertificate-top">
								<img src="/img/magniflex-sertifikat-2.jpg" alt="Сертифкат LGA (Германия)">
							</div>
							<div class="sertificate-bottom">
								<h2>LGA</h2>
								<p>Сертифкат LGA означает, что продукция прошла комплексные испытания в европейской лаборатории под эгидой независимого аудитора TUV Reinland LGA Products (Германия). 
								</p>
							</div>
						</a>
				</div>
				<div class="sertificate-line">
					<a class="sertificate-link" href="/pokupatelyam/certificates/AJA/">
						<div class="sertificate-top">
							<img src="/img/magniflex-sertifikat-5.jpg" alt="Сертификат AJA Registrars, UKAS">
						</div>
						<div class="sertificate-bottom">
							<h2>Стандартизация AJA</h2>
							<p>Испытательные и калибровочные лаборатории AJA проводят комплексный и всесторонний мониторинг менеджмента качества предприятий, фабрик, компаний в большинстве сферах производства. 
							</p>
						</div>
					</a>
				</div>
				<div class="sertificate-line">
					<a class="sertificate-link" href="/pokupatelyam/certificates/UKAS/">
						<div class="sertificate-top">
							<img src="/img/magniflex-sertifikat-6.jpg" alt="Медицинское изделие">
						</div>
						<div class="sertificate-bottom">
							<h2>UKAS</h2>
							<p> Аккредитация в этой системе означает, что организация, получившая этот сертификат, была подвержена анализу в соответствии с международными стандартами</p>
						</div>
					</a>
				</div>
			
				<div class="sertificate-line">
					<a class="sertificate-link" href="/pokupatelyam/certificates/medecinskie-isdeliya/">
						<div class="sertificate-top">
							<img src="/img/magniflex-sertifikat-7.jpg" alt="Сертификат Medical Device">
						</div>
						<div class="sertificate-bottom">
							<h2>Медицинское изделие</h2>
							<p>Ортопедические матрасы и подушки признаны медицинскими изделиями в Европе и рекомендованы к применению. 
							</p>
						</div>
					</a>
				</div>
				...
				<div class="sertificate-line">
					<a class="sertificate-link" href="/pokupatelyam/certificates/FIRA/">
						<div class="sertificate-top">
							<img src="/img/magniflex-sertifikat-8.jpg" alt="Сертификат FIRA UK – Великобритания">
						</div>
						<div class="sertificate-bottom">
							<h2>FIRA UK</h2>
							<p>FIRA UK – Великобритания. Организация проводит широкий спектр мебельных тестов, включающий тестирование воспламеняемости
							</p>
						</div>
					</a>
				</div>
				...
				<div class="sertificate-line">
					<a class="sertificate-link" href="/pokupatelyam/certificates/ICEA/">
						<div class="sertificate-top">
							<img src="/img/icea.png" alt="Сертификат ICEA/AIAB (Италия)">
						</div>
						<div class="sertificate-bottom">
							<h2>ICEA </h2>
							<p>ICEA (Институт экололгической сертификации) совместно с AIAB (Итальянская ассоциация органического сельского хозяйства)
							</p>
						</div>
					</a>
				</div>
				...
				<div class="sertificate-line">
					<a class="sertificate-link" href="/pokupatelyam/certificates/CFR/">
						<div class="sertificate-top">
							<img  src="/img/cfr.png" alt="Сертификат CFR">
						</div>
						<div class="sertificate-bottom">
							<h2>CFR</h2>
							<p>Государственный стандарт США на воспламеняемость матрасов в условиях CFR 16 часть 1633 ”Стандарт воспламеняемости (открытого пламени) матрасов”.
							</p>
						</div>
					</a>
				</div>
				...
				<div class="sertificate-line">
					<a class="sertificate-link" href="/pokupatelyam/certificates/GOTS/">
						<div class="sertificate-top">
							<img  src="/img/GOTS.png" alt="Сертификат GOTS">
						</div>
						<div class="sertificate-bottom">
							<h2>GOTS </h2>
							<p>Сертификат GOTS является мировым стандартом по обработке текстиля из органически выращенных натуральных волокон.
							</p>
						</div>
					</a>
				</div>
...
Memoform устраняет давление, которое сила тяжести Земли оказывает как на тело, так и на матрас, создавая эффект невесомости между телом человека и матрасом. Этот материал обеспечивает постоянный комфорт, на который не влияют изменения температуры, подстраиваясь под движения, которые происходят во время сна, и, таким образом, гарантирует превосходное качество отдыха в любое время года. Особая способность материала позволяет приспосабливаться к телосложению человека и максимально снижать давление на тело, способствуя идеальной циркуляции крови во время отдыха. Memoform позволяет также избежать раздражающих болей ночью и при пробуждении утром, обеспечивая замечательное ощущение комфорта.
 <span>Узнать больше о материале <a href="/production/Memoform-Magnifoam/">Memoform Magnifoam</a></span></p>
</div>
</div>
<div class="outlast_wrapper">
...
Материал изготавливается из 100% натурального латекса. В процессе обработки латекс приобретает уникальные ортопедические свойства, дополнительную мягкость и прочность. Элиософт (Eliosoft) легко поглощает и испаряет влагу, воздухопроницаемый, экологически чистый долговечный материал, обеспечивающий мягкую, комфортную, естественную поддержку. Обычно используется в сочетании с такими материалами, как Memoform и Elioform, для идеального контроля мягкости и жесткости матраса.
  <span>Узнать больше о материале <a href="/production/Eliosoft/">Eliosoft</a></span></p>
 </div>
 </div>
 <div class="outlast_wrapper">
...
Экологически чистый, воздухопроницаемый материал с микропористой структурой - мягкий, упругий, эластичный, легко поглощает и испаряет влагу с тела человека, обладает антисептическим действием.
 <span>Узнать больше о материале <a href="/production/Eliocel/">Eliocel</a></span></p>
 </div>
 </div>
 <div class="outlast_wrapper">
...
<span>Узнать больше о материале <a href="/production/Memory/">Memory</a></span></p>
 </div>
 </div>
 <div class="outlast_wrapper">
...
<span>Узнать больше о наполнителе <a href="/production/magnifoambreeze/">Magnifoam Breeze</a></span></p>
 </div>
 </div>
 <div class="outlast_wrapper">
 ...
 <span>Узнать больше о пене <a href="/production/aquabreeze/">Aquabreeze </a></span></p>
</div>
</div>
<div class="outlast_wrapper">
	...
	<span>Узнать больше о пене <a href="/production/magnifoam/">Magnifoam </a></span></p>
	</div>
</div>
	<div class="outlast_wrapper">
		...
		<span>Узнать больше о материале <a href="/production/magnigelfoam/">Magnigel Foam </a></span></p>
		</div>
	</div>
	<div class="outlast_wrapper">
		...
		<span>Узнать больше о материале <a href="/production/mallowfoam/">Mallow Foam</a></span></p>
		</div>
</div>
<div class="outlast_wrapper">
		...
		<span>Узнать больше о пене <a href="/production/memoformhd/">Memoform HD</a></span></p>
		</div>
</div>
<div class="outlast_wrapper">
		...
		<span>Узнать больше о материале <a href="/production/memosoft/">Memosoft</a></span></p>
		</div>
</div>
<div class="outlast_wrapper">
	...
	<span>Узнать больше о материале <a href="/production/supersoftfiber/">Super Soft Fiber</a></span></p>
	</div>
</div>
...
.table_dostavka tr > td:first-child{
	width:270px;
	font-weight: 500;
}
@media(max-width:640px){
	.hnb_conttextright table.table_dostavka{
		white-space: normal;
	}
	.table_dostavka tr{
		display: flex;
 ...
 <h3>Доставка по Москве и Московской области</h3>
	...
	<table class="table_dostavka">
	<tr><td>Бесплатная доставка до двери.</td><td>Осуществляется <b>бесплатно</b> в будние дни по г. Москве <b>в пределах МКАД + 10 км от МКАД с 11:00 – 18:00.</b> (Далее 40 руб. за км). *Максимальная удаленность доставки фирменной службой до 50 км от МКАД. От 50 км доставка осуществляется транспортными компаниями по условиям доставки по России.
</td></tr>
	<tr><td>Доставка в день заказа.</td><td>Осуществляется только в будние дни <b>в случае оформления и подтверждения заказа</b> в первой половине дня строго <b>до 10:30</b>.
</td></tr>
	<tr><td>Вечерняя доставка:  18:00 - 21:00.</td><td><b>300 руб.</b> (В случае доставки более чем за 10 км от МКАД добавляется к тарифу за километраж).
</td></tr>
	<tr><td>Доставка в выходные и праздничные дни.</td><td><b>500 руб.</b> Осуществляется в случае оформления и подтверждения заказа до 10:30 предшествующего буднего дня.  (В случае доставки более чем за 10 км от МКАД добавляется к тарифу за километраж). При оформлении заказа в выходные и праздничные дни ближайшая доставка возможна на следующий после выходных и праздничных дней рабочий день.
</td></tr>
	<tr><td>Доставка орт. оснований.</td><td><b>500 руб.</b> в случае заказа доставки без матрасов. <b>При заказе вместе с матрасами доставка бесплатно.</b>
</td></tr>
	<tr><td>Доставка наматрасников.</td><td><b>500 руб.</b> в случае заказа доставки без матрасов. <b>При заказе вместе с матрасами доставка бесплатно.</b>
</td></tr>
	<tr><td>Подъем матрасов на этаж.</td><td><b>Бесплатно при наличии лифта</b>, либо <b>+ 50 руб. за 1 этаж в случае отсутствия лифта</b> при подъеме матрасов вручную, начиная со 2 этажа.
</td></tr>
	<tr><td>Подъем орт. оснований на этаж.</td><td><b>Бесплатно при наличии грузового лифта</b>, либо <b>+ 100 руб. за 1 этаж в случае отстутствия грузового лифта</b> при подъеме ортопедических оснований вручную, начиная со 2 этажа.
</td></tr>
	<tr><td><br>Дополнительно:</td><td><br>Доставка осуществляется в любой город России услугами транспортных компаний. Отгрузка продукции производится в течение 1-2 дней после поступления 100%-ой предоплаты на расчетный счет организации.
<br><br><b>Доставка продукции со склада</b> компании Magniflex (г. Москва) <b>до терминала транспортной компании</b> в г. Москва осуществляется <b>БЕСПЛАТНО</b>. Клиент оплачивает самостоятельно транспортной компании при получении заказа только доставку из Москвы до терминала транспортной компании в пункте назначения. Также возможна доставка транспортной компанией от терминала в пункте назначения до адреса клиента, является платной согласно тарифам транспортных компаний.<br><br>
Отгрузки продукции производятся услугами транспортных компаний «ПЭК» или «Деловые Линии».<br>
</td></tr>
	</table><br><br>

    <h3>Доставка по России.</h3>
    <p>
    Доставка осуществляется в любой город России услугами транспортных компаний. Отгрузка продукции производится в течение 1-2 дней после поступления 100%-ой предоплаты на расчетный счет организации.<br><br>
	<b>Доставка продукции со склада</b> компании Magniflex (г. Москва) <b>до терминала транспортной компании</b> в г. Москва осуществляется <b>БЕСПЛАТНО</b>. Клиент оплачивает самостоятельно транспортной компании при получении заказа только доставку из Москвы до терминала транспортной компании в пункте назначения. Также возможна доставка транспортной компанией от терминала в пункте назначения до адреса клиента, является платной согласно тарифам транспортных компаний.<br><br>
	Отгрузки продукции производятся услугами транспортных компаний «ПЭК» или «Деловые Линии».<br><br>
    </p>
    <h3>§ Важно</h3>
    <p>Так как матрасы поставляются в вакуумной упаковке в рулонах, стоимость доставки, по сравнению с обычными матрасами, является невысокой и доступной. Для самостоятельного расчета рекомендуем воспользоваться тарифными калькуляторами ТК "ПЭК" https://pecom.ru/services-are/shipping-request/ или «Деловые Линии» https://www.dellin.ru/requests/<br><br>
	Диаметр матраса в рулоне составляет: 30 см. Длина рулона равна ширине матраса.<br>
	По всем вопросам, связанным с доставкой, обращайтесь по телефону: <a href="tel:+74959891132"><b>+7 (495) 989 11 32</b></a>.<br>
	<b>Мы обязательно Вам поможем!</b><br><br>
    </p>
 ...
 <img width="605" src="/img/magniflex-car2.jpg" height="364" alt="Служба доставки Magniflex">
	...
	<div style="clear:both;"></div>
		...
		array(
			...
			'breadcrumbs_image' => '/img/breadcrumbs_riposook.jpg',
			'text' => '
 <h3>Способы оплаты товара</h3><br>
		<p>
...
Оплата по выставленному счету. Попросить выставить счет Вы можете в дополнительных пожеланиях к заказу или по телефону +7 (495) 989 11 32 <br /><br />
			 3. <b>Банковской карточкой:</b> на сайте Онлайн, в <a href="/contacts/show-room-matrasov/" target="_blank"/>флагманском шоу-руме</a> или курьеру при получении товара.<br />
Оплата карточкой доступна покупателям из Москвы и Московской области при условии осуществления доставки фирменной службой доставки Magniflex.
<br><br><br>
 
<b>При заказе с доставкой по России (кроме Москвы/Московской области):</b><br><br>
 
1. <b>Безналичный платеж с оплатой по счету</b>: для физических и юридических лиц.<br>
Запросить выставление счета возможно в дополнительных пожеланиях к заказу или по телефону +7 (495) 989 11 32.<br><br>
 
Для выставления счета в адрес юридических лиц потребуется предоставить карточку предприятия.<br>
Для выставления счета в адрес физических лиц потребуется предоставить ФИО, адрес, номер телефона и e-mail.<br><br>
 
2. <b>Онлайн-оплата</b> на сайте банковской картой.<br>
		</p>
		
<script src="https://widget.cloudpayments.ru/bundles/cloudpayments"></script>

<div class="payCustomForm">
<h3>Оплата картой онлайн</h3>
<span class="payCustomErrorText"></span><br>
<form>
<input type="number" min="1" max="100000000" name="sum" placeholder="Сумма для оплаты (руб.)" />
<input type="text" name="name" placeholder="Имя" />
<input type="text" name="phone" placeholder="Телефон" />
<input type="text" name="email" placeholder="E-mail" />
</form>
<div class="hiddenBtn"></div>
<button class="payCustomBtn">Оплатить</button>
</div>
		<br>
...
array(
			...
			'name' => 'Скидки и Акции',
			'left_sidebar' => '',
			'title' => 'Скидки и Акции | Magniflex Официальный сайт',
			'description' => 'Актуальные акции и скидки на матрасы и подушки Magniflex',
			'keywords' => 'magniflex акции, магнифлекс скидки, скидки magniflex',
			'text' => '
			<style>		
			...
			<div class="ama_visual one">
					...
					<div class="ama_visual_copy">
						<h1 class="ama_visual_copy_title">Скидки и Акции</h1>
						<p class="ama_visual_copy_subtitle">Покупайте выгодно! Актуальные акции и скидки на матрасы и подушки Magniflex</p>
					</div>
			</div>
			...
			<div class="news_block_with">				
					<a href="/discounts/discounts-15pr/" class="magazine-article-preview__image">
						<div class="absole_news_sk">15%</div>
					<div class="bac_img_news newsbacnum2" style="background-image:url(/img/action/ocen-sale.jpg);"></div>
						
					</a>
					<a href="/discounts/discounts-15pr/" class="magazine-article-preview__image">
					<div class="magazine-article-preview__desca">
						15% СКИДКА НА ВСЕ МАТРАСЫ И ПОДУШКИ
					</div>
					</a>
				</div>
			...
			<article class="magazine-article-preview_new is-inview">
					<div class="news_block_with">				
						<a href="/outlet/" class="magazine-article-preview__image">
						<div class="absole_news_sk">30%</div>
						<div class="bac_img_news outlet"></div>
							
						</a>
						<a href="/outlet/" class="magazine-article-preview__image">
							<div class="magazine-article-preview__desca">
								Скидки до 30% на уцененные матрасы
							</div>
						</a>
					</div>					
				</article>
			...
			<article class="magazine-article-preview_new is-inview">
				<div class="news_block_with">				
						<a href="/discounts/discounts-25-per/" class="magazine-article-preview__image">
				...
				<article class="magazine-article-preview_new is-inview">
					<div class="news_block_with">				
						<a href="/discounts/your-birthday/" class="magazine-article-preview__image">
						<div class="absole_news_sk">10%</div>
						<div class="bac_img_news dr"></div>
							
						</a>
						<a href="/discounts/your-birthday/" class="magazine-article-preview__image">
							<div class="magazine-article-preview__desca">
								Скидка 10% на Ваш День Рождения
							</div>
						</a>
					</div>					
				</article>
				...
				<article class="magazine-article-preview_new is-inview">
				<div class="news_block_with">				
					<a href="/discounts/discounts-namatras-25" class="magazine-article-preview__image">
					<div class="absole_news_sk">25%</div>
					<div class="bac_img_news namatras"></div>
						
					</a>
					<a href="/discounts/discounts-namatras-25" class="magazine-article-preview__image">
						<div class="magazine-article-preview__desca">
							25% скидка на наматрасник
						</div>
					</a>
				</div>					
			</article>
				...
				<!--<article class="magazine-article-preview_new is-inview">
					<div class="news_block_with">				
						<a href="" class="magazine-article-preview__image">
							<div class="absole_news_sk">Sale</div>
							<div class="bac_img_news newsbacnum7"></div>							
						</a>
						<div class="magazine-article-preview__desca">
							Черная пятница
						</div>
				...
				<!--<article class="magazine-article-preview_new is-inview">
					<div class="news_block_with">				
						<a href="/discounts/new-year-discount/" class="magazine-article-preview__image">
							<div class="absole_news_sk">Sale</div>
							<div class="bac_img_news new-year"></div>							
						</a>
						<div class="magazine-article-preview__desca">
							НОВОГОДНИЕ СКИДКИ!
						</div>
				...
				<!--<article class="magazine-article-preview_new is-inview">
					<div class="news_block_with">				
						<a href="/discounts/cyber-monday/" class="magazine-article-preview__image">
							<div class="absole_news_sk">Sale</div>
							<div class="bac_img_news cyber-monday"></div>							
						</a>
						<div class="magazine-article-preview__desca">
							Киберпонедельник! Скидка 10%
						</div>
					</div>					
				</article>-->
...
<!--
				<article class="magazine-article-preview_new is-inview">
					<div class="news_block_with">				
						<a href="/discounts/likvid-parts/" class="magazine-article-preview__image">
							<div class="absole_news_sk">Sale</div>
...
<!--
				<article class="magazine-article-preview_new is-inview">
				<div class="news_block_with">				
						<a href="/discounts/sales-freshgel/" class="magazine-article-preview__image">
							<div class="absole_news_sk">30%</div>
				...
				<article class="magazine-article-preview_new is-inview">
				<div class="news_block_with">				
						<a href="/discounts/sales-carezza/" class="magazine-article-preview__image">
				...
				<article class="magazine-article-preview_new is-inview">
				<div class="news_block_with">				
						<a href="/discounts/sales-blanket/" class="magazine-article-preview__image">
							<div class="absole_news_sk">15%</div>
				...
				<article class="magazine-article-preview_new is-inview">
				<div class="news_block_with">				
						<a href="/discounts/sales-open-mattress/" class="magazine-article-preview__image">
							<div class="absole_news_sk">Sale</div>
...
-->			
			<style>
				...
				.title_textpage {
					...
					letter-spacing: .625em !important;
		...
		array(
			'address' => 'new-year-discount',
			'parent_address' => 'discounts',
			'parent_name' => 'Скидки',
			'name' => 'Новогодние скидки',
			'left_sidebar' => 'skidki-magniflex',
			'title' => 'Новогодние скидки Magniflex (Магнифлекс)',
			'description' => 'Новогодние скидки Magniflex (Магнифлекс)',
			'keywords' => 'magniflex, магнифлекс, компания магнифлекс',
			'breadcrumbs_image' => '/img/breadcrumbs_aziendaok.jpg',
			'text' => '
			<p>

			<span class="red">С 16 декабря по 15 января будет действовать</span><span class="green"> Новогодняя акция</span><span class="red"> на следующие товары:</span><br><br>
			
			<span class="red">- Скидка 30% </span>от розничной цены на матрасы коллекций Memorie, freshGel и Magnificent!<br>
			<span class="red">- Скидка 25% </span>от розничной цены на пледы производства итальянской фабрики IWT Srl из наличия на складе в Москве.<br>
			<span class="red">- Скидка 15% </span>от розничной цены на матрасы Freshgel Dual 10, Freshgel Deluxe Dual 12 на размеры из наличия на складе в Москве.<br>
			<span class="red">- Скидка 10% </span>от розничной цены на все остальные матрасы и подушки из наличия на складе в Москве, не участвующие в других акциях.

			</p>
			<img src="/img/newyaeardiscount.jpg" alt="" style="width: 100%;"/>
			'
		),
		array(
			'address' => 'your-birthday',
			'parent_address' => 'discounts',
			'parent_name' => 'Скидки',
			'name' => '10% Скидка на Ваш День Рождения',
			'left_sidebar' => 'skidki-magniflex',
			'title' => '10% Скидка на Ваш День Рождения | Magniflex (Магнифлекс)',
			'description' => '10% Скидка на Ваш День Рождения | Magniflex (Магнифлекс)',
			'keywords' => 'Скидка, День Рождения, magniflex, магнифлекс, компания магнифлекс',
			'text' => '
			<p>
			10% скидка на весь заказ  — наш подарок на День Рождения!<br>
			Воспользуйтесь скидкой в течение 7 дней ДО или 7 дней ПОСЛЕ дня рождения.<br>
			Только при предъявлении паспорта. Скидки не суммируются!<br>
			</p>
			<img src="/img/action/dr.jpg" alt="" style="width: 50%;"/>
			'
		),
		array(
			'address' => 'cyber-monday',
			'parent_address' => 'discounts',
			'parent_name' => 'Скидки',
			'name' => 'Киберпонедельник! Скидка 10%',
			'left_sidebar' => 'skidki-magniflex',
			'title' => 'Киберпонедельник Magniflex (Магнифлекс)',
			'description' => 'Киберпонедельник Magniflex (Магнифлекс)',
			'keywords' => 'Киберпонедельник, magniflex, магнифлекс, компания магнифлекс',
			'breadcrumbs_image' => '/img/kibm.jpg',
			'text' => '
			<p>Акция "Киберпонедельник": с 27 января по 2 февраля включительно скидка 10% на всю продукцию Magniflex (матрасы и подушки), не участвующую в других акциях. <br><br>

			Внимание! Скидки по акциям не суммируются.
			</p>
			<img src="/img/slider/cubermon.jpg" alt="" style="width: 100%;"/>
			'
		),
		...
		array(
			...
			'left_sidebar' => 'skidki-magniflex',
			'title' => 'Ликвидация складских остатков Magniflex (Магнифлекс)',
			'description' => 'Ликвидация складских остатков Magniflex (Магнифлекс)',
			'keywords' => 'Ликвидация складских остатков, magniflex, магнифлекс, компания магнифлекс',
			'breadcrumbs_image' => '/img/breadcrumbs_aziendaok.jpg',
			'text' => '
			<p>Внимание! Проводится акция по ликвидации складских остатков. Распродажа товаров происходит со склада представительства фабрики в Москве. Количество товаров ограничено!<br /><br />

			<font color="red">Скидка 20%</font> от розничной цены только на матрасы и размеры из наличия:<br />
			...
			<a href="/catalog/orthopedic_mattresses/waterlattex/">Ортопедические матрасы Waterlattex</a> (остались размеры <a href="/catalog/orthopedic_mattresses/waterlattex/?size=80x200">80х200</a>, <a href="/catalog/orthopedic_mattresses/waterlattex/?size=160x190">160х190</a>)<br />
			<a href="/catalog/orthopedic_mattresses/memo-merino/">Ортопедические матрасы Orthomemo Merino</a> (остались размеры <a href="/catalog/orthopedic_mattresses/memo-merino/?size=80x200">80х200</a>, <a href="/catalog/orthopedic_mattresses/memo-merino/?size=90x190">90х190</a>,<a href="/catalog/orthopedic_mattresses/memo-merino/?size=90x200"> 90х200</a>, <a href="/catalog/orthopedic_mattresses/memo-merino/?size=120x200">120х200</a>)<br />
			<a href="/catalog/elitnye-rest/Rest-12/">Ортопедические матрасы Rest 12</a> (остались размеры <a href="/catalog/elitnye-rest/Rest-12/?size=80x200">80x200</a>)<br />
			<br /><br />
			<font color="red">Скидка 30%</font> от розничной цены только на матрасы и подушки, размеры из наличия:<br />
			<a href="/catalog/elitnye-freshgel/freshgel-10/?size=80x200">Ортопедические матрасы Freshgel 10 (80х200)</a><br />
			<a href="/catalog/pillows/freshgel_wave/">Подушка Freshgel Wave</a><br />
			<br /><br />
			</p>
			'
		),
		array(
			...
			'left_sidebar' => 'skidki-magniflex',
			'title' => '25% скидка на все подушки Magniflex',
			'description' => 'Magniflex действует акция — 25% скидка на любые модели подушек',
			'keywords' => 'magniflex, магнифлекс, компания магнифлекс',
			'breadcrumbs_image' => '/img/breadcrumbs_aziendaok.jpg',
			'text' => '
			
			<p>
			В наших официальных интернет-магазине и  <a target="_blank" href="/contacts/show-room-matrasov/">шоу-руме </a> Magniflex действует акция — 25% скидка на любые модели подушек в любом количестве при единовременной покупке вместе с матрасами Magniflex. Скидки не суммируются.
			<br /><br />
		...
		array(
			'address' => 'discounts-namatras-25',
			'parent_address' => 'discounts',
			'parent_name' => 'Скидки',
			'name' => '25% скидка на наматрасник при покупке матраса',
			'left_sidebar' => 'skidki-magniflex',
			'title' => '25% скидка на наматрасник',
			'description' => 'Magniflex действует акция — 25% скидка на любые модели подушек',
			'keywords' => 'magniflex, магнифлекс, компания магнифлекс',
			'breadcrumbs_image' => '/img/breadcrumbs_aziendaok.jpg',
			'text' => '
			...
			<p>
			В наших официальных интернет-магазине и  <a target="_blank" href="/contacts/show-room-matrasov/">шоу-руме </a> Magniflex действует акция — 25% скидка на любые модели наматрасников в любом количестве при единовременной покупке вместе с матрасами Magniflex. Скидки не суммируются.
			<br /><br />
			<strong>Экономьте с Пользой – выгодное предложение на комплект матрас + наматрасник!</strong>
			<br /><br />
			Например:
			</p>
			<!--{namatrasnik_carousel}-->
			</p>
		...
		array(
			'address' => 'discounts-15pr',
			'parent_address' => 'discounts',
			'parent_name' => 'Скидки',
			'name' => '15% СКИДКА НА ВСЕ МАТРАСЫ И ПОДУШКИ',
			'left_sidebar' => 'skidki-magniflex',
			'title' => '15% скидка на все матрасы и подушки только до 27 сентября',
			'description' => 'Magniflex действует акция — 15% скидка на все матрасы и подушки Magniflex',
			'keywords' => 'magniflex, магнифлекс, компания магнифлекс',
			'breadcrumbs_image' => '/img/breadcrumbs_aziendaok.jpg',
			'text' => '
				<h3>Акция ОСЕНЬ SALE</h3>
				<br>
				<p>
				Честные скидки 15% на весь ассортимент ортопедических матрасов и подушек Magniflex. <!--Только 2 недели!--> Акция продлена, 28 сентября 2020 года цены станут прежними. Успейте сделать выгодную покупку! <br>
				У нас не бывает скидок 50-70% на новые матрасы, как не бывает 50-70% скидок на новый премиальный автомобиль, потому что мы изначально предлагаем Вам качественный товар.
				<br>
				Акция «ОСЕНЬ SALE» - это максимально возможная 15% скидка на итальянские матрасы и подушки Magniflex. Подобные распродажи случаются редко. Только до 27 сентября (включительно) Вы можете купить отличный матрас с максимальной скидкой!</p>
				<p>
				Внимание! Скидки не суммируются. Количество товаров по акции ограничено!
				</p>
				<p>
				<img src="/img/action/sale_fall.jpg" alt="Честные скидки 15% на весь ассортимент ортопедических матрасов и подушек Magniflex" style="max-width:100%;" />
				</p>
			',
		),
		...
		array(
			...
			'left_sidebar' => 'skidki-magniflex',
			'title' => 'Распродажа матрасов и подушек FRESHGEL(-30%) Magniflex (Магнифлекс)',
			'description' => 'Распродажа складских остатков коллекции FRESHGEL (матрасы и подушки)',
			'keywords' => 'Распродажа, magniflex, магнифлекс, компания магнифлекс',
			'breadcrumbs_image' => '/img/breadcrumbs_aziendaok.jpg',
			'text' => '
...
<div class="hnb_mypoh2sk">
		...
		array(
			...
			'left_sidebar' => 'skidki-magniflex',
			'title' => 'Скидка на все пледы ',
			'description' => 'Зимняя акция на итальянские пледы',
			'keywords' => 'magniflex, магнифлекс, компания магнифлекс',
			'breadcrumbs_image' => '/img/breadcrumbs_aziendaok.jpg',
			'text' => '				
	<p>
	
	Зимняя акция на итальянские пледы:<br>
	
	- <span class="red">Скидка 15%</span> на весь ассортимент пледов.<br>
	- <span class="red">Скидка 20%</span> на весь ассортимент пледов при единовременной покупке с матрасом или подушкой Magniflex.<br>зимняя
	...
	<p></p><div class="hnb_mypoh2sk">	
		...
		array(
			...
			'left_sidebar' => 'skidki-magniflex',
			'title' => 'Распродажа открытых матрасов Magniflex (Магнифлекс)',
			'description' => 'Предлагаем к продаже открытые матрасы',
			'keywords' => 'распродажа, magniflex, магнифлекс, компания магнифлекс',
			'breadcrumbs_image' => '/img/breadcrumbs_aziendaok.jpg',
			'text' => '
	...
	<p> Более подробную информацию по матрасам с экспозиций можно получить по телефону +7 (495) 989 11 32 или по электронной почте <a href="mailto:info@magniflex.ru">info@magniflex.ru</a></p>
			...
			<table >
				...
				<tr>
					<td>2</td>
					<td><a href="/catalog/elitnye-rest/Rest-12/?size=195x200 (не в рулоне, новый)">Rest 12</a></td>
					<td>195x200</td>
					<td>1</td>
					<td>125 800 руб</td>
					<td>88.100 руб.</td>
				...
				<tr>
					<td>3</td>
					<td><a href="/catalog/elitnye-rest/stile-7/?size=120x200 (не в рулоне, новый)">Stile 7</a></td>
					<td>120x200</td>
					<td>1</td>
					<td>37 600 руб</td>
					<td>26.400 руб.</td>
				...
				<tr>
					<td>7</td>
					<td><a href="/catalog/mattresses/waterlattex/?size=200x200 (не в рулоне, новые)">Waterlattex</a></td>
					<td>200x200</td>
					<td>1</td>
					<td>71 900 руб</td>
					<td>50.400 руб.</td>
			...
			<tr>
				<td>1</td>
				<td><a href="/catalog/elitnye-rest/Rest-10/?size=90x200 (с экспозиции шоу-рума)">Rest 10</a></td>
				<td>90x200</td>
				<td>1</td>
				<td>49 300 руб</td>
				<td>34.600 руб.</td>
			...
			<tr>
				<td>2</td>
				<td><a href="/catalog/orthopedic_mattresses/memo-merino/?size=90x190 (с экспозиции шоу-рума)">Orthomemo Merino</a></td>
				<td>90x190</td>
				<td>1</td>
				<td>49 700 руб</td>
				<td>34.800 руб.</td>
			...
			<tr>
				<td>3</td>
				<td><a href="/catalog/mattresses/waterlattex/?size=90x200 (с экспозиции шоу-рума)">Waterlattex</a></td>
				<td>90x200</td>
				<td>1</td>
				<td>32 600 руб</td>
				<td>22.900 руб.</td>
		...
		array(
			...
			<div class="ama_skidki_photo">
				<img src="/img/products/mattresses/сarezza_mattress.jpg" alt="Распродажа коллекции матрасов Carezza">
			</div>
			<div class="hnb_mypoh2sk">
			</div>
		...
		array(
			...
			'parent_address' => '',
			'parent_name' => '',
			'name' => 'Тестовая страница Магазинов Magniflex',
			'left_sidebar' => '',
			'title' => 'Тестовая страница Магазинов Magniflex',
			'description' => 'Тестовая страница Магазинов Magniflex',
			'keywords' => 'тест magniflex',
			'text' => '
<style>
@font-face{font-family:Porsche Next;font-style:normal;font-weight:100;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-latin/PorscheNextWLa-Thin.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-latin/PorscheNextWLa-Thin.woff) format("woff");unicode-range:U+20-7F,U+80-FF,U+100-17F,U+180-24F,U+250-2AF,U+2B0-2FF,U+300-36F,U+E00-E7F,U+1E00-1EFF,U+2000-206F,U+2070-209F,U+20A0-20CF,U+2100-214F,U+2150-218F,U+2190-21FF,U+2200-22FF,U+25A0-25FF,U+2600-26FF,U+FB00-FB4F,U+FE70-FEFF;font-display:swap}@font-face{font-family:Porsche Next;font-style:normal;font-weight:400;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-latin/PorscheNextWLa-Regular.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-latin/PorscheNextWLa-Regular.woff) format("woff");unicode-range:U+20-7F,U+80-FF,U+100-17F,U+180-24F,U+250-2AF,U+2B0-2FF,U+300-36F,U+E00-E7F,U+1E00-1EFF,U+2000-206F,U+2070-209F,U+20A0-20CF,U+2100-214F,U+2150-218F,U+2190-21FF,U+2200-22FF,U+25A0-25FF,U+2600-26FF,U+FB00-FB4F,U+FE70-FEFF;font-display:swap}@font-face{font-family:Porsche Next;font-style:normal;font-weight:600;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-latin/PorscheNextWLa-SemiBold.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-latin/PorscheNextWLa-SemiBold.woff) format("woff");unicode-range:U+20-7F,U+80-FF,U+100-17F,U+180-24F,U+250-2AF,U+2B0-2FF,U+300-36F,U+E00-E7F,U+1E00-1EFF,U+2000-206F,U+2070-209F,U+20A0-20CF,U+2100-214F,U+2150-218F,U+2190-21FF,U+2200-22FF,U+25A0-25FF,U+2600-26FF,U+FB00-FB4F,U+FE70-FEFF;font-display:swap}@font-face{font-family:Porsche Next;font-style:normal;font-weight:700;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-latin/PorscheNextWLa-Bold.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-latin/PorscheNextWLa-Bold.woff) format("woff");unicode-range:U+20-7F,U+80-FF,U+100-17F,U+180-24F,U+250-2AF,U+2B0-2FF,U+300-36F,U+E00-E7F,U+1E00-1EFF,U+2000-206F,U+2070-209F,U+20A0-20CF,U+2100-214F,U+2150-218F,U+2190-21FF,U+2200-22FF,U+25A0-25FF,U+2600-26FF,U+FB00-FB4F,U+FE70-FEFF;font-display:swap}@font-face{font-family:Porsche Next;font-style:normal;font-weight:100;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-greek/PorscheNextWGr-Thin.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-greek/PorscheNextWGr-Thin.woff) format("woff");unicode-range:U+370-3FF;font-display:swap}@font-face{font-family:Porsche Next;font-style:normal;font-weight:400;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-greek/PorscheNextWGr-Regular.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-greek/PorscheNextWGr-Regular.woff) format("woff");unicode-range:U+370-3FF;font-display:swap}@font-face{font-family:Porsche Next;font-style:normal;font-weight:600;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-greek/PorscheNextWGr-SemiBold.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-greek/PorscheNextWGr-SemiBold.woff) format("woff");unicode-range:U+370-3FF;font-display:swap}@font-face{font-family:Porsche Next;font-style:normal;font-weight:700;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-greek/PorscheNextWGr-Bold.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-greek/PorscheNextWGr-Bold.woff) format("woff");unicode-range:U+370-3FF;font-display:swap}@font-face{font-family:Porsche Next;font-style:normal;font-weight:100;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-cyril/PorscheNextWCy-Thin.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-cyril/PorscheNextWCy-Thin.woff) format("woff");unicode-range:U+400-4FF;font-display:swap}@font-face{font-family:Porsche Next;font-style:normal;font-weight:400;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-cyril/PorscheNextWCy-Regular.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-cyril/PorscheNextWCy-Regular.woff) format("woff");unicode-range:U+400-4FF;font-display:swap}@font-face{font-family:Porsche Next;font-style:normal;font-weight:600;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-cyril/PorscheNextWCy-SemiBold.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-cyril/PorscheNextWCy-SemiBold.woff) format("woff");unicode-range:U+400-4FF;font-display:swap}@font-face{font-family:Porsche Next;font-style:normal;font-weight:700;src:url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-cyril/PorscheNextWCy-Bold.woff2) format("woff2"),url(https://cdn.ui.porsche.com/porsche-design-system/font/v1/porsche-next-cyril/PorscheNextWCy-Bold.woff) format("woff");unicode-range:U+400-4FF;font-display:swap}
...
<div style="clear: both;"></div>
		...
		array(
			...
			<style>
				...
				#wrap #content{
					background-color: #144760!important;
				}
				h1{
					display:none!important;
				}
	...
	<div class="compare_main_block">
		...
		array(
			'address' => 'test-main-slider',
			'parent_address' => '',
			'parent_name' => '',
			'name' => '',
			'left_sidebar' => '',
			'title' => '(в разработке) Слайдер Товаров на главной',
			'description' => '',
			'keywords' => '',
			'text' => '
				...
				<div class="ama-grid-block">
					<div class="ama-grid-image-wrapper ags-mr ama-grid-left-side">
						<img src="/img/deleyt/cupra-formentor.jpg"/>
						<div class="new-blocks-text">
							<h1 class="Buff-title">Звезды выбирают Magniflex</h1>
							<a href="/o-magniflex/stars-magniflex/" class="new-blocks-button">Узнать больше</a>
						</div>	
					</div>
					<div class="ama-grid-wrapper ama-grid-right-side">
						<div class="ama-grid-image-wrapper ags-slider ags-mb ama-grid-slider">
							<div class="ags-block">
								<div class="ags-abs">
									<p class="ags-first">CUPRA Leon Sportstourer</p>
									<p class="ags-second">The new CUPRA Tavascan.</p>
									<p class="ags-under">With only 1999 units available, is for those who define the concept of unique in their very own way.</p>
									<a href="#" class="new-blocks-button ags-link">See more</a>
								</div>
								
								<img src="/img/deleyt/cupra-tavascan-front-view.jpg"/>
							</div>
							<div class="ags-block">
								<div class="ags-abs">
									<p class="ags-first">CUPRA Leon Sportstourer</p>
						...
						<div class="ama-grid-wrapper w100 ama-grid-mobile-flex">
							<div class="ags-mr ags-calc-width ags-noimage-block">
								<div class="new-blocksR-flex">
									<h3 class="new-blocksR-Title">Contact</h3>
									<a href="/o-magniflex/stars-magniflex/" class="new-blocks-button ama-grid-contact">Узнать больше</a>
								</div>
							</div>
							<div class="ama-grid-image-wrapper ags-calc-width ">
								<img src="/img/deleyt/cupra-leon-5d.jpg"/>
								<div class="new-blocksR-group">
									<p class="new-blocksR-subRtext">Используем космические технологии НАСА</p>
									<a href="/o-magniflex/stars-magniflex/" class="new-blocks-button opasity0">Узнать больше</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="grid-container">
					<div class="newblockBuff">
						<div class="Buff-left topShadov">
							<div class="newblockBuff-left">
							</div>
							<div class="Buff-info">
								<a href="/o-magniflex/stars-magniflex/" class="info-link Buff-link">
								<p class="Buff-title">Звезды выбирают Magniflex</p>	
									<p class="Buff-subtitle">Амбассадор бренда - звезда мирового футбола, чемпион мира, Джанлуиджи Буффон</p>
								</a>								
								<a href="/o-magniflex/stars-magniflex/" class="button Buff-button abs-butt">Узнать больше</a>
							</div>
						</div>
						<div class="Buff-right-main">
							<div class="Buff-right">
								<div class="newblockBuff-center topShadov">
									<a href="/production/fabric-and-treatments/" class="Buff-link">										
										<div class="info">
											<p>Используем космические технологии НАСА</p>
										</div>
									</a>
									<a href="/production/fabric-and-treatments/" class="button Buff-button abs-butt">Узнать больше</a>
								</div>
								<div class="newblockBuff-center-right topShadov">
									<a href="/production/made-in-Italy/" class="Buff-link">											
										<div class="info">
											<p>Вся продукция производится в Италии</p>
										</div>
									</a>
									<a href="/production/made-in-Italy/" class="button Buff-button abs-butt">Узнать больше</a>
								</div>
							</div>
							<div class="Buff-bottom">
								<div class="newblockBuff-center-bottom topShadov">
									<a href="/o-magniflex/magniflex-daydreamer/" class="Buff-link">												
										<div class="info">
											<p>Матрасы Magniflex на лучших курортах Мира</p>
										</div>
									</a>
									<a href="/o-magniflex/magniflex-daydreamer/" class="button Buff-button abs-butt">Узнать больше</a>
								</div>
								<div class="newblockBuff-center-bottomRight">
									<a href="/o-magniflex/magniflex-top-hotel/" class="Buff-link">												
										<div class="info">
											<p>Матрасы Magniflex в лучших отелях Мира</p>
										</div>
									</a>
									<a href="/o-magniflex/magniflex-top-hotel/" class="button Buff-button abs-butt">Узнать больше</a>
								</div>
							</div>
						</div>
					</div>
		...
		array(
			...
			'name' => '',
			'left_sidebar' => '',
			'title' => '(в разработке) Страничка с отзывами',
			'description' => '',
			'keywords' => '',
			'all_review' => 'Качество продукции',
			'text' => '
		...
		array(
			...
			'text' => '
				...
				<center><h3>Вы успешно отписались от рассылки</h3></center>

				<br><br><br><br><br><br><br>
				<style>.hnb_conttextright{margin: 0 auto!important;padding: 0!important;}</style>
			'
		),
		array(
			'address' => 'send-review',
				...
				<div class="review-page">    
					<div class="textPage hnb_contarea">
						...
						<h1 class="title_textpage" style="opacity: 1;">Оставить свой отзыв</h1>
							...
							<input type="hidden" name="sfn" id="sfn-review" value="'.base64_decode(urldecode($_REQUEST['utm_campaign'])).'" />
							<div class="fancybox-item fancybox-close sf_close" onclick="hide_popup();"></div>
							<p class="review_modal_rate">Ваша оценка</p>
							...
							<div class="otzuv prod_selectors">
								<label for="review"><span>Выберите матрас</span></label>
								<select name="prod_select_mattresses" class="ama-product-select">
									<option disabled selected>Не выбрано</option>
									<option>Merino (Merinos)</option>
									<option>Merino (Merinos) для детей</option>
									<option>B-Bamboo</option>
									<option>Stile</option>
									<option>Stile для детей</option>
									<option>WaterLattex</option>
									<option>Pensiero</option>
									<option>Pensiero для детей</option>
									<option>Naturalmente (New Naturcomfort)</option>
									<option>Memorie</option>
									<option>Orthomemo Merino</option>
									<option>Topper Best Top</option>
									<option>Rest</option>
									<option>New Comfort Plus</option>
									<option>Carezza</option>
									<option>FreshGel</option>
									<option>Stretching</option>
									<option>Exchange Memoform dual</option>
									<option>Maestro</option>
									<option>Virtus</option>
								</select>
							</div>
							<div class="otzuv prod_selectors">
								<label for="review"><span>Выберите подушку</span></label>								
								<select name="prod_select_mattresses" class="ama-product-select">
									<option disabled selected>Не выбрано</option>
									<option>Relaxsan</option>
							...
							<div class="otzuv">
								...
								<textarea rows="10" id="review" name="review" placeholder="Расскажите нам о приобретенном товаре. Как он выглядит? Подошла ли Вам модель? Поделитесь тем, что, на Ваш взгляд, может быть важно для  других покупателей, на что им обратить внимание при покупке. Каким был Ваш опыт покупки? Расскажите о консультантах, службе доставке."></textarea>
							</div>
							<div class="otzuv">
								<label for="plus"><span>Достоинства</span></label>
								<textarea rows="2" id="plus" name="plus" placeholder=""></textarea>
							</div>
							<div class="otzuv">
								<label for="minus"><span>Недостатки</span></label>
								<textarea rows="2" id="minus" name="minus" placeholder=""></textarea>
							</div>
							<div class="otzuv">
								<label for="size"><span>Укажите размер</span></label>
								<textarea rows="1" id="size" name="size" placeholder=""></textarea>
							</div>
							...
							<div class="otzuv">
								...
								<input id="name-review" maxlength="300" type="text" name="name-review" value="'.urldecode($_REQUEST['utm_medium']).'">
							</div>
							<div class="otzuv">
								<label for="email-review"><span>Укажите email или телефон, если требуется ответ</span></label>
								<input id="email-review" maxlength="300" type="text" name="email" value="'.$_REQUEST['utm_source'].'">
							</div>

							<input id="buy_one_click2" maxlength="21" type="text" name="name" style="display:none;" value="Ортопедический матрас Merino">
							<input id="buy_one_clic3k" maxlength="21" type="text" name="price" style="display:none;" value="name TODO">
							<label for="userfile" class="file_att">
								<input type="file" name="userfile[]" multiple="" id="userfile" class="w100" accept="image/*">
							</label>
							<div class="button button-style button_style send_review">Отправить</div>
							<p style="text-align: center;">Нажимая на кнопку «отправить», я соглашаюсь на обработку моих персональных данных и ознакомлен(а)
							с <a href="/privacy-policy/">условиями конфиденциальности</a></p>
						</form>
							
							<script>
								localStorage["review_sfn"] = "'.base64_decode(urldecode($_REQUEST['utm_campaign'])).'" || localStorage["review_sfn"];
								localStorage["review_name"] = "'.urldecode($_REQUEST['utm_medium']).'" || localStorage["review_name"];
								localStorage["review_email"] = "'.$_REQUEST['utm_source'].'" || localStorage["review_email"];
								localStorage["review_mark"] = "'.$_REQUEST['mark'].'" || localStorage["review_mark"];
								
								$(document).ready(function(){
									if(localStorage["review_mark"]){
										change_star(localStorage["review_mark"]);
										$("#option" + localStorage["review_mark"]).prop("checked", true);
										choosing_star = true;
										result_star = localStorage["review_mark"];
										$(".star_img.star"+localStorage["review_mark"]).click();
									}
									if(!$("#sfn-review").val() && localStorage["review_sfn"] != "undefined") $("#sfn-review").val(localStorage["review_sfn"]);
									if(!$("#name-review").val() && localStorage["review_name"] != "undefined") $("#name-review").val(localStorage["review_name"]);
									if(!$("#email-review").val() && localStorage["review_email"] != "undefined") $("#email-review").val(localStorage["review_email"]);
								});
								...
								$(".send_review").on("click", function(e){
									...
									$.ajax({
										...
										success: function(msg){
											...
											$("#review_form").append(\'<p id="info"><span>Спасибо за ваш отзыв</span></p>\')
										}
									});
								});
								
								'.(($_REQUEST['utm_campaign'])?'$(document).ready(function(){ $(".send_review").click(); });':'').'
...
if($_SESSION['hide_discount'] === true && !empty($hide_discount_discount)){
	$pages []= array(
		'address' => 'hide-discount',
		'parent_address' => 'discounts',
		'parent_name' => 'Скидки',
		'name' => 'Закрытая распродажа для клиентов Magniflex',
		'left_sidebar' => 'skidki-magniflex',
		'title' => 'Закрытая распродажа для клиентов Magniflex',
		'description' => 'Закрытая распродажа для клиентов Magniflex',
		'keywords' => 'скидка, magniflex, магнифлекс, компания магнифлекс',
		'breadcrumbs_image' => '/img/breadcrumbs_aziendaok.jpg',
		'text' => '
		<style>
			.textPage .hnb_conttextright a.button {color:white;}
			.textPage .hnb_conttextright a.button:hover {color:#004562;}
			@media screen and (max-width: 640px){
				.hide-discount-ds, .hide-discount-plink{
					display:block!important;
					text-align: center;
				}
			}
		...
		<p>
		<span><b>Рады видеть Вас снова'.((!empty($_SESSION['hd_name']))?(', '.$_SESSION['hd_name'].''):('')).'!</b></span><br><br>
		<span><b>В период с 23 по 27 июля проходит закрытая распродажа исключительно для постоянных клиентов Magniflex.</b></span><br><br>
		<img src="/img/sale0720.jpg" style="width:480px;max-width:100%;" alt="" />
		</p>
		<p>
			<span>Обратите внимание на подушку, которую можно взять всегда с собой: на дачу, в путешествие или в командировку.</span><br>
			<a class="hide-discount-plink" href="/catalog/pillows/sushi-piccolo/" target="_blank" style="display: flex; align-items: center;text-decoration: none;" title="Выбрать подушку SUSHI PICCOLO">
				<img src="/img/product/Sushi Piccolo1.jpg" alt="" style="width:480px;max-width:100%;" />
				<span class="data--social" style="font-size: 30px;color: #004363; font-weight: 500;    text-align: center;background:none;text-transform: uppercase;">Подушка Sushi Piccolo, <span class="red">которую можно взять с собой</span><br><br>
					<span style="font-size: 30px;color: #004363; font-weight: 500;    padding: 5px 10px;padding-left:0;">9 120 P</span>
					<span style="font-size: 24px; color: #9a9a9a;  text-decoration: line-through;    padding: 5px 10px;">11 400 P</span>
					<span style="font-size: 30px;color: #004363; font-weight: 500;    padding: 5px 10px;">-20%</span><br><br>
					<span class="button button--blue">Подушка SUSHI PICCOLO</span>
				</span>
			</a>
		</p>
		<hr><br>
		<div class="data--social hide-discount-ds" style="display: flex;background:none;">
			<a target="_blank" href="/catalog/mattresses/" class="button button--blue">Выберите матрас</a>
			<a target="_blank" href="/catalog/pillows/" class="button button--blue">Выберите подушку</a>
			<a target="_blank" href="/catalog/plaids/" class="button button--blue">Выберите плед</a>
		</div>
		'
	);
}
