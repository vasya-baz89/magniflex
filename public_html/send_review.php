...
$prod_select_mattresses = $_POST["prod_select_mattresses"] ? $_POST["prod_select_mattresses"] : 'Матрас не выбран.';
$prod_select_pillows = $_POST["prod_select_pillows"] ? $_POST["prod_select_pillows"] : 'Подушка не выбрана.';
$order_id = '';
if(isset($_POST["sfn"])) $order_id = $_POST["sfn"];
...
$mail->addBCC('seerfull@yandex.ru', 'My Friend');
...
$mail->Body = "
<p>Рейтинг: $rating </p>
<p>Выбраный матрас: $prod_select_mattresses </p>
<p>Выбраная подушка: $prod_select_pillows </p>
<p>Имя: $name_review </p>
<p>Email: $email </p>
<p>Размер: $size </p>
...
<p>Отзыв: $review </p> "; 
if($order_id) $mail->Body .= '<p>№ заказа: '.$order_id.' </p>';
