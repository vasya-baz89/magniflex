<?php
$testerok = array(
	 array('carousel_img' => '/img/product/very_small/Relaxsan.jpg',
	 				  'carousel_name' => 'Подушка Relaxsan',
	 				  'carousel_oldprice' => '3 000',
	 				  'carousel_price' => '2 250',
	 				  'carousel_href' => '/catalog/vacuum_pillows/RELAXSAN/'
	...
	//  				  'carousel_href' => 'https://www.magniflex.ru/catalog/Orthopedic_pillows/MEMORY/'

	//   ),

	//  array('carousel_img' => '/img/product/very_small/Comfort Pillow.jpg',
	//  				  'carousel_name' => 'Подушка Memoform Comfort',
	//  				  'carousel_oldprice' => '8 800',
	//  				  'carousel_price' => '6 600',
	//  				  'carousel_href' => 'https://www.magniflex.ru/catalog/Orthopedic_pillows/COMFORT-PILLOW/'

	//   ),
	 array('carousel_img' => '/img/product/very_small/FreshGel Wave.jpg',
	 				  'carousel_name' => 'Подушка FreshGel Wave',
	 				  'carousel_oldprice' => '11 600',
	 				  'carousel_price' => '8 700',
	 				  'carousel_href' => '/catalog/gelevye-podushki/FreshGel+Wave/'

	  ),
	  array('carousel_img' => '/img/product/very_small/FreshGel Standard.jpg',
	 				  'carousel_name' => 'Подушка FreshGel Standard',
	 				  'carousel_oldprice' => '11 600',
	 				  'carousel_price' => '8 700',
	 				  'carousel_href' => '/catalog/gelevye-podushki/Memoform-Magnigel-Standard/'
