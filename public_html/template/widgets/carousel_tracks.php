<?php
$testerokss = array(
	 array('carousel_img' => '/img/product/Asmana_400_03.jpg',
	 				  'carousel_name' => 'ПЛЕД ASMANA 400 3',
	 				  'carousel_oldprice' => '18 400 ',
	 				  'carousel_price' => '14 720',
	 				  'carousel_href' => '/catalog/tracks/ASMANA-400-3/'

	  ),
	//  array('carousel_img' => '/img/product/very_small/Memory.jpg',
	//  				  'carousel_name' => 'Подушка Memory',
	//  				  'carousel_oldprice' => '9 200',
	//  				  'carousel_price' => '6 900',
	//  				  'carousel_href' => 'https://www.magniflex.ru/catalog/Orthopedic_trackss/MEMORY/'

	//   ),

	//  array('carousel_img' => '/img/product/very_small/Comfort tracks.jpg',
	//  				  'carousel_name' => 'Подушка Memoform Comfort',
	//  				  'carousel_oldprice' => '8 800',
	//  				  'carousel_price' => '6 600',
	//  				  'carousel_href' => 'https://www.magniflex.ru/catalog/Orthopedic_trackss/COMFORT-tracks/'

	//   ),
	array('carousel_img' => '/img/product/Sorrento_1.jpg',
	 				  'carousel_name' => 'ПЛЕД SORRENTO 1',
	 				  'carousel_oldprice' => '15 800',
	 				  'carousel_price' => '12 640 ',
	 				  'carousel_href' => '/catalog/tracks/SORRENTO-1/'

	  ),
	array('carousel_img' => '/img/product/Sorrento_2.jpg',
	 				  'carousel_name' => 'ПЛЕД SORRENTO 2',
	 				  'carousel_oldprice' => '15 800',
	 				  'carousel_price' => '12 640 ',
	 				  'carousel_href' => '/catalog/tracks/SORRENTO-2/'

	  ),
);
$get_tracks_carousel='<div class="carousel-test">
	   <div class="carousel-test shadow"> 
	      <div class="carousel-button-left"><a href="#"></a></div> 
	      <div class="carousel-button-right"><a href="#"></a></div> 
			<div class="carousel-test-wrapper"> 
			   <div class="carousel-test-items">'; 
				foreach ($testerokss as $value) {
				          $get_tracks_carousel .= '<div class="carousel-test-block">
				          <div class="carousel-img-block">
				          <a href="'.$value['carousel_href'].'"><img src="'.$value['carousel_img'].'" alt="" /></a>
				          </div>
				          <p class="tracks_name" align="center">'.$value['carousel_name'].'</p>
				          <p class="oldprice"> Цена: <span class="maroon" align="left"><s>'.$value['carousel_oldprice'].' р.</s></span>
				          <p class="tracks_price " align="left">'.$value['carousel_price'].' р.<a href="'.$value['carousel_href'].'"> <button class="button_buy" align="right">Купить</button> </a> </p>
				          </div>';
				}
			 $get_tracks_carousel .= '</div>
			</div>
	   </div>
	</div>';
