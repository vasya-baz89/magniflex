...
<div class="buy_one_click">
  <div class="field">
		...
		<form id="one_click_buy">
			...
			<div class="button ama-one-click-buy" onclick="ym(28675206, 'reachGoal', 'one_click_ok'); return true;">OK</div>
		</form>
	</div>
	<p id="info"></p>
</div>
...
<div class="ama_small_description">
	<?=$page['outlet_q']['desc'];?>
			...
			<div class="textModel link_to_new">
				<a style="text-decoration: none;" href="<?=$page['outlet_q']['donor_link']; ?>">Перейти на новый матрас</a>
			</div>
		</div>
		<div class="clear"></div>
	</div>
